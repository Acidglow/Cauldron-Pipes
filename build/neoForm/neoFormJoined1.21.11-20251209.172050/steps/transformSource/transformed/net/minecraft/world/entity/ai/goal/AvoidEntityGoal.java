...
public class AvoidEntityGoal<T extends LivingEntity> extends Goal {
    ...
    public AvoidEntityGoal(PathfinderMob mob, Class<T> avoidClass, float maxDistance, double walkSpeedModifier, double sprintSpeedModifier) {
        this(mob, avoidClass, p_25052_ -> true, maxDistance, walkSpeedModifier, sprintSpeedModifier, EntitySelector.NO_CREATIVE_OR_SPECTATOR);
    }
    ...
    public AvoidEntityGoal(
        PathfinderMob mob, Class<T> avoidClass, float maxDistance, double walkSpeedModifier, double sprintSpeedModifier, Predicate<? super LivingEntity> predicateOnAvoidEntity
    ) {
        this(mob, avoidClass, p_25049_ -> true, maxDistance, walkSpeedModifier, sprintSpeedModifier, predicateOnAvoidEntity);
    }
