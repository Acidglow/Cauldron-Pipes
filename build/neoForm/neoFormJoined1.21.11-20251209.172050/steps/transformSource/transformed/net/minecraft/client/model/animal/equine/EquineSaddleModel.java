...
public class EquineSaddleModel extends AbstractEquineModel<EquineRenderState> {
    ...
    public EquineSaddleModel(ModelPart p_480776_) {
        super(p_480776_);
    ...
    @Override
    public void setupAnim(EquineRenderState p_478823_) {
        super.setupAnim(p_478823_);

        for (ModelPart modelpart : this.ridingParts) {
            modelpart.visible = p_478823_.isRidden;
        }
    }
}
