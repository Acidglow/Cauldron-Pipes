...
public class ModelPartFeatureRenderer {
    ...
    public static class Storage {
        ...
        public void add(RenderType renderType, SubmitNodeStorage.ModelPartSubmit submit) {
            this.modelPartSubmits.computeIfAbsent(renderType, p_458912_ -> new ArrayList<>()).add(submit);
        }
        ...
        public void endFrame() {
            this.modelPartSubmits.keySet().removeIf(p_459061_ -> !this.modelPartSubmitsUsage.contains(p_459061_));
