...
public class FelineModel<T extends FelineRenderState> extends EntityModel<T> {
    ...
    public FelineModel(ModelPart p_479139_) {
        super(p_479139_);
        this.head = p_479139_.getChild("head");
        this.body = p_479139_.getChild("body");
        this.tail1 = p_479139_.getChild("tail1");
        this.tail2 = p_479139_.getChild("tail2");
        this.leftHindLeg = p_479139_.getChild("left_hind_leg");
        this.rightHindLeg = p_479139_.getChild("right_hind_leg");
        this.leftFrontLeg = p_479139_.getChild("left_front_leg");
        this.rightFrontLeg = p_479139_.getChild("right_front_leg");
    }
    ...
    public void setupAnim(T p_480398_) {
        super.setupAnim(p_480398_);
        float f = p_480398_.ageScale;
        if (p_480398_.isCrouching) {
            this.body.y += 1.0F * f;
            this.head.y += 2.0F * f;
            this.tail1.y += 1.0F * f;
            this.tail2.y += -4.0F * f;
        ...
        this.head.xRot = p_480398_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_480398_.yRot * (float) (Math.PI / 180.0);
        if (!p_480398_.isSitting) {
            this.body.xRot = (float) (Math.PI / 2);
            float f1 = p_480398_.walkAnimationSpeed;
            float f2 = p_480398_.walkAnimationPos;
            if (p_480398_.isSprinting) {
        ...
        if (p_480398_.lieDownAmount > 0.0F) {
            this.head.zRot = Mth.rotLerp(p_480398_.lieDownAmount, this.head.zRot, -1.2707963F);
            this.head.yRot = Mth.rotLerp(p_480398_.lieDownAmount, this.head.yRot, 1.2707963F);
            ...
            this.tail1.xRot = Mth.rotLerp(p_480398_.lieDownAmountTail, this.tail1.xRot, 0.8F);
            this.tail2.xRot = Mth.rotLerp(p_480398_.lieDownAmountTail, this.tail2.xRot, -0.4F);
        }

        if (p_480398_.relaxStateOneAmount > 0.0F) {
            this.head.xRot = Mth.rotLerp(p_480398_.relaxStateOneAmount, this.head.xRot, -0.58177644F);
        }
    }
}
