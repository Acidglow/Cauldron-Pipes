...
public record ScreenRectangle(ScreenPosition position, int width, int height) {
    ...
    public @Nullable ScreenRectangle intersection(ScreenRectangle rectangle) {
    ...
    public ScreenRectangle transformAxisAligned(Matrix3x2fc pose) {
        Vector2f vector2f = pose.transformPosition(this.left(), this.top(), new Vector2f());
        Vector2f vector2f1 = pose.transformPosition(this.right(), this.bottom(), new Vector2f());
    ...
    public ScreenRectangle transformMaxBounds(Matrix3x2fc pose) {
        Vector2f vector2f = pose.transformPosition(this.left(), this.top(), new Vector2f());
        Vector2f vector2f1 = pose.transformPosition(this.right(), this.top(), new Vector2f());
        Vector2f vector2f2 = pose.transformPosition(this.left(), this.bottom(), new Vector2f());
        Vector2f vector2f3 = pose.transformPosition(this.right(), this.bottom(), new Vector2f());
