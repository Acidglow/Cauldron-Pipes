...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener> {
    ...
    record ArgumentNodeStub(String id, ArgumentTypeInfo.Template<?> argumentType, @Nullable Identifier suggestionId)
        ...
        @Override
        public <S> ArgumentBuilder<S, ?> build(CommandBuildContext p_237656_, ClientboundCommandsPacket.NodeBuilder<S> p_426292_) {
            ArgumentType<?> argumenttype = this.argumentType.instantiate(p_237656_);
            return p_426292_.createArgument(this.id, argumenttype, this.suggestionId);
        }
    ...
    record LiteralNodeStub(String id) implements ClientboundCommandsPacket.NodeStub {
        @Override
        public <S> ArgumentBuilder<S, ?> build(CommandBuildContext p_237682_, ClientboundCommandsPacket.NodeBuilder<S> p_426272_) {
