...
public abstract class PathNavigation {
     ...
     */
    public final @Nullable Path createPath(double x, double y, double z, int accuracy) {
     ...
     */
    public @Nullable Path createPath(Stream<BlockPos> targets, int accuracy) {
        return this.createPath(targets.collect(Collectors.toSet()), 8, false, accuracy);
    }

    public @Nullable Path createPath(Set<BlockPos> positions, int distance) {
    ...
    public @Nullable Path createPath(BlockPos pos, int regionOffset, int accuracy) {
     ...
     */
    public @Nullable Path createPath(Entity entity, int accuracy) {
