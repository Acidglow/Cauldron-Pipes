...
public final class EntitySelector {
    ...
    public static final Predicate<Entity> NO_CREATIVE_OR_SPECTATOR = p_392971_ -> !(
        p_392971_ instanceof Player player && (p_392971_.isSpectator() || player.isCreative())
    );
    /**
     ...
     */
    public static final Predicate<Entity> CAN_BE_COLLIDED_WITH = NO_SPECTATORS.and(p_423226_ -> p_423226_.canBeCollidedWith(null));
    ...
    public static Predicate<Entity> withinDistance(double x, double y, double z, double range) {
        ...
        return p_460390_ -> p_460390_.distanceToSqr(x, y, z) <= d0;
    }
            ...
            : NO_SPECTATORS.and(
                p_392970_ -> {
                    if (!p_392970_.isPushable()) {
                        return false;
                    } else if (!entity.level().isClientSide() || p_392970_ instanceof Player player && player.isLocalPlayer()) {
                        Team team1 = p_392970_.getTeam();
