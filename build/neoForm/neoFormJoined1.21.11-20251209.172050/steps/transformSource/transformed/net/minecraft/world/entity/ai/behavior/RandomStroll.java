...
public class RandomStroll {
    ...
    public static OneShot<PathfinderMob> stroll(float speedModifier, boolean mayStrollFromWater) {
        return strollFlyOrSwim(
            speedModifier, p_258601_ -> LandRandomPos.getPos(p_258601_, 10, 7), mayStrollFromWater ? p_258615_ -> true : p_427037_ -> !p_427037_.isInWater()
        );
    }
    ...
    private static @Nullable Vec3 getTargetSwimPos(PathfinderMob mob) {
        ...
        for (int[] aint : SWIM_XY_DISTANCE_TIERS) {
            ...
            boolean flag = GoalUtils.mobRestricted(mob, aint[0]);
