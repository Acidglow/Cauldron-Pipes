...
public abstract class AgeableMob extends PathfinderMob {
    ...
    public @Nullable SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_146746_, DifficultyInstance p_146747_, EntitySpawnReason p_363316_, @Nullable SpawnGroupData p_146749_
    ) {
        if (p_146749_ == null) {
    ...
    public abstract @Nullable AgeableMob getBreedOffspring(ServerLevel level, AgeableMob otherParent);
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_421826_) {
        super.addAdditionalSaveData(p_421826_);
        p_421826_.putInt("Age", this.getAge());
        p_421826_.putInt("ForcedAge", this.forcedAge);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_422327_) {
        super.readAdditionalSaveData(p_422327_);
        this.setAge(p_422327_.getIntOr("Age", 0));
        this.forcedAge = p_422327_.getIntOr("ForcedAge", 0);
    }
