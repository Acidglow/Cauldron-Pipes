...
public class HappyGhastHarnessModel extends EntityModel<HappyGhastRenderState> {
    ...
    public HappyGhastHarnessModel(ModelPart p_481804_) {
        super(p_481804_);
        this.goggles = p_481804_.getChild("goggles");
    }
    ...
    public void setupAnim(HappyGhastRenderState p_479301_) {
        super.setupAnim(p_479301_);
        if (p_479301_.isRidden) {
