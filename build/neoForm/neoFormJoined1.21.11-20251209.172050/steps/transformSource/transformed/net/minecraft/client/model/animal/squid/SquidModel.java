...
public class SquidModel extends EntityModel<SquidRenderState> {
    ...
    public SquidModel(ModelPart p_480881_) {
        super(p_480881_);
        Arrays.setAll(this.tentacles, p_481862_ -> p_480881_.getChild(createTentacleName(p_481862_)));
    }
    ...
    public void setupAnim(SquidRenderState p_479622_) {
        super.setupAnim(p_479622_);

        for (ModelPart modelpart : this.tentacles) {
            modelpart.xRot = p_479622_.tentacleAngle;
        }
    }
}
