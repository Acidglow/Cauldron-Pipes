...
public class VanillaRecipeProvider extends RecipeProvider {
    ...
    protected VanillaRecipeProvider(HolderLookup.Provider p_364298_, RecipeOutput p_361287_) {
    ...
    protected void buildRecipes() {
        ...
        this.shapeless(RecipeCategory.FOOD, Items.MUSHROOM_STEW)
            ...
            .unlockedBy("has_red_mushroom", this.has(Blocks.RED_MUSHROOM))
            .save(this.output);
        BuiltInRegistries.ITEM.stream().forEach(p_359460_ -> {
            SuspiciousEffectHolder suspiciouseffectholder = SuspiciousEffectHolder.tryGet(p_359460_);
            if (suspiciouseffectholder != null) {
                this.suspiciousStew(p_359460_, suspiciouseffectholder);
            }
        });
        ...
        smithingTrims().forEach(p_399385_ -> this.trimSmithing(p_399385_.template(), p_399385_.patternId(), p_399385_.recipeId()));
    ...
    public static Stream<VanillaRecipeProvider.TrimTemplate> smithingTrims() {
        return Stream.of(
            ...
            .map(p_466058_ -> {
                Item item = (Item)p_466058_.getFirst();
                ResourceKey<TrimPattern> resourcekey = (ResourceKey<TrimPattern>)p_466058_.getSecond();
    ...
    public static class Runner extends RecipeProvider.Runner {
        ...
        protected RecipeProvider createRecipeProvider(HolderLookup.Provider p_364945_, RecipeOutput p_362956_) {
            return new VanillaRecipeProvider(p_364945_, p_362956_);
        }
