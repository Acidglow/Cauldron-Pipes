...
public class SnowGolemModel extends EntityModel<LivingEntityRenderState> {
    ...
    public SnowGolemModel(ModelPart p_478507_) {
        super(p_478507_);
        this.head = p_478507_.getChild("head");
        this.leftArm = p_478507_.getChild("left_arm");
        this.rightArm = p_478507_.getChild("right_arm");
        this.upperBody = p_478507_.getChild("upper_body");
    }
    ...
    public void setupAnim(LivingEntityRenderState p_480176_) {
        super.setupAnim(p_480176_);
        this.head.yRot = p_480176_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_480176_.xRot * (float) (Math.PI / 180.0);
        this.upperBody.yRot = p_480176_.yRot * (float) (Math.PI / 180.0) * 0.25F;
