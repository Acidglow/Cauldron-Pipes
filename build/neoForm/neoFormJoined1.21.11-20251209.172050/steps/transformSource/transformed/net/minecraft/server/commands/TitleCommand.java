                                ...
                                .then(
                                    Commands.argument("title", ComponentArgument.textComponent(context))
                                        .executes(
                                            p_400900_ -> showTitle(
                                                p_400900_.getSource(),
                                                EntityArgument.getPlayers(p_400900_, "targets"),
                                                ComponentArgument.getRawComponent(p_400900_, "title"),
                                                "title",
                                ...
                                .then(
                                    Commands.argument("title", ComponentArgument.textComponent(context))
                                        .executes(
                                            p_400899_ -> showTitle(
                                                p_400899_.getSource(),
                                                EntityArgument.getPlayers(p_400899_, "targets"),
                                                ComponentArgument.getRawComponent(p_400899_, "title"),
                                                "subtitle",
                                ...
                                .then(
                                    Commands.argument("title", ComponentArgument.textComponent(context))
                                        .executes(
                                            p_400898_ -> showTitle(
                                                p_400898_.getSource(),
                                                EntityArgument.getPlayers(p_400898_, "targets"),
                                                ComponentArgument.getRawComponent(p_400898_, "title"),
                                                "actionbar",
