...
public record FireworksPredicate(
    ...
    public static final Codec<FireworksPredicate> CODEC = RecordCodecBuilder.create(
        p_465948_ -> p_465948_.group(
            ...
            .apply(p_465948_, FireworksPredicate::new)
    );
    ...
    public boolean matches(Fireworks p_400011_) {
        return this.explosions.isPresent() && !this.explosions.get().test(p_400011_.explosions())
            ? false
            : this.flightDuration.matches(p_400011_.flightDuration());
    }
}
