...
public class HoglinModel extends EntityModel<HoglinRenderState> {
    ...
    public HoglinModel(ModelPart p_480595_) {
        super(p_480595_);
        this.body = p_480595_.getChild("body");
        this.mane = this.body.getChild("mane");
        this.head = p_480595_.getChild("head");
        this.rightEar = this.head.getChild("right_ear");
        this.leftEar = this.head.getChild("left_ear");
        this.rightFrontLeg = p_480595_.getChild("right_front_leg");
        this.leftFrontLeg = p_480595_.getChild("left_front_leg");
        this.rightHindLeg = p_480595_.getChild("right_hind_leg");
        this.leftHindLeg = p_480595_.getChild("left_hind_leg");
    }
    ...
    public void setupAnim(HoglinRenderState p_481825_) {
        super.setupAnim(p_481825_);
        float f = p_481825_.walkAnimationSpeed;
        float f1 = p_481825_.walkAnimationPos;
        this.rightEar.zRot = (float) (-Math.PI * 2.0 / 9.0) - f * Mth.sin(f1);
        this.leftEar.zRot = (float) (Math.PI * 2.0 / 9.0) + f * Mth.sin(f1);
        this.head.yRot = p_481825_.yRot * (float) (Math.PI / 180.0);
        float f2 = 1.0F - Mth.abs(10 - 2 * p_481825_.attackAnimationRemainingTicks) / 10.0F;
