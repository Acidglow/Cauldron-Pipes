...
public class CyclingSlotBackground {
    ...
    public void tick(List<Identifier> icons) {
    ...
    private void renderIcon(Slot slot, Identifier icon, float alpha, GuiGraphics guiGraphics, int x, int y) {
        guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, icon, x + slot.x, y + slot.y, 16, 16, ARGB.white(alpha));
    }
