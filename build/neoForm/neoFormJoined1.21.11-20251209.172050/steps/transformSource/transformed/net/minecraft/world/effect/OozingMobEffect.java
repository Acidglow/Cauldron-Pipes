...
class OozingMobEffect extends MobEffect {
    ...
    public void onMobRemoved(ServerLevel p_376380_, LivingEntity p_338339_, int p_338421_, Entity.RemovalReason p_338677_) {
        if (p_338677_ == Entity.RemovalReason.KILLED) {
            ...
            int j = p_376380_.getGameRules().get(GameRules.MAX_ENTITY_CRAMMING);
    ...
    protected interface NearbySlimes {
        ...
        static OozingMobEffect.NearbySlimes closeTo(LivingEntity entity) {
            return p_426976_ -> {
                ...
                entity.level().getEntities(EntityType.SLIME, entity.getBoundingBox().inflate(2.0), p_348647_ -> p_348647_ != entity, list, p_426976_);
                return list.size();
            };
        }
    }
