...
public class SocialInteractionsScreen extends Screen {
    ...
    @Override
    public boolean keyPressed(KeyEvent p_445537_) {
        if (!this.searchBox.isFocused() && this.minecraft.options.keySocialInteractions.matches(p_445537_)) {
            this.onClose();
            return true;
        } else {
            return super.keyPressed(p_445537_);
        }
    }
