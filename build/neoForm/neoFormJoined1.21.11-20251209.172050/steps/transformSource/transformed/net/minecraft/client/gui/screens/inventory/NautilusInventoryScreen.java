...
public class NautilusInventoryScreen extends AbstractMountInventoryScreen<NautilusInventoryMenu> {
    ...
    public NautilusInventoryScreen(NautilusInventoryMenu menu, Inventory playerInventory, AbstractNautilus nautilus, int inventoryColumns) {
        super(menu, playerInventory, nautilus.getDisplayName(), inventoryColumns, nautilus);
    }
