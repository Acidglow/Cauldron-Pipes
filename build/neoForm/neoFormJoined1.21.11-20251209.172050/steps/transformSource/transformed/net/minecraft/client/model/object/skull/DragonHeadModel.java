...
public class DragonHeadModel extends SkullModelBase {
    ...
    public DragonHeadModel(ModelPart p_478821_) {
        super(p_478821_);
        this.head = p_478821_.getChild("head");
    ...
    public void setupAnim(SkullModelBase.State p_481448_) {
        super.setupAnim(p_481448_);
        this.jaw.xRot = (float)(Math.sin(p_481448_.animationPos * (float) Math.PI * 0.2F) + 1.0) * 0.2F;
        this.head.yRot = p_481448_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_481448_.xRot * (float) (Math.PI / 180.0);
    }
}
