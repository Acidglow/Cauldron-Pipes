...
public class DolphinModel extends EntityModel<DolphinRenderState> {
    ...
    public DolphinModel(ModelPart p_481260_) {
        super(p_481260_);
        this.body = p_481260_.getChild("body");
    ...
    public void setupAnim(DolphinRenderState p_478177_) {
        super.setupAnim(p_478177_);
        this.body.xRot = p_478177_.xRot * (float) (Math.PI / 180.0);
        this.body.yRot = p_478177_.yRot * (float) (Math.PI / 180.0);
        if (p_478177_.isMoving) {
            this.body.xRot = this.body.xRot + (-0.05F - 0.05F * Mth.cos(p_478177_.ageInTicks * 0.3F));
            this.tail.xRot = -0.1F * Mth.cos(p_478177_.ageInTicks * 0.3F);
            this.tailFin.xRot = -0.2F * Mth.cos(p_478177_.ageInTicks * 0.3F);
        }
    }
}
