...
public enum DyeColor implements StringRepresentable {
    ...
    @Deprecated
    public static final Codec<DyeColor> LEGACY_ID_CODEC = Codec.BYTE.xmap(DyeColor::byId, p_404523_ -> (byte)p_404523_.id);
    ...
    public static @Nullable DyeColor byName(String translationKey, @Nullable DyeColor fallback) {
    ...
    public static DyeColor getMixedColor(ServerLevel level, DyeColor first, DyeColor second) {
        ...
        return level.recipeAccess()
            ...
            .map(p_432575_ -> p_432575_.value().assemble(craftinginput, level.registryAccess()))
