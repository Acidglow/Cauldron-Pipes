...
public class MobSpawnSettings {
    ...
    public static final MapCodec<MobSpawnSettings> CODEC = RecordCodecBuilder.mapCodec(
        p_466679_ -> p_466679_.group(
            ...
            .apply(p_466679_, MobSpawnSettings::new)
    );
    ...
    MobSpawnSettings(
        float creatureGenerationProbability, Map<MobCategory, WeightedList<MobSpawnSettings.SpawnerData>> spawners, Map<EntityType<?>, MobSpawnSettings.MobSpawnCost> mobSpawnCosts
    ) {
    ...
    public static class Builder {
        protected final Map<MobCategory, WeightedList.Builder<MobSpawnSettings.SpawnerData>> spawners = Util.makeEnumMap(
            MobCategory.class, p_393314_ -> WeightedList.builder()
        );
        ...
        public MobSpawnSettings build() {
            return new MobSpawnSettings(
                ...
                this.spawners.entrySet().stream().collect(ImmutableMap.toImmutableMap(Entry::getKey, p_393315_ -> p_393315_.getValue().build())),
    ...
    public record SpawnerData(EntityType<?> type, int minCount, int maxCount) {
        public static final MapCodec<MobSpawnSettings.SpawnerData> CODEC = RecordCodecBuilder.<MobSpawnSettings.SpawnerData>mapCodec(
                p_393316_ -> p_393316_.group(
                    ...
                    .apply(p_393316_, MobSpawnSettings.SpawnerData::new)
            )
            .validate(
