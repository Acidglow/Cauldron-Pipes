...
public record Advancement(
    ...
    public static final Codec<Advancement> CODEC = RecordCodecBuilder.<Advancement>create(
            p_465322_ -> p_465322_.group(
                ...
                .apply(p_465322_, (p_311374_, p_311375_, p_311376_, p_311377_, p_311378_, p_311379_) -> {
    ...
    private static Component decorateName(DisplayInfo display) {
        ...
        Component component2 = component.copy().withStyle(p_392482_ -> p_392482_.withHoverEvent(new HoverEvent.ShowText(component1)));
    ...
    public void validate(ProblemReporter reporter, HolderGetter.Provider lootData) {
        this.criteria.forEach((p_465320_, p_465321_) -> {
            CriterionValidator criterionvalidator = new CriterionValidator(reporter.forChild(new ProblemReporter.RootFieldPathElement(p_465320_)), lootData);
            p_465321_.triggerInstance().validate(criterionvalidator);
        });
    }
