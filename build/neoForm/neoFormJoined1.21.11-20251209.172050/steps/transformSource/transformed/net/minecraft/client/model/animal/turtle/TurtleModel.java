...
public class TurtleModel extends QuadrupedModel<TurtleRenderState> {
    ...
    public TurtleModel(ModelPart p_478361_) {
        super(p_478361_);
        this.eggBelly = p_478361_.getChild("egg_belly");
    }
    ...
    public void setupAnim(TurtleRenderState p_478264_) {
        super.setupAnim(p_478264_);
        float f = p_478264_.walkAnimationPos;
        float f1 = p_478264_.walkAnimationSpeed;
        if (p_478264_.isOnLand) {
            float f2 = p_478264_.isLayingEgg ? 4.0F : 1.0F;
            float f3 = p_478264_.isLayingEgg ? 2.0F : 1.0F;
            float f4 = f * 5.0F;
        ...
        this.eggBelly.visible = p_478264_.hasEgg;
