...
public class SmithingTemplateItem extends Item {
    ...
    public void appendHoverText(
        ItemStack p_267313_, Item.TooltipContext p_339591_, TooltipDisplay p_399688_, Consumer<Component> p_400130_, TooltipFlag p_266857_
    ) {
        p_400130_.accept(SMITHING_TEMPLATE_SUFFIX);
        p_400130_.accept(CommonComponents.EMPTY);
        p_400130_.accept(APPLIES_TO_TITLE);
        p_400130_.accept(CommonComponents.space().append(this.appliesTo));
        p_400130_.accept(INGREDIENTS_TITLE);
        p_400130_.accept(CommonComponents.space().append(this.ingredients));
    }
