...
public class PufferfishSmallModel extends EntityModel<EntityRenderState> {
    ...
    public PufferfishSmallModel(ModelPart p_480625_) {
        super(p_480625_);
        this.leftFin = p_480625_.getChild("left_fin");
        this.rightFin = p_480625_.getChild("right_fin");
    }
    ...
    public void setupAnim(EntityRenderState p_479724_) {
        super.setupAnim(p_479724_);
        this.rightFin.zRot = -0.2F + 0.4F * Mth.sin(p_479724_.ageInTicks * 0.2F);
        this.leftFin.zRot = 0.2F - 0.4F * Mth.sin(p_479724_.ageInTicks * 0.2F);
    }
}
