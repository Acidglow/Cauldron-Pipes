...
public class BlockEntityCustomNameToComponentFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            type1,
            p_466448_ -> {
                Optional<String> optional = p_466448_.getOptional(opticfinder);
                return optional.isPresent() && !NAMEABLE_BLOCK_ENTITIES.contains(optional.get())
                    ? ExtraDataFixUtils.cast(type1, p_466448_)
                    : Util.writeAndReadTypedOrThrow(ExtraDataFixUtils.cast(type2, p_466448_), type1, BlockEntityCustomNameToComponentFix::fixTagCustomName);
            }
        );
    }
    ...
    public static <T> Dynamic<T> fixTagCustomName(Dynamic<T> tag) {
        ...
        return s.isEmpty()
            ...
            : tag.set("CustomName", LegacyComponentDataFixUtils.createPlainTextComponent(tag.getOps(), s));
    }
}
