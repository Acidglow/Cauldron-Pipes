...
public interface ClientGamePacketListener extends ClientCommonPacketListener, ClientPongPacketListener {
    ...
    /**
     * Spawns an instance of the {@link EntityType} indicated by the packet and sets its position and momentum
     */
    ...
    /**
     * Updates all registered Level instances with destroyBlockProgress
     */
    ...
    /**
     * Updates the CompoundTag metadata of instances of the following entitytypes: Mob spawners, command blocks, beacons, skulls, flowerpot
     */
    ...
    /**
     * Registers some server properties (gametype,hardcore-mode,terraintype,difficulty,player limit), creates a new {@link ClientLevel} and sets the player initial dimension
     */
