...
public class GoatModel extends QuadrupedModel<GoatRenderState> {
    ...
    public GoatModel(ModelPart p_481995_) {
        super(p_481995_);
    }
    ...
    public void setupAnim(GoatRenderState p_480565_) {
        super.setupAnim(p_480565_);
        this.head.getChild("left_horn").visible = p_480565_.hasLeftHorn;
        this.head.getChild("right_horn").visible = p_480565_.hasRightHorn;
        if (p_480565_.rammingXHeadRot != 0.0F) {
            this.head.xRot = p_480565_.rammingXHeadRot;
        }
    }
}
