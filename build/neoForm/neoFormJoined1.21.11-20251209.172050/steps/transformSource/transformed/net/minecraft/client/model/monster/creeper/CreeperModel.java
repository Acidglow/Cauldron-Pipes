...
public class CreeperModel extends EntityModel<CreeperRenderState> {
    ...
    public CreeperModel(ModelPart p_481686_) {
        super(p_481686_);
        this.head = p_481686_.getChild("head");
        this.leftHindLeg = p_481686_.getChild("right_hind_leg");
        this.rightHindLeg = p_481686_.getChild("left_hind_leg");
        this.leftFrontLeg = p_481686_.getChild("right_front_leg");
        this.rightFrontLeg = p_481686_.getChild("left_front_leg");
    }
    ...
    public void setupAnim(CreeperRenderState p_481440_) {
        super.setupAnim(p_481440_);
        this.head.yRot = p_481440_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_481440_.xRot * (float) (Math.PI / 180.0);
        float f = p_481440_.walkAnimationSpeed;
        float f1 = p_481440_.walkAnimationPos;
