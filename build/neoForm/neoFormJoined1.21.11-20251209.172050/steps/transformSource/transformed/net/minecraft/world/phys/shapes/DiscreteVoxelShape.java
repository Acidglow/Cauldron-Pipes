...
public abstract class DiscreteVoxelShape {
                ...
                for (int i1 = 0; i1 < this.ySize; i1++) {
                    for (int j1 = 0; j1 < this.zSize; j1++) {
                        if (this.isFull(l, i1, j1)) {
                            Vector3i vector3i1 = octahedralGroup.rotate(vector3i.set(l, i1, j1));
    ...
    private static int fixupCoordinate(Vector3i coordinate, int axis) {
        int i = coordinate.get(axis);
        if (i < 0) {
