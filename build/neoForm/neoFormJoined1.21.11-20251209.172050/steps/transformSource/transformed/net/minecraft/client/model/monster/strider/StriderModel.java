...
public class StriderModel extends EntityModel<StriderRenderState> {
    ...
    public StriderModel(ModelPart p_478104_) {
        super(p_478104_);
        this.rightLeg = p_478104_.getChild("right_leg");
        this.leftLeg = p_478104_.getChild("left_leg");
        this.body = p_478104_.getChild("body");
    ...
    public void setupAnim(StriderRenderState p_479618_) {
        super.setupAnim(p_479618_);
        float f = p_479618_.walkAnimationPos;
        float f1 = Math.min(p_479618_.walkAnimationSpeed, 0.25F);
        if (!p_479618_.isRidden) {
            this.body.xRot = p_479618_.xRot * (float) (Math.PI / 180.0);
            this.body.yRot = p_479618_.yRot * (float) (Math.PI / 180.0);
        } else {
            this.body.xRot = 0.0F;
            this.body.yRot = 0.0F;
        }
        ...
        float f4 = 1.0F;
        float f5 = 1.0F;
        this.rightBottomBristle.zRot = this.rightBottomBristle.zRot + 0.05F * Mth.sin(p_479618_.ageInTicks * 1.0F * -0.4F);
        this.rightMiddleBristle.zRot = this.rightMiddleBristle.zRot + 0.1F * Mth.sin(p_479618_.ageInTicks * 1.0F * 0.2F);
        this.rightTopBristle.zRot = this.rightTopBristle.zRot + 0.1F * Mth.sin(p_479618_.ageInTicks * 1.0F * 0.4F);
        this.leftTopBristle.zRot = this.leftTopBristle.zRot + 0.1F * Mth.sin(p_479618_.ageInTicks * 1.0F * 0.4F);
        this.leftMiddleBristle.zRot = this.leftMiddleBristle.zRot + 0.1F * Mth.sin(p_479618_.ageInTicks * 1.0F * 0.2F);
        this.leftBottomBristle.zRot = this.leftBottomBristle.zRot + 0.05F * Mth.sin(p_479618_.ageInTicks * 1.0F * -0.4F);
    }
}
