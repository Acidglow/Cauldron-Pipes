...
public class CowVariants {
    ...
    private static void register(
        BootstrapContext<CowVariant> context, ResourceKey<CowVariant> key, CowVariant.ModelType model, String name, TagKey<Biome> spawnBiomes
    ) {
    ...
    private static void register(
        ...
        CowVariant.ModelType model,
        String name,
        SpawnPrioritySelectors spawnConditions
    ) {
        Identifier identifier = Identifier.withDefaultNamespace("entity/cow/" + name);
        context.register(key, new CowVariant(new ModelAndTexture<>(model, identifier), spawnConditions));
    }
}
