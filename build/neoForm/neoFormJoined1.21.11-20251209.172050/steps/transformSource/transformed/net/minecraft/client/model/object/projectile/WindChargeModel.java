...
public class WindChargeModel extends EntityModel<EntityRenderState> {
    ...
    public WindChargeModel(ModelPart p_479932_) {
        super(p_479932_, RenderTypes::entityTranslucent);
        this.bone = p_479932_.getChild("bone");
    ...
    public void setupAnim(EntityRenderState p_478276_) {
        super.setupAnim(p_478276_);
        this.windCharge.yRot = -p_478276_.ageInTicks * 16.0F * (float) (Math.PI / 180.0);
        this.wind.yRot = p_478276_.ageInTicks * 16.0F * (float) (Math.PI / 180.0);
    }
}
