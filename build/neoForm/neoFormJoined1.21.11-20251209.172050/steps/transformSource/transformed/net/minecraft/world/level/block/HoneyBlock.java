...
public class HoneyBlock extends HalfTransparentBlock {
    ...
    @Override
    public void fallOn(Level p_153372_, BlockState p_153373_, BlockPos p_153374_, Entity p_153375_, double p_396999_) {
        ...
        if (p_153375_.causeFallDamage(p_396999_, 0.2F, p_153372_.damageSources().fall())) {
            p_153375_.playSound(this.soundType.getFallSound(), this.soundType.getVolume() * 0.5F, this.soundType.getPitch() * 0.75F);
        }
    }

    @Override
    protected void entityInside(BlockState p_54003_, Level p_54004_, BlockPos p_54005_, Entity p_54006_, InsideBlockEffectApplier p_404924_, boolean p_451779_) {
        ...
        super.entityInside(p_54003_, p_54004_, p_54005_, p_54006_, p_404924_, p_451779_);
    }
    ...
    private boolean isSlidingDown(BlockPos pos, Entity entity) {
        if (entity.onGround()) {
            ...
            double d0 = Math.abs(pos.getX() + 0.5 - entity.getX());
            double d1 = Math.abs(pos.getZ() + 0.5 - entity.getZ());
            double d2 = 0.4375 + entity.getBbWidth() / 2.0F;
