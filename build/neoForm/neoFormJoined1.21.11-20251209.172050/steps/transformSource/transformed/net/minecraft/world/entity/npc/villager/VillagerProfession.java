...
public record VillagerProfession(
    ...
    public static final Predicate<Holder<PoiType>> ALL_ACQUIRABLE_JOBS = p_481582_ -> p_481582_.is(PoiTypeTags.ACQUIRABLE_JOB_SITE);
    ...
    private static VillagerProfession register(
        Registry<VillagerProfession> registry, ResourceKey<VillagerProfession> key, ResourceKey<PoiType> jobSite, @Nullable SoundEvent workSound
    ) {
        return register(registry, key, p_481848_ -> p_481848_.is(jobSite), p_481135_ -> p_481135_.is(jobSite), workSound);
    }
    ...
    private static VillagerProfession register(
        ...
        return register(registry, key, heldJobSite, acquirableJobSite, ImmutableSet.of(), ImmutableSet.of(), workSound);
    }
    ...
    private static VillagerProfession register(
        ...
        return register(registry, key, p_479159_ -> p_479159_.is(jobSite), p_480352_ -> p_480352_.is(jobSite), requestedItems, secondaryPoi, workSound);
    }
