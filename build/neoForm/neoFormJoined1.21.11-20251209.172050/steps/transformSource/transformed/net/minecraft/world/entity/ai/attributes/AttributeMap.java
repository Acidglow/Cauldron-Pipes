...
public class AttributeMap {
    ...
    public void addTransientAttributeModifiers(Multimap<Holder<Attribute>, AttributeModifier> modifiers) {
        modifiers.forEach((p_466547_, p_466548_) -> {
            AttributeInstance attributeinstance = this.getInstance((Holder<Attribute>)p_466547_);
            if (attributeinstance != null) {
                attributeinstance.removeModifier(p_466548_.id());
                attributeinstance.addTransientModifier(p_466548_);
            }
        });
    }
    ...
    public void removeAttributeModifiers(Multimap<Holder<Attribute>, AttributeModifier> modifiers) {
        modifiers.asMap().forEach((p_344297_, p_344298_) -> {
            ...
            if (attributeinstance != null) {
                p_344298_.forEach(p_466550_ -> attributeinstance.removeModifier(p_466550_.id()));
            }
        });
    }
