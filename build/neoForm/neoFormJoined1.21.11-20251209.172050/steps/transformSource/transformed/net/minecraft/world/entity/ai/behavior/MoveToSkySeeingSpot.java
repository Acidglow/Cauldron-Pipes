...
public class MoveToSkySeeingSpot {
    public static OneShot<LivingEntity> create(float speedModifier) {
        return BehaviorBuilder.create(
            p_258543_ -> p_258543_.group(p_258543_.absent(MemoryModuleType.WALK_TARGET)).apply(p_258543_, p_258545_ -> (p_466573_, p_466574_, p_466575_) -> {
                if (p_466573_.canSeeSky(p_466574_.blockPosition())) {
                    return false;
                } else {
                    Optional<Vec3> optional = Optional.ofNullable(getOutdoorPosition(p_466573_, p_466574_));
