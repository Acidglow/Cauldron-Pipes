...
public class Beardifier implements DensityFunctions.BeardifierOrMarker {
    ...
    @Override
    public void fillArray(double[] p_435636_, DensityFunction.ContextProvider p_435864_) {
        if (this.affectedBox == null) {
            Arrays.fill(p_435636_, 0.0);
        } else {
            DensityFunctions.BeardifierOrMarker.super.fillArray(p_435636_, p_435864_);
        }
    }
