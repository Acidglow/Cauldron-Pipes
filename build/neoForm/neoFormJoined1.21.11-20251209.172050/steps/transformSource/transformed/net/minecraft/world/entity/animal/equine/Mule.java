...
public class Mule extends AbstractChestedHorse {
    public Mule(EntityType<? extends Mule> p_479146_, Level p_481978_) {
        super(p_479146_, p_481978_);
    }
    ...
    @Override
    public @Nullable AgeableMob getBreedOffspring(ServerLevel p_482055_, AgeableMob p_482050_) {
        return EntityType.MULE.create(p_482055_, EntitySpawnReason.BREEDING);
    }
}
