...
public class RavagerModel extends EntityModel<RavagerRenderState> {
    ...
    public RavagerModel(ModelPart p_481297_) {
        super(p_481297_);
        this.neck = p_481297_.getChild("neck");
        this.head = this.neck.getChild("head");
        this.mouth = this.head.getChild("mouth");
        this.rightHindLeg = p_481297_.getChild("right_hind_leg");
        this.leftHindLeg = p_481297_.getChild("left_hind_leg");
        this.rightFrontLeg = p_481297_.getChild("right_front_leg");
        this.leftFrontLeg = p_481297_.getChild("left_front_leg");
    }
    ...
    public void setupAnim(RavagerRenderState p_481870_) {
        super.setupAnim(p_481870_);
        float f = p_481870_.stunnedTicksRemaining;
        float f1 = p_481870_.attackTicksRemaining;
        int i = 10;
        if (f1 > 0.0F) {
            ...
            } else if (p_481870_.roarAnimation > 0.0) {
                float f10 = Mth.sin(p_481870_.roarAnimation * (float) Math.PI * 0.25F);
                this.mouth.xRot = (float) (Math.PI / 2) * f10;
            }
        }

        this.head.xRot = p_481870_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_481870_.yRot * (float) (Math.PI / 180.0);
        float f7 = p_481870_.walkAnimationPos;
        float f9 = 0.4F * p_481870_.walkAnimationSpeed;
