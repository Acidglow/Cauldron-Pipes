        ...
        ChannelFuture channelfuture = new ServerBootstrap()
            ...
            .childHandler(
                new ChannelInitializer<Channel>() {
                    @Override
                    protected void initChannel(Channel p_442866_) {
                        try {
                            p_442866_.config().setOption(ChannelOption.TCP_NODELAY, true);
                        } catch (ChannelException channelexception) {
                        }

                        ChannelPipeline channelpipeline = p_442866_.pipeline();
                        if (context != null) {
                            channelpipeline.addLast(context.newHandler(p_442866_.alloc()));
                        }
                        ...
                        channelpipeline.addLast(new HttpServerCodec())
                            ...
                            .addLast(new Connection(p_442866_, ManagementServer.this, api, jsonrpclogger));
                    }
                }
            )
