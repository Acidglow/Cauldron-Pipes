...
public class Noises {
    ...
    public static NormalNoise instantiate(
        ...
        Holder<NormalNoise.NoiseParameters> holder = noises.getOrThrow(resourceKey);
        return NormalNoise.create(random.fromHashOf(holder.unwrapKey().orElseThrow().identifier()), holder.value());
    }
}
