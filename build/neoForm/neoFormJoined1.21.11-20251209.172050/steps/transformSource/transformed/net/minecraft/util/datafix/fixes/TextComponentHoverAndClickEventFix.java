    ...
    private <C1, C2, H extends Pair<String, ?>> TypeRewriteRule createFixer(Type<C1> inputComponentType, Type<C2> outputComponentType, Type<H> hoverEventType) {
        ...
        if (!type.equals(this.getInputSchema().getType(References.TEXT_COMPONENT))) {
            ...
            return this.fixTypeEverywhere(
                ...
                outputComponentType,
                p_394396_ -> p_466483_ -> {
                    boolean flag = p_466483_.getSecond().map(p_394057_ -> false, p_394065_ -> {
                    ...
                    return (C2)(!flag
                        ...
                        : Util.writeAndReadTypedOrThrow(
                                ExtraDataFixUtils.cast(type1, p_466483_, p_394396_), outputComponentType, TextComponentHoverAndClickEventFix::fixTextComponent
                            )
                            .getValue());
                }
            );
