...
public class ModelTemplates {
    ...
    public static final ModelTemplate[] STEMS = IntStream.range(0, 8)
        .mapToObj(p_386777_ -> create("stem_growth" + p_386777_, "_stage" + p_386777_, TextureSlot.STEM))
    ...
    public static ModelTemplate createItem(String name, TextureSlot... requiredSlots) {
        return new ModelTemplate(Optional.of(ModelLocationUtils.decorateItemModelLocation(name)), Optional.empty(), requiredSlots);
    }

    public static ModelTemplate createItem(String name, String suffix, TextureSlot... requiredSlots) {
        return new ModelTemplate(Optional.of(ModelLocationUtils.decorateItemModelLocation(name)), Optional.of(suffix), requiredSlots);
    }

    public static ModelTemplate create(String name, String suffix, TextureSlot... requiredSlots) {
        return new ModelTemplate(Optional.of(ModelLocationUtils.decorateBlockModelLocation(name)), Optional.of(suffix), requiredSlots);
    }
}
