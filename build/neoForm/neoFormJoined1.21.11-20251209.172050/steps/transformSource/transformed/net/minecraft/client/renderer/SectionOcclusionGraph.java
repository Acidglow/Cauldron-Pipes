...
public class SectionOcclusionGraph {
    ...
    private SectionRenderDispatcher.@Nullable RenderSection getRelativeFrom(
        long sectionPos, SectionRenderDispatcher.RenderSection section, Direction direction
    ) {
    ...
    static class SectionToNodeMap {
        ...
        public SectionOcclusionGraph.@Nullable Node get(SectionRenderDispatcher.RenderSection section) {
            int i = section.index;
