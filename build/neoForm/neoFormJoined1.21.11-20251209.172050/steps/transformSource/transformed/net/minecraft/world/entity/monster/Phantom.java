...
public class Phantom extends Mob implements Enemy {
    ...
    @Override
    protected void checkFallDamage(double p_416149_, boolean p_416567_, BlockState p_416240_, BlockPos p_416722_) {
    }
    ...
    @Override
    public void travel(Vec3 p_416093_) {
        this.travelFlying(p_416093_, 0.2F);
    }

    @Override
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_33126_, DifficultyInstance p_33127_, EntitySpawnReason p_364084_, @Nullable SpawnGroupData p_33129_
    ) {
        this.anchorPoint = this.blockPosition().above(5);
        this.setPhantomSize(0);
        return super.finalizeSpawn(p_33126_, p_33127_, p_364084_, p_33129_);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_421906_) {
        super.readAdditionalSaveData(p_421906_);
        this.anchorPoint = p_421906_.read("anchor_pos", BlockPos.CODEC).orElse(null);
        this.setPhantomSize(p_421906_.getIntOr("size", 0));
    }

    @Override
    protected void addAdditionalSaveData(ValueOutput p_422420_) {
        super.addAdditionalSaveData(p_422420_);
        p_422420_.storeNullable("anchor_pos", BlockPos.CODEC, this.anchorPoint);
        p_422420_.putInt("size", this.getPhantomSize());
    }
