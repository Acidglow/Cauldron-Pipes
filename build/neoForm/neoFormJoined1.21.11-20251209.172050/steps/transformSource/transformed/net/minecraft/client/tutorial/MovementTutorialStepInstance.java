...
public class MovementTutorialStepInstance implements TutorialStepInstance {
    ...
    @Override
    public void onInput(ClientInput p_371386_) {
        if (p_371386_.keyPresses.forward()
            || p_371386_.keyPresses.backward()
            || p_371386_.keyPresses.left()
            || p_371386_.keyPresses.right()
            || p_371386_.keyPresses.jump()) {
            this.moved = true;
        }
    }
