...
public class Goat extends Animal {
    ...
    public ItemStack createHorn() {
        ...
        return this.level()
            ...
            .map(p_361652_ -> InstrumentItem.create(Items.GOAT_HORN, (Holder<Instrument>)p_361652_))
    ...
    @Override
    protected int calculateFallDamage(double p_397533_, float p_149389_) {
        return super.calculateFallDamage(p_397533_, p_149389_) - 10;
    }
    ...
    @Override
    protected void customServerAiStep(ServerLevel p_376813_) {
        ProfilerFiller profilerfiller = Profiler.get();
        profilerfiller.push("goatBrain");
        this.getBrain().tick(p_376813_, this);
        profilerfiller.pop();
        profilerfiller.push("goatActivityUpdate");
        GoatAi.updateActivity(this);
        profilerfiller.pop();
        super.customServerAiStep(p_376813_);
    }
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_149365_, DifficultyInstance p_149366_, EntitySpawnReason p_360901_, @Nullable SpawnGroupData p_149368_
    ) {
        ...
        return super.finalizeSpawn(p_149365_, p_149366_, p_360901_, p_149368_);
    }
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_422084_) {
        super.addAdditionalSaveData(p_422084_);
        p_422084_.putBoolean("IsScreamingGoat", this.isScreamingGoat());
        p_422084_.putBoolean("HasLeftHorn", this.hasLeftHorn());
        p_422084_.putBoolean("HasRightHorn", this.hasRightHorn());
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_421703_) {
        super.readAdditionalSaveData(p_421703_);
        this.setScreamingGoat(p_421703_.getBooleanOr("IsScreamingGoat", false));
        this.entityData.set(DATA_HAS_LEFT_HORN, p_421703_.getBooleanOr("HasLeftHorn", true));
        this.entityData.set(DATA_HAS_RIGHT_HORN, p_421703_.getBooleanOr("HasRightHorn", true));
    }
