...
public class DerivedLevelData implements ServerLevelData {
    ...
    @Override
    public void setSpawn(LevelData.RespawnData p_451281_) {
        this.wrapped.setSpawn(p_451281_);
    }
    ...
    @Override
    public void setLegacyWorldBorderSettings(Optional<WorldBorder.Settings> p_446958_) {
    }
