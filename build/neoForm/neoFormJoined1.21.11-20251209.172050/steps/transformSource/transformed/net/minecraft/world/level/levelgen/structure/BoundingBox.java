...
public class BoundingBox {
    ...
    public static final Codec<BoundingBox> CODEC = Codec.INT_STREAM
        .<BoundingBox>comapFlatMap(
            p_466721_ -> Util.fixedSize(p_466721_, 6)
    ...
    public static final StreamCodec<ByteBuf, BoundingBox> STREAM_CODEC = StreamCodec.composite(
        ...
        p_448999_ -> new BlockPos(p_448999_.minX, p_448999_.minY, p_448999_.minZ),
        BlockPos.STREAM_CODEC,
        p_449002_ -> new BlockPos(p_449002_.maxX, p_449002_.maxY, p_449002_.maxZ),
        (p_449000_, p_449001_) -> new BoundingBox(p_449000_.getX(), p_449000_.getY(), p_449000_.getZ(), p_449001_.getX(), p_449001_.getY(), p_449001_.getZ())
    );
    private int minX;
    private int minY;
    private int minZ;
