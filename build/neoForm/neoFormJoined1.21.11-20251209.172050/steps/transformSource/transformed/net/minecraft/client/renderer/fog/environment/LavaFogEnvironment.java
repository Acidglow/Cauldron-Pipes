...
public class LavaFogEnvironment extends FogEnvironment {
    ...
    @Override
    public void setupFog(FogData p_423517_, Camera p_454779_, ClientLevel p_423495_, float p_423631_, DeltaTracker p_423491_) {
        if (p_454779_.entity().isSpectator()) {
            p_423517_.environmentalStart = -8.0F;
            p_423517_.environmentalEnd = p_423631_ * 0.5F;
        } else if (p_454779_.entity() instanceof LivingEntity livingentity && livingentity.hasEffect(MobEffects.FIRE_RESISTANCE)) {
