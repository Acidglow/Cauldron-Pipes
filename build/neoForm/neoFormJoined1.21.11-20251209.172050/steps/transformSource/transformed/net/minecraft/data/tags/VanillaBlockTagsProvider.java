...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    ...
    protected void addTags(HolderLookup.Provider p_255662_) {
        (new BlockItemTagsProvider() {
            @Override
            protected TagAppender<Block, Block> tag(TagKey<Block> p_421596_, TagKey<Item> p_422551_) {
                return VanillaBlockTagsProvider.this.tag(p_421596_);
            }
        }).run();
        ...
        this.tag(BlockTags.REPLACEABLE)
            .addAll(
                p_255662_.lookupOrThrow(Registries.BLOCK)
                    ...
                    .filter(p_359461_ -> p_359461_.defaultBlockState().canBeReplaced())
            );
