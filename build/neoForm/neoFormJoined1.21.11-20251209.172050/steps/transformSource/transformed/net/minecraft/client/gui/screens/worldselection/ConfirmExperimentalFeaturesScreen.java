...
public class ConfirmExperimentalFeaturesScreen extends Screen {
    ...
    class DetailsScreen extends Screen {
        ...
        class PackListEntry extends ObjectSelectionList.Entry<ConfirmExperimentalFeaturesScreen.DetailsScreen.PackListEntry> {
            ...
            @Override
            public void renderContent(GuiGraphics p_439291_, int p_440652_, int p_439867_, boolean p_439187_, float p_439661_) {
                ActiveTextCollector activetextcollector = p_439291_.textRenderer();
                p_439291_.drawString(DetailsScreen.this.minecraft.font, this.packId, this.getContentX(), this.getContentY(), -1);
