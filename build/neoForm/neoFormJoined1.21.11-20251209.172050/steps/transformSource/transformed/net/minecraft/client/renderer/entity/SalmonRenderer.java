...
public class SalmonRenderer extends MobRenderer<Salmon, SalmonRenderState, SalmonModel> {
    ...
    public void extractRenderState(Salmon p_478989_, SalmonRenderState p_363993_, float p_363648_) {
        super.extractRenderState(p_478989_, p_363993_, p_363648_);
        p_363993_.variant = p_478989_.getVariant();
    }

    public Identifier getTextureLocation(SalmonRenderState p_365406_) {
