...
public class ClipContext {
    ...
    public static enum Block implements ClipContext.ShapeGetter {
        ...
        FALLDAMAGE_RESETTING(
            (p_460561_, p_460562_, p_460563_, p_460564_) -> {
                if (p_460561_.is(BlockTags.FALL_DAMAGE_RESETTING)) {
                    return Shapes.block();
                } else {
                    if (p_460564_ instanceof EntityCollisionContext entitycollisioncontext
                        && entitycollisioncontext.getEntity() != null
                        && entitycollisioncontext.getEntity().getType() == EntityType.PLAYER) {
                        if (p_460561_.is(Blocks.END_GATEWAY) || p_460561_.is(Blocks.END_PORTAL)) {
                            return Shapes.block();
                        }

                        if (p_460562_ instanceof ServerLevel serverlevel
                            && p_460561_.is(Blocks.NETHER_PORTAL)
