...
public class RecipeBookPage {
    ...
    public void init(Minecraft minecraft, int x, int y) {
        ...
        this.forwardButton = new ImageButton(
            x + 93, y + 137, 12, 17, PAGE_FORWARD_SPRITES, p_470733_ -> this.updateArrowButtons(), NEXT_PAGE_TEXT
        );
        this.forwardButton.setTooltip(Tooltip.create(NEXT_PAGE_TEXT));
        this.backButton = new ImageButton(
            x + 38, y + 137, 12, 17, PAGE_BACKWARD_SPRITES, p_470753_ -> this.updateArrowButtons(), PREVIOUS_PAGE_TEXT
        );
    ...
    public void renderTooltip(GuiGraphics guiGraphics, int x, int y) {
        if (this.minecraft.screen != null && this.hoveredButton != null && !this.overlay.isVisible()) {
            ...
            guiGraphics.setComponentTooltipForNextFrame(this.minecraft.font, this.hoveredButton.getTooltipText(itemstack), x, y, identifier);
        }
    }
