...
public class SpiderModel extends EntityModel<LivingEntityRenderState> {
    ...
    public SpiderModel(ModelPart p_480013_) {
        super(p_480013_);
        this.head = p_480013_.getChild("head");
        this.rightHindLeg = p_480013_.getChild("right_hind_leg");
        this.leftHindLeg = p_480013_.getChild("left_hind_leg");
        this.rightMiddleHindLeg = p_480013_.getChild("right_middle_hind_leg");
        this.leftMiddleHindLeg = p_480013_.getChild("left_middle_hind_leg");
        this.rightMiddleFrontLeg = p_480013_.getChild("right_middle_front_leg");
        this.leftMiddleFrontLeg = p_480013_.getChild("left_middle_front_leg");
        this.rightFrontLeg = p_480013_.getChild("right_front_leg");
        this.leftFrontLeg = p_480013_.getChild("left_front_leg");
    }
    ...
    public void setupAnim(LivingEntityRenderState p_480578_) {
        super.setupAnim(p_480578_);
        this.head.yRot = p_480578_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_480578_.xRot * (float) (Math.PI / 180.0);
