...
public interface AttributeModifier<Subject, Argument> {
    ...
    public record OverrideModifier<Value>() implements AttributeModifier<Value, Value> {
        ...
        @Override
        public Value apply(Value p_458170_, Value p_458127_) {
            return p_458127_;
        }

        @Override
        public Codec<Value> argumentCodec(EnvironmentAttribute<Value> p_457977_) {
            return p_457977_.valueCodec();
        }

        @Override
        public LerpFunction<Value> argumentKeyframeLerp(EnvironmentAttribute<Value> p_467925_) {
            return p_467925_.type().keyframeLerp();
        }
    }
}
