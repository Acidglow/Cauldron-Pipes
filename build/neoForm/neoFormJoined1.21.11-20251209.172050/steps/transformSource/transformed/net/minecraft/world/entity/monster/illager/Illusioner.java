...
public class Illusioner extends SpellcasterIllager implements RangedAttackMob {
    ...
    public Illusioner(EntityType<? extends Illusioner> p_480780_, Level p_478080_) {
        super(p_480780_, p_478080_);
        this.xpReward = 5;
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_480751_, DifficultyInstance p_481479_, EntitySpawnReason p_478167_, @Nullable SpawnGroupData p_481045_
    ) {
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Items.BOW));
        return super.finalizeSpawn(p_480751_, p_481479_, p_478167_, p_481045_);
    }
    ...
    public Vec3[] getIllusionOffsets(float partialTick) {
        if (this.clientSideIllusionTicks <= 0) {
            ...
            double d0 = (this.clientSideIllusionTicks - partialTick) / 3.0F;
            d0 = Math.pow(d0, 0.25);
    ...
    @Override
    public void applyRaidBuffs(ServerLevel p_480088_, int p_478712_, boolean p_479617_) {
    }
