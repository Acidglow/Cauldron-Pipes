...
public abstract class AbstractClientPlayer extends Player implements ClientAvatarEntity {
    ...
    @Override
    public Parrot.@Nullable Variant getParrotVariantOnShoulder(boolean p_447216_) {
        return (p_447216_ ? this.getShoulderParrotLeft() : this.getShoulderParrotRight()).orElse(null);
    }
