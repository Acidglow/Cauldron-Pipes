...
public record CatVariant(ClientAsset.ResourceTexture assetInfo, SpawnPrioritySelectors spawnConditions)
    ...
    public static final Codec<CatVariant> DIRECT_CODEC = RecordCodecBuilder.create(
        p_479970_ -> p_479970_.group(
            ...
            .apply(p_479970_, CatVariant::new)
    );
    public static final Codec<CatVariant> NETWORK_CODEC = RecordCodecBuilder.create(
        p_479905_ -> p_479905_.group(ClientAsset.ResourceTexture.DEFAULT_FIELD_CODEC.forGetter(CatVariant::assetInfo)).apply(p_479905_, CatVariant::new)
    );
    ...
    private CatVariant(ClientAsset.ResourceTexture p_480342_) {
        this(p_480342_, SpawnPrioritySelectors.EMPTY);
    }
