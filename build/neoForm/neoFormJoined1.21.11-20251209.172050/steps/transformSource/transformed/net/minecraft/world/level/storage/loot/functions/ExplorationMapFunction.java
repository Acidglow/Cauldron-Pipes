...
public class ExplorationMapFunction extends LootItemConditionalFunction {
        ...
        p_298641_ -> commonFields(p_298641_)
            .and(
                p_298641_.group(
                    ...
                    Codec.BYTE.optionalFieldOf("zoom", (byte)2).forGetter(p_298446_ -> p_298446_.zoom),
                    Codec.INT.optionalFieldOf("search_radius", 50).forGetter(p_298263_ -> p_298263_.searchRadius),
                    Codec.BOOL.optionalFieldOf("skip_existing_chunks", true).forGetter(p_299182_ -> p_299182_.skipKnownStructures)
                )
            )
    ...
    ExplorationMapFunction(
        List<LootItemCondition> conditions, TagKey<Structure> destination, Holder<MapDecorationType> mapDecoration, byte zoom, int searchRadius, boolean skipKnownStructures
    ) {
        super(conditions);
