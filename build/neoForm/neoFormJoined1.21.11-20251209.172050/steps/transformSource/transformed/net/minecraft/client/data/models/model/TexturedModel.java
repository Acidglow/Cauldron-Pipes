...
public class TexturedModel implements net.neoforged.neoforge.client.extensions.ITexturedModelExtension {
    ...
    public Identifier create(Block block, BiConsumer<Identifier, ModelInstance> output) {
        return this.template.create(block, this.mapping, output);
    }

    public Identifier createWithSuffix(Block block, String suffix, BiConsumer<Identifier, ModelInstance> output) {
    ...
    public interface Provider extends net.neoforged.neoforge.client.extensions.ITexturedModelExtension.Provider {
        ...
        default Identifier create(Block block, BiConsumer<Identifier, ModelInstance> output) {
            return this.get(block).create(block, output);
        }

        default Identifier createWithSuffix(Block block, String suffix, BiConsumer<Identifier, ModelInstance> output) {
