...
public class GrindstoneMenu extends AbstractContainerMenu {
    ...
    public GrindstoneMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
        ...
        this.addSlot(new Slot(this.resultSlots, 2, 129, 34) {
            ...
            public void onTake(Player p_150574_, ItemStack p_150575_) {
                if (net.neoforged.neoforge.common.CommonHooks.onGrindstoneTake(GrindstoneMenu.this.repairSlots, access, p_150574_, this::getExperienceAmount)) return;
    ...
    private ItemStack mergeItems(ItemStack inputItem, ItemStack additionalItem) {
        if (!inputItem.is(additionalItem.getItem())) {
            ...
            int l = j + k + i * 5 / 100;
            int i1 = 1;
            if (!inputItem.isDamageableItem() || !inputItem.isCombineRepairable()) {
            ...
            if (itemstack.isDamageableItem()) {
                ...
                if (!additionalItem.isCombineRepairable()) itemstack.setDamageValue(inputItem.getDamageValue());
            }
