...
public class HappyGhastModel extends EntityModel<HappyGhastRenderState> {
    ...
    public HappyGhastModel(ModelPart p_479264_) {
        super(p_479264_);
        this.body = p_479264_.getChild("body");
    ...
    public void setupAnim(HappyGhastRenderState p_479105_) {
        super.setupAnim(p_479105_);
        if (!p_479105_.bodyItem.isEmpty()) {
            this.body.xScale = 0.9375F;
            this.body.yScale = 0.9375F;
            this.body.zScale = 0.9375F;
        }

        GhastModel.animateTentacles(p_479105_, this.tentacles);
    }
}
