...
public class BlindnessFogEnvironment extends MobEffectFogEnvironment {
    ...
    @Override
    public void setupFog(FogData p_423496_, Camera p_454856_, ClientLevel p_423609_, float p_423576_, DeltaTracker p_423570_) {
        if (p_454856_.entity() instanceof LivingEntity livingentity) {
