...
public class ChatReportScreen extends AbstractReportScreen<ChatReport.Builder> {
    ...
    protected void addContent() {
        ...
        this.selectReasonButton = Button.builder(
                SELECT_REASON,
                p_359098_ -> this.minecraft.setScreen(new ReportReasonSelectionScreen(this, this.reportBuilder.reason(), ReportType.CHAT, p_299789_ -> {
    ...
    @Override
    public boolean mouseReleased(MouseButtonEvent p_446448_) {
        return super.mouseReleased(p_446448_) ? true : this.commentBox.mouseReleased(p_446448_);
    }
}
