...
public class EvokerFangsModel extends EntityModel<EvokerFangsRenderState> {
    ...
    public EvokerFangsModel(ModelPart p_481077_) {
        super(p_481077_);
        this.base = p_481077_.getChild("base");
    ...
    public void setupAnim(EvokerFangsRenderState p_480222_) {
        super.setupAnim(p_480222_);
        float f = p_480222_.biteProgress;
