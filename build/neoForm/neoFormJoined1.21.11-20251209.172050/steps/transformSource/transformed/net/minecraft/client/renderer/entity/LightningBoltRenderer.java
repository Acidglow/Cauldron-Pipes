...
public class LightningBoltRenderer extends EntityRenderer<LightningBolt, LightningBoltRenderState> {
    ...
    public void submit(LightningBoltRenderState p_433100_, PoseStack p_435280_, SubmitNodeCollector p_433826_, CameraRenderState p_451052_) {
        float[] afloat = new float[8];
        float[] afloat1 = new float[8];
        float f = 0.0F;
        float f1 = 0.0F;
        RandomSource randomsource = RandomSource.create(p_433100_.seed);
        ...
        float f2 = f;
        float f3 = f1;
        p_433826_.submitCustomGeometry(p_435280_, RenderTypes.lightning(), (p_434636_, p_432984_) -> {
            Matrix4f matrix4f = p_434636_.pose();

            for (int j = 0; j < 4; j++) {
                RandomSource randomsource1 = RandomSource.create(p_433100_.seed);
    ...
    public void extractRenderState(LightningBolt p_365212_, LightningBoltRenderState p_362459_, float p_364965_) {
        super.extractRenderState(p_365212_, p_362459_, p_364965_);
        p_362459_.seed = p_365212_.seed;
    }

    protected boolean affectedByCulling(LightningBolt p_364219_) {
        return false;
    }
}
