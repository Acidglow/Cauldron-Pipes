...
public class V1460 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:arrow", p_17683_ -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(schema)));
        ...
        schema.register(
            ...
            p_392913_ -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema), "LastOutput", References.TEXT_COMPONENT.in(schema))
        );
        ...
        schema.register(
            map,
            "minecraft:donkey",
            p_396597_ -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema))
        );
        ...
        schema.register(map, "minecraft:enderman", p_17677_ -> DSL.optionalFields("carriedBlockState", References.BLOCK_STATE.in(schema)));
        ...
        schema.register(map, "minecraft:fireworks_rocket", p_396612_ -> DSL.optionalFields("FireworksItem", References.ITEM_STACK.in(schema)));
        schema.register(map, "minecraft:furnace_minecart", p_396608_ -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema)));
        ...
        schema.register(
            map,
            "minecraft:horse",
            p_396595_ -> DSL.optionalFields("ArmorItem", References.ITEM_STACK.in(schema), "SaddleItem", References.ITEM_STACK.in(schema))
        );
        ...
        schema.register(map, "minecraft:minecart", p_17634_ -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema)));
        registerMob(schema, map, "minecraft:mooshroom");
        schema.register(
            map,
            "minecraft:mule",
            p_396614_ -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema))
        );
        ...
        schema.register(map, "minecraft:skeleton_horse", p_17665_ -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema)));
        ...
        schema.register(map, "minecraft:zombie_horse", p_396610_ -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema)));
        registerMob(schema, map, "minecraft:zombie_pigman");
        schema.register(
            map,
            "minecraft:zombie_villager",
            p_396606_ -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in(schema))))
        );
        return map;
    }
    ...
    public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
        schema.registerType(
            ...
            () -> DSL.optionalFields(
                "CustomBossEvents",
                DSL.compoundList(DSL.optionalFields("Name", References.TEXT_COMPONENT.in(schema))),
                References.LIGHTWEIGHT_LEVEL.in(schema)
            )
        );
        ...
        schema.registerType(
            ...
            () -> DSL.hook(
                DSL.optionalFields("id", References.ITEM_NAME.in(schema), "tag", V99.itemStackTag(schema)), V705.ADD_NAMES, HookFunction.IDENTITY
            )
        );
