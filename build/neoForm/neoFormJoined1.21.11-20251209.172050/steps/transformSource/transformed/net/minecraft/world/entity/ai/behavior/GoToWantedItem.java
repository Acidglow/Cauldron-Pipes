        ...
        return BehaviorBuilder.create(
            p_258371_ -> {
                ...
                return p_258371_.group(
                    ...
                    .apply(
                        p_258371_,
                        (p_258387_, p_258388_, p_258389_, p_258390_) -> (p_466561_, p_466562_, p_466563_) -> {
                            ItemEntity itementity = p_258371_.get(p_258389_);
                            if (p_258371_.tryGet(p_258390_).isEmpty()
                                && canWalkToItem.test(p_466562_)
                                && itementity.closerThan(p_466562_, maxDistToWalk)
                                && p_466562_.level().getWorldBorder().isWithinBounds(itementity.blockPosition())
                                && p_466562_.canPickUpLoot()) {
