...
public class EvokerRenderer<T extends SpellcasterIllager> extends IllagerRenderer<T, EvokerRenderState> {
    ...
    public Identifier getTextureLocation(EvokerRenderState p_361448_) {
    ...
    public void extractRenderState(T p_479838_, EvokerRenderState p_480479_, float p_364002_) {
        super.extractRenderState(p_479838_, p_480479_, p_364002_);
        p_480479_.isCastingSpell = p_479838_.isCastingSpell();
    }
}
