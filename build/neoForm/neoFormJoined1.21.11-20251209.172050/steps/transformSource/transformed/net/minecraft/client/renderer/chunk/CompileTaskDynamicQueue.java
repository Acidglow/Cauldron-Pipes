...
public class CompileTaskDynamicQueue {
    ...
    public synchronized SectionRenderDispatcher.RenderSection.@Nullable CompileTask poll(Vec3 cameraPosition) {
        int i = -1;
        int j = -1;
        ...
        while (listiterator.hasNext()) {
            ...
            if (sectionrenderdispatcher$rendersection$compiletask.isCancelled.get()) {
                ...
                double d2 = sectionrenderdispatcher$rendersection$compiletask.getRenderOrigin().distToCenterSqr(cameraPosition);
    ...
    private SectionRenderDispatcher.RenderSection.@Nullable CompileTask removeTaskByIndex(int index) {
