...
public class UnihexProvider implements GlyphProvider {
    ...
    public static class Definition implements GlyphProviderDefinition {
        public static final MapCodec<UnihexProvider.Definition> CODEC = RecordCodecBuilder.mapCodec(
            p_465484_ -> p_465484_.group(
                    Identifier.CODEC.fieldOf("hex_file").forGetter(p_465485_ -> p_465485_.hexFile),
                ...
                .apply(p_465484_, UnihexProvider.Definition::new)
        );
    ...
    record Glyph(UnihexProvider.LineData contents, int left, int right) implements UnbakedGlyph {
        ...
        @Override
        public BakedGlyph bake(UnbakedGlyph.Stitcher p_439528_) {
            return p_439528_.stitch(
                this.info(),
                new GlyphBitmap() {
                    @Override
                    ...
                    @Override
                    public void upload(int p_439387_, int p_439034_, GpuTexture p_440500_) {
                        ...
                        RenderSystem.getDevice()
                            ...
                            .writeToTexture(
                                p_440500_, MemoryUtil.memByteBuffer(intbuffer), NativeImage.Format.RGBA, 0, 0, p_439387_, p_439034_, Glyph.this.width(), 16
                            );
    ...
    public interface ReaderOutput {
        void accept(int codepoint, UnihexProvider.LineData lineData);
    }
