...
public class WitchModel extends EntityModel<WitchRenderState> implements HeadedModel, VillagerLikeModel<WitchRenderState> {
    ...
    public WitchModel(ModelPart p_481735_) {
        super(p_481735_);
        this.head = p_481735_.getChild("head");
        this.nose = this.head.getChild("nose");
        this.rightLeg = p_481735_.getChild("right_leg");
        this.leftLeg = p_481735_.getChild("left_leg");
        this.arms = p_481735_.getChild("arms");
    }
    ...
    public void setupAnim(WitchRenderState p_480858_) {
        super.setupAnim(p_480858_);
        this.head.yRot = p_480858_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_480858_.xRot * (float) (Math.PI / 180.0);
        this.rightLeg.xRot = Mth.cos(p_480858_.walkAnimationPos * 0.6662F) * 1.4F * p_480858_.walkAnimationSpeed * 0.5F;
        this.leftLeg.xRot = Mth.cos(p_480858_.walkAnimationPos * 0.6662F + (float) Math.PI) * 1.4F * p_480858_.walkAnimationSpeed * 0.5F;
        float f = 0.01F * (p_480858_.entityId % 10);
        this.nose.xRot = Mth.sin(p_480858_.ageInTicks * f) * 4.5F * (float) (Math.PI / 180.0);
        this.nose.zRot = Mth.cos(p_480858_.ageInTicks * f) * 2.5F * (float) (Math.PI / 180.0);
        if (p_480858_.isHoldingItem) {
    ...
    public void translateToArms(WitchRenderState p_482073_, PoseStack p_481094_) {
        this.root.translateAndRotate(p_481094_);
        this.arms.translateAndRotate(p_481094_);
    }
}
