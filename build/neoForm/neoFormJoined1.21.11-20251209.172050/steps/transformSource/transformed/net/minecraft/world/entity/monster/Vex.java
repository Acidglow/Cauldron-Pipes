...
public class Vex extends Monster implements TraceableEntity {
    ...
    protected void readAdditionalSaveData(ValueInput p_422040_) {
        ...
        this.owner = EntityReference.read(p_422040_, "owner");
    }
    ...
    protected void addAdditionalSaveData(ValueOutput p_422240_) {
        ...
        EntityReference.store(this.owner, p_422240_, "owner");
    }
    ...
    public @Nullable SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_34002_, DifficultyInstance p_34003_, EntitySpawnReason p_364407_, @Nullable SpawnGroupData p_34005_
    ) {
