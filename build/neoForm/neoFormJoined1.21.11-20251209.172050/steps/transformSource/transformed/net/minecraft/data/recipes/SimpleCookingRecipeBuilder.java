...
public class SimpleCookingRecipeBuilder implements RecipeBuilder {
    ...
    @Override
    public void save(RecipeOutput p_301266_, ResourceKey<Recipe<?>> p_380371_) {
        this.ensureValid(p_380371_);
        Advancement.Builder advancement$builder = p_301266_.advancement()
            .addCriterion("has_the_recipe", RecipeUnlockedTrigger.unlocked(p_380371_))
            .rewards(AdvancementRewards.Builder.recipe(p_380371_))
        ...
        p_301266_.accept(
            p_380371_, abstractcookingrecipe, advancement$builder.build(p_380371_.identifier().withPrefix("recipes/" + this.category.getFolderName() + "/"))
        );
    }
