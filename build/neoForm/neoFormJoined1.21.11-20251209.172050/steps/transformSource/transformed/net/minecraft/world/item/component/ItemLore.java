...
public record ItemLore(List<Component> lines, List<Component> styledLines) implements TooltipProvider {
    ...
    public ItemLore(List<Component> p_330411_) {
        this(p_330411_, Lists.transform(p_330411_, p_457467_ -> ComponentUtils.mergeStyles(p_457467_, LORE_STYLE)));
    }
    ...
    @Override
    public void addToTooltip(Item.TooltipContext p_341353_, Consumer<Component> p_332116_, TooltipFlag p_330800_, DataComponentGetter p_399957_) {
