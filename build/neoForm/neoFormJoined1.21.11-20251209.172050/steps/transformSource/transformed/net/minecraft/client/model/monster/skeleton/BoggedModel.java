...
public class BoggedModel extends SkeletonModel<BoggedRenderState> {
    ...
    public BoggedModel(ModelPart p_481518_) {
        super(p_481518_);
        this.mushrooms = p_481518_.getChild("head").getChild("mushrooms");
    }
    ...
    public void setupAnim(BoggedRenderState p_481165_) {
        super.setupAnim(p_481165_);
        this.mushrooms.visible = !p_481165_.isSheared;
    }
}
