...
public class WardenModel extends EntityModel<WardenRenderState> {
    ...
    public static LayerDefinition createTendrilsLayer() {
        return createBodyLayer().apply(p_480035_ -> {
            p_480035_.getRoot().retainExactParts(Set.of("left_tendril", "right_tendril"));
            return p_480035_;
        });
    }

    public static LayerDefinition createHeartLayer() {
        return createBodyLayer().apply(p_478936_ -> {
            p_478936_.getRoot().retainExactParts(Set.of("body"));
            return p_478936_;
        });
    }

    public static LayerDefinition createBioluminescentLayer() {
        return createBodyLayer().apply(p_478311_ -> {
            p_478311_.getRoot().retainExactParts(Set.of("head", "left_arm", "right_arm", "left_leg", "right_leg"));
            return p_478311_;
        });
    }

    public static LayerDefinition createPulsatingSpotsLayer() {
        return createBodyLayer().apply(p_480154_ -> {
            p_480154_.getRoot().retainExactParts(Set.of("body", "head", "left_arm", "right_arm", "left_leg", "right_leg"));
            return p_480154_;
        });
    }

    public void setupAnim(WardenRenderState p_481083_) {
        super.setupAnim(p_481083_);
        this.animateHeadLookTarget(p_481083_.yRot, p_481083_.xRot);
        this.animateWalk(p_481083_.walkAnimationPos, p_481083_.walkAnimationSpeed);
        this.animateIdlePose(p_481083_.ageInTicks);
        this.animateTendrils(p_481083_, p_481083_.ageInTicks);
        this.attackAnimation.apply(p_481083_.attackAnimationState, p_481083_.ageInTicks);
        this.sonicBoomAnimation.apply(p_481083_.sonicBoomAnimationState, p_481083_.ageInTicks);
        this.diggingAnimation.apply(p_481083_.diggingAnimationState, p_481083_.ageInTicks);
        this.emergeAnimation.apply(p_481083_.emergeAnimationState, p_481083_.ageInTicks);
        this.roarAnimation.apply(p_481083_.roarAnimationState, p_481083_.ageInTicks);
        this.sniffAnimation.apply(p_481083_.sniffAnimationState, p_481083_.ageInTicks);
    }
