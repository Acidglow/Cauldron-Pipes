...
public record DirectoryLister(String sourcePath, String idPrefix) implements SpriteSource {
    ...
    public void run(ResourceManager p_261582_, SpriteSource.Output p_261898_) {
        ...
        filetoidconverter.listMatchingResources(p_261582_).forEach((p_465745_, p_465746_) -> {
            Identifier identifier = filetoidconverter.fileToId(p_465745_).withPrefix(this.idPrefix);
            p_261898_.add(identifier, p_465746_);
        });
    }
