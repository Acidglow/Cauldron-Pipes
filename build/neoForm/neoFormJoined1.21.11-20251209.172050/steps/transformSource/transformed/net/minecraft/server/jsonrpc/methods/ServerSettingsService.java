...
public class ServerSettingsService {
    ...
    public static PermissionLevel setOperatorUserPermissionLevel(MinecraftApi api, PermissionLevel operatorPermissionLevel, ClientInfo clientInfo) {
        return api.serverSettingsService().setOperatorUserPermissions(LevelBasedPermissionSet.forLevel(operatorPermissionLevel), clientInfo).level();
    }
