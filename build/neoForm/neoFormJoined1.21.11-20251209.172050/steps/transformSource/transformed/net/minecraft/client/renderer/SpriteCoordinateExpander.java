...
public class SpriteCoordinateExpander implements VertexConsumer {
    ...
    @Override
    public VertexConsumer setColor(int p_456077_) {
        return this.delegate.setColor(p_456077_);
    }
    ...
    @Override
    public VertexConsumer setLineWidth(float p_454923_) {
        this.delegate.setLineWidth(p_454923_);
        return this;
    }
