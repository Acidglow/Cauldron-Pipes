...
public class BookEditScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(
            Button.builder(SIGN_BOOK_LABEL, p_421281_ -> this.minecraft.setScreen(this.signScreen))
    ...
    @Override
    public boolean keyPressed(KeyEvent p_446119_) {
        switch (p_446119_.key()) {
            case 266:
                this.backButton.onPress(p_446119_);
                return true;
            case 267:
                this.forwardButton.onPress(p_446119_);
                return true;
            default:
                return super.keyPressed(p_446119_);
        }
    }
    ...
    public void renderBackground(GuiGraphics p_294860_, int p_295019_, int p_294307_, float p_295562_) {
        ...
        p_294860_.blit(RenderPipelines.GUI_TEXTURED, BookViewScreen.BOOK_LOCATION, this.backgroundLeft(), this.backgroundTop(), 0.0F, 0.0F, 192, 192, 256, 256);
    }
}
