...
public class TadpoleModel extends EntityModel<LivingEntityRenderState> {
    ...
    public TadpoleModel(ModelPart p_479886_) {
        super(p_479886_, RenderTypes::entityCutoutNoCull);
        this.tail = p_479886_.getChild("tail");
    }
    ...
    public void setupAnim(LivingEntityRenderState p_481645_) {
        super.setupAnim(p_481645_);
        float f = p_481645_.isInWater ? 1.0F : 1.5F;
        this.tail.yRot = -f * 0.25F * Mth.sin(0.3F * p_481645_.ageInTicks);
    }
}
