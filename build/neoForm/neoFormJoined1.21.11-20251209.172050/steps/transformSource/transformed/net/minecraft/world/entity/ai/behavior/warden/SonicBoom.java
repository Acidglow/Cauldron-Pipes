...
public class SonicBoom extends Behavior<Warden> {
    ...
    protected void tick(ServerLevel p_217724_, Warden p_217725_, long p_217726_) {
        p_217725_.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).ifPresent(p_427044_ -> p_217725_.getLookControl().setLookAt(p_427044_.position()));
        if (!p_217725_.getBrain().hasMemoryValue(MemoryModuleType.SONIC_BOOM_SOUND_DELAY)
            ...
            p_217725_.getBrain()
                ...
                .ifPresent(p_375715_ -> {
                    ...
                    if (p_375715_.hurtServer(p_217724_, p_217724_.damageSources().sonicBoom(p_217725_), 10.0F)) {
