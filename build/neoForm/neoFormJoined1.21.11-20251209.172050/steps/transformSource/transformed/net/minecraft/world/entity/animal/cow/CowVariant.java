...
public record CowVariant(ModelAndTexture<CowVariant.ModelType> modelAndTexture, SpawnPrioritySelectors spawnConditions)
    ...
    public static final Codec<CowVariant> DIRECT_CODEC = RecordCodecBuilder.create(
        p_481302_ -> p_481302_.group(
            ...
            .apply(p_481302_, CowVariant::new)
    );
    public static final Codec<CowVariant> NETWORK_CODEC = RecordCodecBuilder.create(
        p_479441_ -> p_479441_.group(ModelAndTexture.codec(CowVariant.ModelType.CODEC, CowVariant.ModelType.NORMAL).forGetter(CowVariant::modelAndTexture))
            .apply(p_479441_, CowVariant::new)
    );
    ...
    private CowVariant(ModelAndTexture<CowVariant.ModelType> p_479802_) {
        this(p_479802_, SpawnPrioritySelectors.EMPTY);
    }
