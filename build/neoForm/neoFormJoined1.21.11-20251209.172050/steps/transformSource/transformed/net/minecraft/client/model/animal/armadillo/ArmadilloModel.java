...
public class ArmadilloModel extends EntityModel<ArmadilloRenderState> {
    ...
    public ArmadilloModel(ModelPart p_479764_) {
        super(p_479764_);
        this.body = p_479764_.getChild("body");
        this.rightHindLeg = p_479764_.getChild("right_hind_leg");
        this.leftHindLeg = p_479764_.getChild("left_hind_leg");
        this.head = this.body.getChild("head");
        this.tail = this.body.getChild("tail");
        this.cube = p_479764_.getChild("cube");
        this.walkAnimation = ArmadilloAnimation.ARMADILLO_WALK.bake(p_479764_);
        this.rollOutAnimation = ArmadilloAnimation.ARMADILLO_ROLL_OUT.bake(p_479764_);
        this.rollUpAnimation = ArmadilloAnimation.ARMADILLO_ROLL_UP.bake(p_479764_);
        this.peekAnimation = ArmadilloAnimation.ARMADILLO_PEEK.bake(p_479764_);
    }
    ...
    public void setupAnim(ArmadilloRenderState p_482070_) {
        super.setupAnim(p_482070_);
        if (p_482070_.isHidingInShell) {
            ...
            this.head.xRot = Mth.clamp(p_482070_.xRot, -22.5F, 25.0F) * (float) (Math.PI / 180.0);
            this.head.yRot = Mth.clamp(p_482070_.yRot, -32.5F, 32.5F) * (float) (Math.PI / 180.0);
        }

        this.walkAnimation.applyWalk(p_482070_.walkAnimationPos, p_482070_.walkAnimationSpeed, 16.5F, 2.5F);
        this.rollOutAnimation.apply(p_482070_.rollOutAnimationState, p_482070_.ageInTicks);
        this.rollUpAnimation.apply(p_482070_.rollUpAnimationState, p_482070_.ageInTicks);
        this.peekAnimation.apply(p_482070_.peekAnimationState, p_482070_.ageInTicks);
    }
}
