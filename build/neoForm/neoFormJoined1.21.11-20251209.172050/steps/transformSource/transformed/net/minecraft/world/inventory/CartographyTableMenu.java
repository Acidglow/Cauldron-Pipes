    ...
    public CartographyTableMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
        ...
        this.addSlot(new Slot(this.resultContainer, 2, 145, 39) {
            ...
            public void onTake(Player p_150509_, ItemStack p_150510_) {
                ...
                access.execute((p_457459_, p_457460_) -> {
                    long i = p_457459_.getGameTime();
                    if (CartographyTableMenu.this.lastSoundTime != i) {
                        p_457459_.playSound(null, p_457460_, SoundEvents.UI_CARTOGRAPHY_TABLE_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
