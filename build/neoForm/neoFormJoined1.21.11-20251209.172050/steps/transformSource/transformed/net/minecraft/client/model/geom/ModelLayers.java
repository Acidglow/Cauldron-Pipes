...
public class ModelLayers {
    ...
    private static ModelLayerLocation createLocation(String path, String model) {
        return new ModelLayerLocation(Identifier.withDefaultNamespace(path), model);
    }

    private static ArmorModelSet<ModelLayerLocation> registerArmorSet(String path) {
        return new ArmorModelSet<>(
            register(path, "helmet"), register(path, "chestplate"), register(path, "leggings"), register(path, "boots")
        );
    }

    public static ModelLayerLocation createStandingSignModelName(WoodType woodType) {
        Identifier location = Identifier.parse(woodType.name());
