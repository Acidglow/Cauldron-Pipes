...
public class PiglinBrute extends AbstractPiglin {
    ...
    public @Nullable SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_35058_, DifficultyInstance p_35059_, EntitySpawnReason p_364915_, @Nullable SpawnGroupData p_35061_
    ) {
        PiglinBruteAi.initMemories(this);
        this.populateDefaultEquipmentSlots(p_35058_.getRandom(), p_35059_);
        return super.finalizeSpawn(p_35058_, p_35059_, p_364915_, p_35061_);
    }
    ...
    @Override
    public boolean wantsToPickUp(ServerLevel p_376577_, ItemStack p_35078_) {
        return p_35078_.is(Items.GOLDEN_AXE) ? super.wantsToPickUp(p_376577_, p_35078_) : false;
    }

    @Override
    protected void customServerAiStep(ServerLevel p_376856_) {
        ProfilerFiller profilerfiller = Profiler.get();
        profilerfiller.push("piglinBruteBrain");
        this.getBrain().tick(p_376856_, this);
        profilerfiller.pop();
        PiglinBruteAi.updateActivity(this);
        PiglinBruteAi.maybePlayActivitySound(this);
        super.customServerAiStep(p_376856_);
    }
    ...
    @Override
    public boolean hurtServer(ServerLevel p_376247_, DamageSource p_376197_, float p_376798_) {
        boolean flag = super.hurtServer(p_376247_, p_376197_, p_376798_);
        if (flag && p_376197_.getEntity() instanceof LivingEntity livingentity) {
            PiglinBruteAi.wasHurtBy(p_376247_, this, livingentity);
        }
