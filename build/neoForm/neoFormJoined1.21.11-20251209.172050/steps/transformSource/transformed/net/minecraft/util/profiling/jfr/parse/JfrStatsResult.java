...
public record JfrStatsResult(
    ...
    public List<Pair<ChunkStatus, TimedStatSummary<ChunkGenStat>>> chunkGenSummary() {
        ...
        return map.entrySet()
            .stream()
            .map(p_454450_ -> Pair.of(p_454450_.getKey(), TimedStatSummary.summary(p_454450_.getValue())))
            .filter(p_454451_ -> p_454451_.getSecond().isPresent())
            .map(p_454452_ -> Pair.of(p_454452_.getFirst(), p_454452_.getSecond().get()))
            .sorted(
