...
public class WolfModel extends EntityModel<WolfRenderState> {
    ...
    public WolfModel(ModelPart p_478993_) {
        super(p_478993_);
        this.head = p_478993_.getChild("head");
        this.realHead = this.head.getChild("real_head");
        this.body = p_478993_.getChild("body");
        this.upperBody = p_478993_.getChild("upper_body");
        this.rightHindLeg = p_478993_.getChild("right_hind_leg");
        this.leftHindLeg = p_478993_.getChild("left_hind_leg");
        this.rightFrontLeg = p_478993_.getChild("right_front_leg");
        this.leftFrontLeg = p_478993_.getChild("left_front_leg");
        this.tail = p_478993_.getChild("tail");
    ...
    public static MeshDefinition createMeshDefinition(CubeDeformation cubeDeformation) {
        ...
        CubeListBuilder cubelistbuilder1 = CubeListBuilder.create().mirror().texOffs(0, 18).addBox(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, cubeDeformation);
    ...
    public void setupAnim(WolfRenderState p_481372_) {
        super.setupAnim(p_481372_);
        float f = p_481372_.walkAnimationPos;
        float f1 = p_481372_.walkAnimationSpeed;
        if (p_481372_.isAngry) {
            this.tail.yRot = 0.0F;
        } else {
            this.tail.yRot = Mth.cos(f * 0.6662F) * 1.4F * f1;
        }

        if (p_481372_.isSitting) {
            float f2 = p_481372_.ageScale;
        ...
        this.realHead.zRot = p_481372_.headRollAngle + p_481372_.getBodyRollAngle(0.0F);
        this.upperBody.zRot = p_481372_.getBodyRollAngle(-0.08F);
        this.body.zRot = p_481372_.getBodyRollAngle(-0.16F);
        this.realTail.zRot = p_481372_.getBodyRollAngle(-0.2F);
        this.head.xRot = p_481372_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_481372_.yRot * (float) (Math.PI / 180.0);
        this.tail.xRot = p_481372_.tailAngle;
    }
}
