...
public class SystemReport {
    ...
    public SystemReport() {
        ...
        this.setDetail("JVM Flags", () -> printJvmFlags(p_448678_ -> p_448678_.startsWith("-X")));
        this.setDetail("Debug Flags", () -> printJvmFlags(p_448677_ -> p_448677_.startsWith("-DMC_DEBUG_")));
    }
    ...
    private static String printJvmFlags(Predicate<String> predicate) {
        ...
        List<String> list1 = list.stream().filter(predicate).toList();
