...
public class DragonStrafePlayerPhase extends AbstractDragonPhaseInstance {
    ...
    @Override
    public void doServerTick(ServerLevel p_376857_) {
                ...
                if (this.dragon.hasLineOfSight(this.attackTarget)) {
                    ...
                    if (this.fireballCharge >= 5 && f >= 0.0F && f < 10.0F) {
                        ...
                        if (!this.dragon.isSilent()) {
                            p_376857_.levelEvent(null, 1017, this.dragon.blockPosition(), 0);
                        }

                        DragonFireball dragonfireball = new DragonFireball(p_376857_, this.dragon, vec31.normalize());
                        dragonfireball.snapTo(d6, d7, d8, 0.0F, 0.0F);
                        p_376857_.addFreshEntity(dragonfireball);
