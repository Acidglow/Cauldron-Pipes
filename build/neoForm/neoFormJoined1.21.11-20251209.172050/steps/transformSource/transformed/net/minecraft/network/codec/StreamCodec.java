...
public interface StreamCodec<B, V> extends StreamDecoder<B, V>, StreamEncoder<B, V> {
    ...
    static <B, C, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> StreamCodec<B, C> composite(
        ...
        return new StreamCodec<B, C>() {
            @Override
            public C decode(B p_425697_) {
                T1 t1 = codec1.decode(p_425697_);
                T2 t2 = codec2.decode(p_425697_);
                T3 t3 = codec3.decode(p_425697_);
                T4 t4 = codec4.decode(p_425697_);
                T5 t5 = codec5.decode(p_425697_);
                T6 t6 = codec6.decode(p_425697_);
                T7 t7 = codec7.decode(p_425697_);
                T8 t8 = codec8.decode(p_425697_);
                T9 t9 = codec9.decode(p_425697_);
                T10 t10 = codec10.decode(p_425697_);
                T11 t11 = codec11.decode(p_425697_);
                return factory.apply(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11);
            }

            @Override
            public void encode(B p_425873_, C p_425600_) {
                codec1.encode(p_425873_, getter1.apply(p_425600_));
                codec2.encode(p_425873_, getter2.apply(p_425600_));
                codec3.encode(p_425873_, getter3.apply(p_425600_));
                codec4.encode(p_425873_, getter4.apply(p_425600_));
                codec5.encode(p_425873_, getter5.apply(p_425600_));
                codec6.encode(p_425873_, getter6.apply(p_425600_));
                codec7.encode(p_425873_, getter7.apply(p_425600_));
                codec8.encode(p_425873_, getter8.apply(p_425600_));
                codec9.encode(p_425873_, getter9.apply(p_425600_));
                codec10.encode(p_425873_, getter10.apply(p_425600_));
                codec11.encode(p_425873_, getter11.apply(p_425600_));
            }
        };
    }
    ...
    static <B, C, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> StreamCodec<B, C> composite(
        ...
        return new StreamCodec<B, C>() {
            @Override
            public C decode(B p_455691_) {
                T1 t1 = codec1.decode(p_455691_);
                T2 t2 = codec2.decode(p_455691_);
                T3 t3 = codec3.decode(p_455691_);
                T4 t4 = codec4.decode(p_455691_);
                T5 t5 = codec5.decode(p_455691_);
                T6 t6 = codec6.decode(p_455691_);
                T7 t7 = codec7.decode(p_455691_);
                T8 t8 = codec8.decode(p_455691_);
                T9 t9 = codec9.decode(p_455691_);
                T10 t10 = codec10.decode(p_455691_);
                T11 t11 = codec11.decode(p_455691_);
                T12 t12 = codec12.decode(p_455691_);
                return factory.apply(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12);
            }

            @Override
            public void encode(B p_454898_, C p_454964_) {
                codec1.encode(p_454898_, getter1.apply(p_454964_));
                codec2.encode(p_454898_, getter2.apply(p_454964_));
                codec3.encode(p_454898_, getter3.apply(p_454964_));
                codec4.encode(p_454898_, getter4.apply(p_454964_));
                codec5.encode(p_454898_, getter5.apply(p_454964_));
                codec6.encode(p_454898_, getter6.apply(p_454964_));
                codec7.encode(p_454898_, getter7.apply(p_454964_));
                codec8.encode(p_454898_, getter8.apply(p_454964_));
                codec9.encode(p_454898_, getter9.apply(p_454964_));
                codec10.encode(p_454898_, getter10.apply(p_454964_));
                codec11.encode(p_454898_, getter11.apply(p_454964_));
                codec12.encode(p_454898_, getter12.apply(p_454964_));
            }
        };
    }
    ...
    static <B, T> StreamCodec<B, T> recursive(final UnaryOperator<StreamCodec<B, T>> modifier) {
        return new StreamCodec<B, T>() {
            ...
            @Override
            public T decode(B p_455222_) {
                return this.inner.get().decode(p_455222_);
            }

            @Override
            public void encode(B p_455653_, T p_456153_) {
                this.inner.get().encode(p_455653_, p_456153_);
            }
        };
    }
