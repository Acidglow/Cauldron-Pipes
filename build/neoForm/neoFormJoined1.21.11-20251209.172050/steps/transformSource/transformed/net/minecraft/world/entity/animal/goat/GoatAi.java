...
public class GoatAi {
    ...
    private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
        .selector(
            (p_460538_, p_460539_) -> !p_460538_.getType().equals(EntityType.GOAT)
                && (p_460539_.getGameRules().get(GameRules.MOB_GRIEFING) || !p_460538_.getType().equals(EntityType.ARMOR_STAND))
                && p_460539_.getWorldBorder().isWithinBounds(p_460538_.getBoundingBox())
        );
