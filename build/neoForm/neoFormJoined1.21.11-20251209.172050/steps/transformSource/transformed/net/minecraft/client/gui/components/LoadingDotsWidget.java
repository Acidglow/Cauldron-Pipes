...
public class LoadingDotsWidget extends AbstractWidget {
    ...
    protected void renderWidget(GuiGraphics p_295359_, int p_296296_, int p_294395_, float p_294654_) {
        ...
        p_295359_.drawString(this.font, component, i - this.font.width(component) / 2, j - 9, -1);
        String s = LoadingDotsText.get(Util.getMillis());
        p_295359_.drawString(this.font, s, i - this.font.width(s) / 2, j + 9, -8355712);
    }
    ...
    @Override
    public @Nullable ComponentPath nextFocusPath(FocusNavigationEvent p_306162_) {
        return null;
    }
}
