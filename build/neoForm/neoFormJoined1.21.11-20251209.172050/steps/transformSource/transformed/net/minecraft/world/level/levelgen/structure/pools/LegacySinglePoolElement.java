...
public class LegacySinglePoolElement extends SinglePoolElement {
    public static final MapCodec<LegacySinglePoolElement> CODEC = RecordCodecBuilder.mapCodec(
        p_404602_ -> p_404602_.group(templateCodec(), processorsCodec(), projectionCodec(), overrideLiquidSettingsCodec())
            .apply(p_404602_, LegacySinglePoolElement::new)
    );
    ...
    protected LegacySinglePoolElement(
        ...
        Optional<LiquidSettings> p_352209_
    ) {
    ...
    protected StructurePlaceSettings getSettings(Rotation p_210353_, BoundingBox p_210354_, LiquidSettings p_352069_, boolean p_210355_) {
        StructurePlaceSettings structureplacesettings = super.getSettings(p_210353_, p_210354_, p_352069_, p_210355_);
