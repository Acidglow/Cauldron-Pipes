...
public class Font implements net.neoforged.neoforge.client.extensions.IFontExtension {
    ...
    public void drawInBatch(
        ...
        Font.PreparedText font$preparedtext = this.prepareText(text.getVisualOrderText(), x, y, color, drawShadow, false, backgroundColor);
        font$preparedtext.visit(Font.GlyphVisitor.forMultiBufferSource(bufferSource, pose, mode, packedLightCoords));
    }
    ...
    public void drawInBatch(
        ...
        Font.PreparedText font$preparedtext = this.prepareText(text, x, y, color, drawShadow, false, backgroundColor);
        font$preparedtext.visit(Font.GlyphVisitor.forMultiBufferSource(bufferSource, pose, mode, packedLightCoords));
    }
    ...
    public void drawInBatch8xOutline(
        ...
        Font.PreparedTextBuilder font$preparedtextbuilder = new Font.PreparedTextBuilder(0.0F, 0.0F, backgroundColor, false, false);
        ...
        Font.PreparedTextBuilder font$preparedtextbuilder1 = new Font.PreparedTextBuilder(x, y, color, false, true);
    ...
    public Font.PreparedText prepareText(String text, float x, float y, int color, boolean drawShadow, int backgroundColor) {
        ...
        Font.PreparedTextBuilder font$preparedtextbuilder = new Font.PreparedTextBuilder(x, y, color, backgroundColor, drawShadow, false);
    ...
    public Font.PreparedText prepareText(
        FormattedCharSequence text, float x, float y, int color, boolean drawShadow, boolean includeEmpty, int backgroundColor
    ) {
        Font.PreparedTextBuilder font$preparedtextbuilder = new Font.PreparedTextBuilder(x, y, color, backgroundColor, drawShadow, includeEmpty);
    ...
    public interface GlyphVisitor {
        static Font.GlyphVisitor forMultiBufferSource(
            ...
            return new Font.GlyphVisitor() {
                @Override
                public void acceptGlyph(TextRenderable.Styled p_457582_) {
                    this.render(p_457582_);
                }
    ...
    class PreparedTextBuilder implements FormattedCharSink, Font.PreparedText {
        ...
        private void addGlyph(TextRenderable.Styled glyph) {
        ...
        public boolean accept(int positionInCurrentSequence, Style style, BakedGlyph glyph) {
            ...
            TextRenderable.Styled textrenderable$styled = glyph.createGlyph(this.x, this.y, i, j, style, f3, f2);
        ...
        public void visit(Font.GlyphVisitor p_425967_) {
            ...
            for (TextRenderable.Styled textrenderable$styled : this.glyphs) {
                p_425967_.acceptGlyph(textrenderable$styled);
            }

            if (this.effects != null) {
                for (TextRenderable textrenderable : this.effects) {
                    p_425967_.acceptEffect(textrenderable);
                }
            }

            if (this.emptyAreas != null) {
                for (EmptyArea emptyarea : this.emptyAreas) {
                    p_425967_.acceptEmptyArea(emptyarea);
                }
            }
        }
