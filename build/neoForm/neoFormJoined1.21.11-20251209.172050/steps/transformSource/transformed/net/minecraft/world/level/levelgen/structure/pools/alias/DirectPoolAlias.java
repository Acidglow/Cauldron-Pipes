...
public record DirectPoolAlias(ResourceKey<StructureTemplatePool> alias, ResourceKey<StructureTemplatePool> target) implements PoolAliasBinding {
    static MapCodec<DirectPoolAlias> CODEC = RecordCodecBuilder.mapCodec(
        p_405069_ -> p_405069_.group(
            ...
            .apply(p_405069_, DirectPoolAlias::new)
    );

    @Override
    public void forEachResolved(RandomSource p_405543_, BiConsumer<ResourceKey<StructureTemplatePool>, ResourceKey<StructureTemplatePool>> p_405626_) {
        p_405626_.accept(this.alias, this.target);
    }
