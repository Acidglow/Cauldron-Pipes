...
public class Avatar extends LivingEntity {
    ...
    protected Avatar(EntityType<? extends LivingEntity> p_446096_, Level p_447192_) {
        super(p_446096_, p_447192_);
    }

    @Override
    protected void defineSynchedData(SynchedEntityData.Builder p_446376_) {
        super.defineSynchedData(p_446376_);
        p_446376_.define(DATA_PLAYER_MAIN_HAND, DEFAULT_MAIN_HAND);
        p_446376_.define(DATA_PLAYER_MODE_CUSTOMISATION, (byte)0);
    }
    ...
    @Override
    public EntityDimensions getDefaultDimensions(Pose p_451644_) {
        return POSES.getOrDefault(p_451644_, STANDING_DIMENSIONS);
    }
}
