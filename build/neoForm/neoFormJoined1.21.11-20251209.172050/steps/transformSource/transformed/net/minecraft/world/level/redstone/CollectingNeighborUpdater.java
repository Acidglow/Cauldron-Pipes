...
public class CollectingNeighborUpdater implements NeighborUpdater {
    ...
    @Override
    public void neighborChanged(BlockPos p_230653_, Block p_230654_, @Nullable Orientation p_360627_) {
        this.addAndRun(p_230653_, new CollectingNeighborUpdater.SimpleNeighborUpdate(p_230653_, p_230654_, p_360627_));
    }

    @Override
    public void neighborChanged(BlockState p_230647_, BlockPos p_230648_, Block p_230649_, @Nullable Orientation p_363917_, boolean p_230651_) {
        this.addAndRun(p_230648_, new CollectingNeighborUpdater.FullNeighborUpdate(p_230647_, p_230648_.immutable(), p_230649_, p_363917_, p_230651_));
    }

    @Override
    public void updateNeighborsAtExceptFromFacing(BlockPos p_230657_, Block p_230658_, @Nullable Direction p_230659_, @Nullable Orientation p_365269_) {
        this.addAndRun(p_230657_, new CollectingNeighborUpdater.MultiNeighborUpdate(p_230657_.immutable(), p_230658_, p_365269_, p_230659_));
    }
    ...
    static final class MultiNeighborUpdate implements CollectingNeighborUpdater.NeighborUpdates {
        ...
        @Override
        public void forEachUpdatedPos(Consumer<BlockPos> p_449646_) {
            for (Direction direction : NeighborUpdater.UPDATE_ORDER) {
                if (direction != this.skipDirection) {
                    BlockPos blockpos = this.sourcePos.relative(direction);
                    p_449646_.accept(blockpos);
                }
            }
        }
    }
