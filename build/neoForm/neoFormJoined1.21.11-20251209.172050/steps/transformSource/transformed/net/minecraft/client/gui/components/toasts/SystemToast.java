...
public class SystemToast implements Toast {
    ...
    public void update(ToastManager p_364721_, long p_364544_) {
        ...
        double d0 = this.id.displayTime * p_364721_.getNotificationDisplayTimeMultiplier();
        long i = p_364544_ - this.lastChanged;
    ...
    public void render(GuiGraphics p_281624_, Font p_364768_, long p_282762_) {
        ...
        if (this.messageLines.isEmpty()) {
            ...
            for (int i = 0; i < this.messageLines.size(); i++) {
                p_281624_.drawString(p_364768_, this.messageLines.get(i), 18, 18 + i * 12, -1, false);
            }
        }
    }
