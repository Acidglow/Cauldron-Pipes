...
public class EnchantedCountIncreaseFunction extends LootItemConditionalFunction {
        ...
        p_346073_ -> commonFields(p_346073_)
            .and(
                p_346073_.group(
                    ...
                    Codec.INT.optionalFieldOf("limit", 0).forGetter(p_344886_ -> p_344886_.limit)
                )
            )
    ...
    public ItemStack run(ItemStack p_345285_, LootContext p_345560_) {
        Entity entity = p_345560_.getOptionalParameter(LootContextParams.ATTACKING_ENTITY);
        if (entity instanceof LivingEntity livingentity) {
            ...
            float f = i * this.value.getFloat(p_345560_);
