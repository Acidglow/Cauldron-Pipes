...
public class ToastManager {
    ...
    public <T extends Toast> @Nullable T getToast(Class<? extends T> toastClass, Object token) {
        for (ToastManager.ToastInstance<?> toastinstance : this.visibleToasts) {
            if (toastClass.isAssignableFrom(toastinstance.getToast().getClass()) && toastinstance.getToast().getToken().equals(token)) {
