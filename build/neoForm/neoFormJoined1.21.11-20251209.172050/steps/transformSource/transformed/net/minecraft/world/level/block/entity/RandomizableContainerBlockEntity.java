...
public abstract class RandomizableContainerBlockEntity extends BaseContainerBlockEntity implements RandomizableContainer {
    ...
    @Override
    protected void applyImplicitComponents(DataComponentGetter p_397239_) {
        super.applyImplicitComponents(p_397239_);
        SeededContainerLoot seededcontainerloot = p_397239_.get(DataComponents.CONTAINER_LOOT);
    ...
    @Override
    public void removeComponentsFromTag(ValueOutput p_422368_) {
        super.removeComponentsFromTag(p_422368_);
        p_422368_.discard("LootTable");
        p_422368_.discard("LootTableSeed");
    }
}
