...
public class CustomFeatureRenderer {
    ...
    public static class Storage {
        ...
        public void add(PoseStack poseStack, RenderType renderType, SubmitNodeCollector.CustomGeometryRenderer customGeometryRenderer) {
            List<SubmitNodeStorage.CustomGeometrySubmit> list = this.customGeometrySubmits.computeIfAbsent(renderType, p_458959_ -> new ArrayList<>());
        ...
        public void endFrame() {
            this.customGeometrySubmits.keySet().removeIf(p_459161_ -> !this.customGeometrySubmitsUsage.contains(p_459161_));
