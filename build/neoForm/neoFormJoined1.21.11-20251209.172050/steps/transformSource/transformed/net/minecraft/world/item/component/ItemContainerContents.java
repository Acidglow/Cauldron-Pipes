...
public final class ItemContainerContents implements TooltipProvider {
    ...
    public boolean equals(Object other) {
        return this == other
            ? true
            : other instanceof ItemContainerContents itemcontainercontents && ItemStack.listMatches(this.items, itemcontainercontents.items);
    }
    ...
    @Override
    public void addToTooltip(Item.TooltipContext p_400001_, Consumer<Component> p_399797_, TooltipFlag p_399639_, DataComponentGetter p_399821_) {
        int i = 0;
        int j = 0;
        ...
        for (ItemStack itemstack : this.nonEmptyItems()) {
            ...
            if (i <= 4) {
                i++;
                p_399797_.accept(Component.translatable("item.container.item_count", itemstack.getHoverName(), itemstack.getCount()));
            }
        }

        if (j - i > 0) {
            p_399797_.accept(Component.translatable("item.container.more_items", j - i).withStyle(ChatFormatting.ITALIC));
        }
    }
