...
public class PlayerSkinWidget extends AbstractWidget {
    ...
    protected void renderWidget(GuiGraphics p_299897_, int p_299826_, int p_300009_, float p_299921_) {
        ...
        p_299897_.submitSkinRenderState(
            playermodel,
    ...
    @Override
    protected void onDrag(MouseButtonEvent p_447054_, double p_299829_, double p_299876_) {
        this.rotationX = Mth.clamp(this.rotationX - (float)p_299876_ * 2.5F, -50.0F, 50.0F);
        this.rotationY += (float)p_299829_ * 2.5F;
    }
    ...
    @Override
    public @Nullable ComponentPath nextFocusPath(FocusNavigationEvent p_299934_) {
        return null;
    }
}
