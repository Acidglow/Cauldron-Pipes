...
public enum Direction implements StringRepresentable {
    ...
    @Deprecated
    public static final Codec<Direction> LEGACY_ID_CODEC = Codec.BYTE.xmap(Direction::from3DDataValue, p_404165_ -> (byte)p_404165_.get3DDataValue());
    @Deprecated
    public static final Codec<Direction> LEGACY_ID_CODEC_2D = Codec.BYTE.xmap(Direction::from2DDataValue, p_404164_ -> (byte)p_404164_.get2DDataValue());
    ...
    public static ImmutableList<Direction.Axis> axisStepOrder(Vec3 direction) {
        return Math.abs(direction.x) < Math.abs(direction.z) ? YZX_AXIS_ORDER : YXZ_AXIS_ORDER;
    }
    ...
    public static enum Axis implements StringRepresentable, Predicate<Direction> {
        X("x") {
            ...
            @Override
            public boolean choose(boolean p_393529_, boolean p_393779_, boolean p_393950_) {
                return p_393529_;
            }
        ...
        Y("y") {
            ...
            @Override
            public boolean choose(boolean p_394580_, boolean p_394441_, boolean p_394640_) {
                return p_394441_;
            }
        ...
        Z("z") {
            ...
            @Override
            public boolean choose(boolean p_393844_, boolean p_393470_, boolean p_393840_) {
                return p_393840_;
            }
