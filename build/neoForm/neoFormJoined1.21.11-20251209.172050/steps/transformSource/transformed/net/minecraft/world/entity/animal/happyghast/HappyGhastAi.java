...
public class HappyGhastAi {
    ...
    private static void initIdleActivity(Brain<HappyGhast> brain) {
        brain.addActivity(
            Activity.IDLE,
            ImmutableList.of(
                Pair.of(1, new FollowTemptation(p_480769_ -> 1.25F, p_480210_ -> 3.0, true)),
                Pair.of(2, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, p_481179_ -> 1.1F, MemoryModuleType.NEAREST_VISIBLE_PLAYER, true)),
                Pair.of(3, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, p_481843_ -> 1.1F, MemoryModuleType.NEAREST_VISIBLE_ADULT, true)),
