...
public class MultiPackResourceManager implements CloseableResourceManager {
    ...
    public MultiPackResourceManager(PackType type, List<PackResources> packs) {
        ...
        for (PackResources packresources : packs) {
            ...
            Predicate<Identifier> predicate = resourcefiltersection != null ? p_466380_ -> resourcefiltersection.isPathFiltered(p_466380_.getPath()) : null;
    ...
    @Override
    public Optional<Resource> getResource(Identifier p_467316_) {
        ResourceManager resourcemanager = this.namespacedManagers.get(p_467316_.getNamespace());
        return resourcemanager != null ? resourcemanager.getResource(p_467316_) : Optional.empty();
    }

    @Override
    public List<Resource> getResourceStack(Identifier p_469633_) {
        ResourceManager resourcemanager = this.namespacedManagers.get(p_469633_.getNamespace());
        return resourcemanager != null ? resourcemanager.getResourceStack(p_469633_) : List.of();
    }
