...
public class DifficultyCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        dispatcher.register(literalargumentbuilder.requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS)).executes(p_457359_ -> {
            Difficulty difficulty1 = p_457359_.getSource().getLevel().getDifficulty();
            p_457359_.getSource().sendSuccess(() -> Component.translatable("commands.difficulty.query", difficulty1.getDisplayName()), false);
