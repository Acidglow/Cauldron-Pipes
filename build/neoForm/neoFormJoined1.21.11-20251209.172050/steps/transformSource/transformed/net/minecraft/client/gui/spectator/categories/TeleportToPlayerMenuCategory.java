...
public class TeleportToPlayerMenuCategory implements SpectatorMenuCategory, SpectatorMenuItem {
    ...
    @Override
    public void renderIcon(GuiGraphics p_281992_, float p_281684_, float p_361587_) {
        p_281992_.blitSprite(
            RenderPipelines.GUI_TEXTURED, TELEPORT_TO_PLAYER_SPRITE, 0, 0, 16, 16, ARGB.colorFromFloat(p_361587_, p_281684_, p_281684_, p_281684_)
        );
    }
