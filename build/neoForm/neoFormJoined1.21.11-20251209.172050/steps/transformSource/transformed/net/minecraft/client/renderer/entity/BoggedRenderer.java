...
public class BoggedRenderer extends AbstractSkeletonRenderer<Bogged, BoggedRenderState> {
    ...
    public BoggedRenderer(EntityRendererProvider.Context p_326938_) {
        super(p_326938_, ModelLayers.BOGGED_ARMOR, new BoggedModel(p_326938_.bakeLayer(ModelLayers.BOGGED)));
    ...
    public Identifier getTextureLocation(BoggedRenderState p_467084_) {
    ...
    public void extractRenderState(Bogged p_480683_, BoggedRenderState p_480794_, float p_363609_) {
        super.extractRenderState(p_480683_, p_480794_, p_363609_);
        p_480794_.isSheared = p_480683_.isSheared();
    }
}
