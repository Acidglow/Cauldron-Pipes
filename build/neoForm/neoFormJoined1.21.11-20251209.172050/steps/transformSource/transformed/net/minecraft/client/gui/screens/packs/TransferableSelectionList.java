...
public class TransferableSelectionList extends ObjectSelectionList<TransferableSelectionList.Entry> {
    ...
    @Override
    public boolean keyPressed(KeyEvent p_446901_) {
        return this.getSelected() != null ? this.getSelected().keyPressed(p_446901_) : super.keyPressed(p_446901_);
    }

    public void updateList(Stream<PackSelectionModel.Entry> entries, PackSelectionModel.@Nullable EntryBase focused) {
        this.clearEntries();
    ...
    public class HeaderEntry extends TransferableSelectionList.Entry {
        ...
        @Override
        public void renderContent(GuiGraphics p_439061_, int p_439590_, int p_440171_, boolean p_440086_, float p_440153_) {
            p_439061_.drawCenteredString(this.font, this.text, this.getX() + this.getWidth() / 2, this.getContentYMiddle() - 9 / 2, -1);
        }
    ...
    public class PackEntry extends TransferableSelectionList.Entry implements SelectableEntry {
        ...
        public PackEntry(Minecraft minecraft, TransferableSelectionList parent, PackSelectionModel.Entry entry) {
            ...
            this.descriptionWidget = new MultiLineTextWidget(
                ComponentUtils.mergeStyles(entry.getExtendedDescription(), Style.EMPTY.withColor(-8355712)), minecraft.font
            );
        ...
        @Override
        public void renderContent(GuiGraphics p_440230_, int p_440699_, int p_439321_, boolean p_440248_, float p_439636_) {
            ...
            if (!packcompatibility.isCompatible()) {
                ...
                p_440230_.fill(i, j, k, l, -8978432);
            }

            p_440230_.blit(RenderPipelines.GUI_TEXTURED, this.pack.getIconTexture(), this.getContentX(), this.getContentY(), 0.0F, 0.0F, 32, 32, 32, 32);
            ...
            if (this.showHoverOverlay()
                && (this.minecraft.options.touchscreen().get() || p_440248_ || this.parent.getSelected() == this && this.parent.isFocused())) {
                p_440230_.fill(this.getContentX(), this.getContentY(), this.getContentX() + 32, this.getContentY() + 32, -1601138544);
                int i1 = p_440699_ - this.getContentX();
                int j1 = p_439321_ - this.getContentY();
            ...
            this.nameWidget.render(p_440230_, p_440699_, p_439321_, p_439636_);
            ...
            this.descriptionWidget.render(p_440230_, p_440699_, p_439321_, p_439636_);
        }

        @Override
        public boolean mouseClicked(MouseButtonEvent p_447361_, boolean p_433742_) {
            if (this.showHoverOverlay()) {
                int i = (int)p_447361_.x() - this.getContentX();
                int j = (int)p_447361_.y() - this.getContentY();
            ...
            return super.mouseClicked(p_447361_, p_433742_);
        }

        @Override
        public boolean keyPressed(KeyEvent p_445822_) {
            if (p_445822_.isConfirmation()) {
                this.keyboardSelection();
                return true;
            } else {
                if (p_445822_.hasShiftDown()) {
                    if (p_445822_.isUp()) {
                        this.keyboardMoveUp();
                        return true;
                    }
                ...
                return super.keyPressed(p_445822_);
            }
        }
