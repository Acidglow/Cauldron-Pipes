...
public class ZombieNautilusAi {
    ...
    private static void initIdleActivity(Brain<ZombieNautilus> brain) {
        brain.addActivity(
            Activity.IDLE,
            ImmutableList.of(
                Pair.of(1, new FollowTemptation(p_455034_ -> 0.9F, p_454885_ -> p_454885_.isBaby() ? 2.5 : 3.5)),
    ...
    public static void updateActivity(ZombieNautilus zombieNautilus) {
        zombieNautilus.getBrain().setActiveActivityToFirstValid(ImmutableList.of(Activity.FIGHT, Activity.IDLE));
    }
}
