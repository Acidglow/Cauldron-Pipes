...
public class SpawnerBlockEntity extends BlockEntity implements Spawner {
    ...
    @Override
    protected void loadAdditional(ValueInput p_422363_) {
        super.loadAdditional(p_422363_);
        this.spawner.load(this.level, this.worldPosition, p_422363_);
    }

    @Override
    protected void saveAdditional(ValueOutput p_422474_) {
        super.saveAdditional(p_422474_);
        this.spawner.save(p_422474_);
    }
