...
public class CubeMapTexture extends ReloadableTexture {
    ...
    public CubeMapTexture(Identifier p_468741_) {
        super(p_468741_);
    }
    ...
    public TextureContents loadContents(ResourceManager p_423524_) throws IOException {
        ...
        try (TextureContents texturecontents = TextureContents.load(p_423524_, identifier.withSuffix(SUFFIXES[0]))) {
            ...
            for (int k = 1; k < 6; k++) {
                try (TextureContents texturecontents1 = TextureContents.load(p_423524_, identifier.withSuffix(SUFFIXES[k]))) {
    ...
    @Override
    protected void doLoad(NativeImage p_423682_) {
