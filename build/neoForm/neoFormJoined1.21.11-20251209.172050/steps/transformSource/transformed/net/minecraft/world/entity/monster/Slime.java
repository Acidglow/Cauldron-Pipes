...
public class Slime extends Mob implements Enemy {
        ...
        this.targetSelector
            .addGoal(
                ...
                new NearestAttackableTargetGoal<>(
                    this, Player.class, 10, true, false, (p_427104_, p_427105_) -> Math.abs(p_427104_.getY() - this.getY()) <= 4.0
                )
            );
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_422317_) {
        super.addAdditionalSaveData(p_422317_);
        p_422317_.putInt("Size", this.getSize() - 1);
        p_422317_.putBoolean("wasOnGround", this.wasOnGround);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_421591_) {
        this.setSize(p_421591_.getIntOr("Size", 0) + 1, false);
        super.readAdditionalSaveData(p_421591_);
        this.wasOnGround = p_421591_.getBooleanOr("wasOnGround", false);
    }
        ...
        if (!this.level().isClientSide() && i > 1 && this.isDeadOrDying()) {
            ...
            for (int l = 0; l < k; l++) {
                ...
                Slime slime = this.convertTo(
                    this.getType(), new ConversionParams(ConversionType.SPLIT_ON_DEATH, false, false, playerteam), EntitySpawnReason.TRIGGERED, p_427109_ -> {
                        p_427109_.setSize(j, true);
                        p_427109_.snapTo(this.getX() + f2, this.getY() + 0.5, this.getZ() + f3, this.random.nextFloat() * 360.0F, 0.0F);
                    }
                );
    ...
    protected Vec3 getPassengerAttachmentPoint(Entity p_296103_, EntityDimensions p_295741_, float p_295572_) {
        return new Vec3(0.0, p_295741_.height() - 0.015625 * this.getSize() * p_295572_, 0.0);
    }
    ...
    public @Nullable SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_33601_, DifficultyInstance p_33602_, EntitySpawnReason p_361992_, @Nullable SpawnGroupData p_33604_
    ) {
    ...
    public EntityDimensions getDefaultDimensions(Pose p_316359_) {
        return super.getDefaultDimensions(p_316359_).scale(this.getSize());
    }
