...
public class Squid extends AgeableWaterCreature {
    ...
    public Squid(EntityType<? extends Squid> p_481390_, Level p_479588_) {
        super(p_481390_, p_479588_);
    ...
    @Override
    public @Nullable AgeableMob getBreedOffspring(ServerLevel p_478002_, AgeableMob p_481542_) {
        return EntityType.SQUID.create(p_478002_, EntitySpawnReason.BREEDING);
    }
    ...
    @Override
    public boolean hurtServer(ServerLevel p_479455_, DamageSource p_478190_, float p_478165_) {
        if (super.hurtServer(p_479455_, p_478190_, p_478165_) && this.getLastHurtByMob() != null) {
            this.spawnInk();
            return true;
        } else {
            return false;
    ...
    @Override
    public void handleEntityEvent(byte p_481969_) {
        if (p_481969_ == 19) {
            this.tentacleMovement = 0.0F;
        } else {
            super.handleEntityEvent(p_481969_);
        }
    }
    ...
    public @Nullable SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_478346_, DifficultyInstance p_480811_, EntitySpawnReason p_481727_, @Nullable SpawnGroupData p_480347_
    ) {
        SpawnGroupData spawngroupdata = Objects.requireNonNullElseGet(p_480347_, () -> new AgeableMob.AgeableMobGroupData(0.05F));
        return super.finalizeSpawn(p_478346_, p_480811_, p_481727_, spawngroupdata);
    }
    ...
    static class SquidRandomMovementGoal extends Goal {
        ...
        public SquidRandomMovementGoal(Squid p_477938_) {
            this.squid = p_477938_;
        }
