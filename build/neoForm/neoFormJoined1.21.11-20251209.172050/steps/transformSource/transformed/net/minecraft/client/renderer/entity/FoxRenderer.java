...
public class FoxRenderer extends AgeableMobRenderer<Fox, FoxRenderState, FoxModel> {
    ...
    public Identifier getTextureLocation(FoxRenderState p_365240_) {
    ...
    public void extractRenderState(Fox p_481737_, FoxRenderState p_365146_, float p_361192_) {
        super.extractRenderState(p_481737_, p_365146_, p_361192_);
        HoldingEntityRenderState.extractHoldingEntityRenderState(p_481737_, p_365146_, this.itemModelResolver);
        p_365146_.headRollAngle = p_481737_.getHeadRollAngle(p_361192_);
        p_365146_.isCrouching = p_481737_.isCrouching();
        p_365146_.crouchAmount = p_481737_.getCrouchAmount(p_361192_);
        p_365146_.isSleeping = p_481737_.isSleeping();
        p_365146_.isSitting = p_481737_.isSitting();
        p_365146_.isFaceplanted = p_481737_.isFaceplanted();
        p_365146_.isPouncing = p_481737_.isPouncing();
        p_365146_.variant = p_481737_.getVariant();
    }
}
