...
public class DragonTakeoffPhase extends AbstractDragonPhaseInstance {
    ...
    @Override
    public void doServerTick(ServerLevel p_376301_) {
        if (!this.firstTick && this.currentPath != null) {
            BlockPos blockpos = p_376301_.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, EndPodiumFeature.getLocation(this.dragon.getFightOrigin()));
