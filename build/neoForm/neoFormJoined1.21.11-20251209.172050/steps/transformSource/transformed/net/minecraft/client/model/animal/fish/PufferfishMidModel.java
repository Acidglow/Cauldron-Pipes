...
public class PufferfishMidModel extends EntityModel<EntityRenderState> {
    ...
    public PufferfishMidModel(ModelPart p_479694_) {
        super(p_479694_);
        this.leftBlueFin = p_479694_.getChild("left_blue_fin");
        this.rightBlueFin = p_479694_.getChild("right_blue_fin");
    }
    ...
    public void setupAnim(EntityRenderState p_481484_) {
        super.setupAnim(p_481484_);
        this.rightBlueFin.zRot = -0.2F + 0.4F * Mth.sin(p_481484_.ageInTicks * 0.2F);
        this.leftBlueFin.zRot = 0.2F - 0.4F * Mth.sin(p_481484_.ageInTicks * 0.2F);
    }
}
