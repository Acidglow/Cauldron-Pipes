...
public class Ravager extends Raider {
    private static final Predicate<Entity> ROAR_TARGET_WITH_GRIEFING = p_375882_ -> !(p_375882_ instanceof Ravager) && p_375882_.isAlive();
    private static final Predicate<Entity> ROAR_TARGET_WITHOUT_GRIEFING = p_375881_ -> ROAR_TARGET_WITH_GRIEFING.test(p_375881_)
        && !p_375881_.getType().equals(EntityType.ARMOR_STAND);
    private static final Predicate<LivingEntity> ROAR_TARGET_ON_CLIENT = p_427102_ -> !(p_427102_ instanceof Ravager)
        && p_427102_.isAlive()
        && p_427102_.isLocalInstanceAuthoritative();
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, AbstractVillager.class, true, (p_199899_, p_376378_) -> !p_199899_.isBaby()));
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_421707_) {
        super.addAdditionalSaveData(p_421707_);
        p_421707_.putInt("AttackTick", this.attackTick);
        p_421707_.putInt("StunTick", this.stunnedTick);
        p_421707_.putInt("RoarTick", this.roarTick);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_421989_) {
        super.readAdditionalSaveData(p_421989_);
        this.attackTick = p_421989_.getIntOr("AttackTick", 0);
        this.stunnedTick = p_421989_.getIntOr("StunTick", 0);
        this.roarTick = p_421989_.getIntOr("RoarTick", 0);
    }
    ...
    private void roar() {
        if (this.isAlive() && this.level() instanceof ServerLevel serverlevel) {
            Predicate<Entity> predicate = net.neoforged.neoforge.event.EventHooks.canEntityGrief(serverlevel, this) ? ROAR_TARGET_WITH_GRIEFING : ROAR_TARGET_WITHOUT_GRIEFING;
    ...
    @Override
    public boolean doHurtTarget(ServerLevel p_376340_, Entity p_33328_) {
        this.attackTick = 10;
        p_376340_.broadcastEntityEvent(this, (byte)4);
        this.playSound(SoundEvents.RAVAGER_ATTACK, 1.0F, 1.0F);
        return super.doHurtTarget(p_376340_, p_33328_);
    }
    ...
    @Override
    protected AABB getAttackBoundingBox(double p_481318_) {
        AABB aabb = super.getAttackBoundingBox(p_481318_);
