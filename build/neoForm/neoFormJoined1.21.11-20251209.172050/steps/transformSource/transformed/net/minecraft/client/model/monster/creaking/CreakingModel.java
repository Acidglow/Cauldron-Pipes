...
public class CreakingModel extends EntityModel<CreakingRenderState> {
    ...
    public CreakingModel(ModelPart p_478232_) {
        super(p_478232_);
        ModelPart modelpart = p_478232_.getChild("root");
    ...
    public void setupAnim(CreakingRenderState p_482168_) {
        super.setupAnim(p_482168_);
        this.head.xRot = p_482168_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_482168_.yRot * (float) (Math.PI / 180.0);
        if (p_482168_.canMove) {
            this.walkAnimation.applyWalk(p_482168_.walkAnimationPos, p_482168_.walkAnimationSpeed, 1.0F, 1.0F);
        }

        this.attackAnimation.apply(p_482168_.attackAnimationState, p_482168_.ageInTicks);
        this.invulnerableAnimation.apply(p_482168_.invulnerabilityAnimationState, p_482168_.ageInTicks);
        this.deathAnimation.apply(p_482168_.deathAnimationState, p_482168_.ageInTicks);
    }
}
