...
public class RecreatingSimpleRegionStorage extends SimpleRegionStorage {
    ...
    @Override
    public CompletableFuture<Void> write(ChunkPos p_321592_, Supplier<CompoundTag> p_459028_) {
        this.markChunkDone(p_321592_);
        return this.writeWorker.store(p_321592_, p_459028_);
    }
