...
public record RandomGroupPoolAlias(WeightedList<List<PoolAliasBinding>> groups) implements PoolAliasBinding {
    ...
    @Override
    public void forEachResolved(RandomSource p_404851_, BiConsumer<ResourceKey<StructureTemplatePool>, ResourceKey<StructureTemplatePool>> p_405752_) {
        this.groups.getRandom(p_404851_).ifPresent(p_405228_ -> p_405228_.forEach(p_404917_ -> p_404917_.forEachResolved(p_404851_, p_405752_)));
    }
