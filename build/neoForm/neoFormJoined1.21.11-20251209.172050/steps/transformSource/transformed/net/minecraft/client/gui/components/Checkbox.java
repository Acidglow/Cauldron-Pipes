...
public class Checkbox extends AbstractButton {
    ...
    @Override
    public void onPress(InputWithModifiers p_447320_) {
    ...
    @Override
    public void renderContents(GuiGraphics p_457815_, int p_458137_, int p_457887_, float p_458250_) {
        ...
        p_457815_.blitSprite(RenderPipelines.GUI_TEXTURED, identifier, this.getX(), this.getY(), i, i, ARGB.white(this.alpha));
        int j = this.getX() + i + 4;
        int k = this.getY() + i / 2 - this.textWidget.getHeight() / 2;
        this.textWidget.setPosition(j, k);
        this.textWidget.visitLines(p_457815_.textRendererForWidget(this, GuiGraphics.HoveredTextEffects.notClickable(this.isHovered())));
    }
