...
public class CherryTrunkPlacer extends TrunkPlacer {
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(
        ...
        Function<BlockState, BlockState> function = p_360246_ -> p_360246_.trySetValue(RotatedPillarBlock.AXIS, direction.getAxis());
        list.add(
    ...
    private FoliagePlacer.FoliageAttachment generateBranch(
        ...
        while (true) {
            ...
            float f = (float)Math.abs(blockpos.getY() - currentPos.getY()) / i1;
