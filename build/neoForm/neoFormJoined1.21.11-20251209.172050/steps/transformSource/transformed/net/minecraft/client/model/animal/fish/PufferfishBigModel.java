...
public class PufferfishBigModel extends EntityModel<EntityRenderState> {
    ...
    public PufferfishBigModel(ModelPart p_478851_) {
        super(p_478851_);
        this.leftBlueFin = p_478851_.getChild("left_blue_fin");
        this.rightBlueFin = p_478851_.getChild("right_blue_fin");
    }
    ...
    public void setupAnim(EntityRenderState p_478260_) {
        super.setupAnim(p_478260_);
        this.rightBlueFin.zRot = -0.2F + 0.4F * Mth.sin(p_478260_.ageInTicks * 0.2F);
        this.leftBlueFin.zRot = 0.2F - 0.4F * Mth.sin(p_478260_.ageInTicks * 0.2F);
    }
}
