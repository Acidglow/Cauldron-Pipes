...
public class DebugEntrySystemSpecs implements DebugScreenEntry {
    ...
    @Override
    public void display(DebugScreenDisplayer p_433331_, @Nullable Level p_434121_, @Nullable LevelChunk p_434213_, @Nullable LevelChunk p_432800_) {
        GpuDevice gpudevice = RenderSystem.getDevice();
        p_433331_.addToGroup(
            GROUP,
            List.of(
    ...
    @Override
    public boolean isAllowed(boolean p_433068_) {
        return true;
    }
}
