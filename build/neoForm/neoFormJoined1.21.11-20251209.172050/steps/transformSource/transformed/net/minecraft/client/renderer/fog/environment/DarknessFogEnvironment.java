...
public class DarknessFogEnvironment extends MobEffectFogEnvironment {
    ...
    @Override
    public void setupFog(FogData p_423539_, Camera p_456152_, ClientLevel p_423550_, float p_423598_, DeltaTracker p_423497_) {
        if (p_456152_.entity() instanceof LivingEntity livingentity) {
