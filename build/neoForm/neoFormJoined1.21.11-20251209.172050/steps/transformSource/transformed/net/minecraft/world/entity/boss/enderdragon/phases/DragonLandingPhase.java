...
public class DragonLandingPhase extends AbstractDragonPhaseInstance {
    ...
    @Override
    public void doServerTick(ServerLevel p_376573_) {
        if (this.targetLocation == null) {
            this.targetLocation = Vec3.atBottomCenterOf(
                p_376573_.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, EndPodiumFeature.getLocation(this.dragon.getFightOrigin()))
            );
        }
