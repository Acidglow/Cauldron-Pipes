    ...
    private static void addFixers(DataFixerBuilder builder) {
        ...
        builder.addFixer(
            new NamedEntityWriteReadFix(schema57, true, "Command block block entity custom name fix", References.BLOCK_ENTITY, "minecraft:command_block") {
                @Override
                protected <T> Dynamic<T> fix(Dynamic<T> p_394639_) {
                    return BlockEntityCustomNameToComponentFix.fixTagCustomName(p_394639_);
                }
            }
        );
        builder.addFixer(
            new DataFix(schema57, false) {
                ...
                protected TypeRewriteRule makeRule() {
                    ...
                    return this.fixTypeEverywhereTyped(
                        ...
                        type,
                        p_394010_ -> {
                            String s = p_394010_.getOptional(opticfinder).orElse("");
                            return !"minecraft:commandblock_minecart".equals(s)
                                ? p_394010_
                                : p_394010_.updateTyped(
                                    opticfinder1,
                                    p_394324_ -> p_394324_.update(
                                        opticfinder2, p_393839_ -> p_393839_.mapSecond(LegacyComponentDataFixUtils::createTextComponentJson)
                                    )
                                );
                        }
                    );
        ...
        ImmutableMap<String, String> immutablemap1 = ImmutableMap.<String, String>builder()
            ...
            .build();
        builder.addFixer(ItemRenameFix.create(schema135, "Rename copper item suffixes", createRenamer(immutablemap1)));
        builder.addFixer(BlockRenameFix.create(schema135, "Rename copper blocks suffixes", createRenamer(immutablemap1)));
        ...
        ImmutableMap<String, String> immutablemap2 = ImmutableMap.<String, String>builder()
            ...
            .build();
        builder.addFixer(ItemRenameFix.create(schema137, "Renamed grimstone block items to deepslate", createRenamer(immutablemap2)));
        builder.addFixer(BlockRenameFix.create(schema137, "Renamed grimstone blocks to deepslate", createRenamer(immutablemap2)));
        ...
        builder.addFixer(
            new EntityVariantFix(
                schema164, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", Util.make(new Int2ObjectOpenHashMap<String>(), p_216528_ -> {
        ...
        builder.addFixer(
            new EntityVariantFix(
                schema165, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap<String>(), p_216519_ -> {
        ...
        builder.addFixer(new AttributesRenameLegacy(
                neoSchema3804,
        ...
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema246, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", p_390638_ -> p_390638_ == 48.0 ? 16.0 : p_390638_
            )
        );
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema246, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", p_390639_ -> p_390639_ == 48.0 ? 16.0 : p_390639_
            )
        );
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema246, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", p_390635_ -> p_390635_ == 48.0 ? 16.0 : p_390635_
            )
        );
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema246, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", p_390636_ -> p_390636_ == 40.0 ? 16.0 : p_390636_
            )
        );
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                ...
                p_390634_ -> p_390634_ == 16.0 ? 12.0 : p_390634_
            )
        );
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema246, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", p_390637_ -> p_390637_ == 16.0 ? 24.0 : p_390637_
            )
        );
        ...
        builder.addFixer(
            new BlockPropertyRenameAndFix(
                ...
                p_392802_ -> p_392802_.equals("true") ? "awake" : "uprooted"
            )
        );
        ...
        builder.addFixer(
            new BlockPropertyRenameAndFix(schema260, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", p_399404_ -> p_399404_)
        );
        ...
        builder.addFixer(new AddFieldFix(schema269, References.PLAYER, "style", p_442437_ -> p_442437_.createString("minecraft:default"), "locator_bar_icon"));
        builder.addFixer(new AddFieldFix(schema269, References.ENTITY, "style", p_442438_ -> p_442438_.createString("minecraft:default"), "locator_bar_icon"));
