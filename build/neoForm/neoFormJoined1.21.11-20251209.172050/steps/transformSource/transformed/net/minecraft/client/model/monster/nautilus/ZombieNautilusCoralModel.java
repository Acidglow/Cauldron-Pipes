...
public class ZombieNautilusCoralModel extends NautilusModel {
    ...
    public ZombieNautilusCoralModel(ModelPart p_478312_) {
        super(p_478312_);
    ...
    @Override
    public void setupAnim(NautilusRenderState p_481115_) {
        super.setupAnim(p_481115_);
        this.corals.visible = p_481115_.bodyArmorItem.isEmpty();
    }
}
