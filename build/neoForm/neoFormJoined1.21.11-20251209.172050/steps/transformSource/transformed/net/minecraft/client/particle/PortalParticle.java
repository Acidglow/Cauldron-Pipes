...
public class PortalParticle extends SingleQuadParticle {
    ...
    public PortalParticle(
        ...
        double p_107556_,
        double p_107557_,
        TextureAtlasSprite p_446723_
    ) {
        super(p_107551_, p_107552_, p_107553_, p_107554_, p_446723_);
        this.xd = p_107555_;
        this.yd = p_107556_;
        this.zd = p_107557_;
        this.x = p_107552_;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            double p_107587_,
            double p_107588_,
            RandomSource p_447259_
        ) {
            return new PortalParticle(p_107582_, p_107583_, p_107584_, p_107585_, p_107586_, p_107587_, p_107588_, this.sprite.get(p_447259_));
        }
    }
}
