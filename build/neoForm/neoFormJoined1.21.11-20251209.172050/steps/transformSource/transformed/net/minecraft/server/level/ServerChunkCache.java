...
public class ServerChunkCache extends ChunkSource implements net.neoforged.neoforge.common.extensions.IServerChunkCacheExtension {
    ...
    public ServerChunkCache(
        ...
        this.dataStorage = new DimensionDataStorage(level, path, fixerUpper, level.registryAccess());
    ...
    @Override
    public @Nullable ChunkAccess getChunk(int p_8360_, int p_8361_, ChunkStatus p_330876_, boolean p_8363_) {
