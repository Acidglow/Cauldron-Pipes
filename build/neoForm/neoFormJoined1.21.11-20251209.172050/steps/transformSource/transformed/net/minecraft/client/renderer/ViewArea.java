...
public class ViewArea {
    ...
    protected SectionRenderDispatcher.@Nullable RenderSection getRenderSection(long sectionPos) {
    ...
    private SectionRenderDispatcher.@Nullable RenderSection getRenderSection(int x, int y, int z) {
