...
public class CamelSaddleModel extends CamelModel {
    ...
    public CamelSaddleModel(ModelPart p_482045_) {
        super(p_482045_);
    }
    ...
    @Override
    public void setupAnim(CamelRenderState p_480386_) {
        super.setupAnim(p_480386_);
        this.reins.visible = p_480386_.isRidden;
    }
}
