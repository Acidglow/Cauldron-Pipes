...
public class PalettedContainer<T> implements PaletteResize<T>, PalettedContainerRO<T> {
    ...
    private PalettedContainer.Data<T> createOrReuseData(PalettedContainer.@Nullable Data<T> data, int id) {
    ...
    @Override
    public PalettedContainerRO.PackedData<T> pack(Strategy<T> p_445627_) {
        this.acquire();
        ...
        try {
            ...
            int i = p_445627_.entryCount();
            int[] aint = reencodeContents(bitstorage, palette, hashmappalette);
            Configuration configuration = p_445627_.getConfigurationForPaletteSize(hashmappalette.getSize());
            int j = configuration.bitsInStorage();
