                    ...
                    Commands.literal("query")
                        ...
                        .then(
                            Commands.literal("gametime")
                                .executes(p_457367_ -> queryTime(p_457367_.getSource(), (int)(p_457367_.getSource().getLevel().getGameTime() % 2147483647L)))
                        )
                        .then(
                            Commands.literal("day")
                                .executes(p_454418_ -> queryTime(p_454418_.getSource(), (int)(p_454418_.getSource().getLevel().getDayCount() % 2147483647L)))
                        )
                )
        );
    }
