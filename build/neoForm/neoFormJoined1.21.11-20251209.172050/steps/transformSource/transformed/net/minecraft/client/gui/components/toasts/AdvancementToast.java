...
public class AdvancementToast implements Toast {
    ...
    public void update(ToastManager p_363415_, long p_363939_) {
        ...
        if (displayinfo == null) {
            ...
            this.wantedVisibility = p_363939_ >= 5000.0 * p_363415_.getNotificationDisplayTimeMultiplier() ? Toast.Visibility.HIDE : Toast.Visibility.SHOW;
        }
    }
        ...
        if (displayinfo != null) {
            ...
            if (list.size() == 1) {
                ...
                if (p_282604_ < 1500L) {
                    ...
                    p_281813_.drawString(p_364425_, displayinfo.getType().getDisplayName(), 30, 11, ARGB.color(k, i), false);
                } else {
                    int i1 = Mth.floor(Mth.clamp((float)(p_282604_ - 1500L) / 300.0F, 0.0F, 1.0F) * 252.0F);
                    int l = this.height() / 2 - list.size() * 9 / 2;

                    for (FormattedCharSequence formattedcharsequence : list) {
                        p_281813_.drawString(p_364425_, formattedcharsequence, 30, l, ARGB.white(i1), false);
                        l += 9;
                    }
                }
            }
