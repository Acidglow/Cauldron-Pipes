...
public class BatModel extends EntityModel<BatRenderState> {
    ...
    public BatModel(ModelPart p_481459_) {
        super(p_481459_, RenderTypes::entityCutout);
        this.body = p_481459_.getChild("body");
        this.head = p_481459_.getChild("head");
        this.rightWing = this.body.getChild("right_wing");
        this.rightWingTip = this.rightWing.getChild("right_wing_tip");
        this.leftWing = this.body.getChild("left_wing");
        this.leftWingTip = this.leftWing.getChild("left_wing_tip");
        this.feet = this.body.getChild("feet");
        this.flyingAnimation = BatAnimation.BAT_FLYING.bake(p_481459_);
        this.restingAnimation = BatAnimation.BAT_RESTING.bake(p_481459_);
    }
    ...
    public void setupAnim(BatRenderState p_479505_) {
        super.setupAnim(p_479505_);
        if (p_479505_.isResting) {
            this.applyHeadRotation(p_479505_.yRot);
        }

        this.flyingAnimation.apply(p_479505_.flyAnimationState, p_479505_.ageInTicks);
        this.restingAnimation.apply(p_479505_.restAnimationState, p_479505_.ageInTicks);
    }
