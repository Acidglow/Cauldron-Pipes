...
public class IllagerModel<S extends IllagerRenderState> extends EntityModel<S> implements ArmedModel<S>, HeadedModel {
    ...
    public IllagerModel(ModelPart p_478011_) {
        super(p_478011_);
        this.head = p_478011_.getChild("head");
        this.hat = this.head.getChild("hat");
        this.hat.visible = false;
        this.arms = p_478011_.getChild("arms");
        this.leftLeg = p_478011_.getChild("left_leg");
        this.rightLeg = p_478011_.getChild("right_leg");
        this.leftArm = p_478011_.getChild("left_arm");
        this.rightArm = p_478011_.getChild("right_arm");
    }
    ...
    public void setupAnim(S p_479331_) {
        super.setupAnim(p_479331_);
        this.head.yRot = p_479331_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_479331_.xRot * (float) (Math.PI / 180.0);
        if (p_479331_.isRiding) {
            ...
            float f = p_479331_.walkAnimationSpeed;
            float f1 = p_479331_.walkAnimationPos;
        ...
        AbstractIllager.IllagerArmPose abstractillager$illagerarmpose = p_479331_.armPose;
        if (abstractillager$illagerarmpose == AbstractIllager.IllagerArmPose.ATTACKING) {
            if (p_479331_.getMainHandItemState().isEmpty()) {
                AnimationUtils.animateZombieArms(this.leftArm, this.rightArm, true, p_479331_);
            } else {
                AnimationUtils.swingWeaponDown(this.rightArm, this.leftArm, p_479331_.mainArm, p_479331_.attackAnim, p_479331_.ageInTicks);
            }
            ...
            this.leftArm.z = 0.0F;
            this.leftArm.x = 5.0F;
            this.rightArm.xRot = Mth.cos(p_479331_.ageInTicks * 0.6662F) * 0.25F;
            this.leftArm.xRot = Mth.cos(p_479331_.ageInTicks * 0.6662F) * 0.25F;
            ...
            AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, p_479331_.maxCrossbowChargeDuration, p_479331_.ticksUsingItem, true);
        } else if (abstractillager$illagerarmpose == AbstractIllager.IllagerArmPose.CELEBRATING) {
            this.rightArm.z = 0.0F;
            this.rightArm.x = -5.0F;
            this.rightArm.xRot = Mth.cos(p_479331_.ageInTicks * 0.6662F) * 0.05F;
            this.rightArm.zRot = 2.670354F;
            this.rightArm.yRot = 0.0F;
            this.leftArm.z = 0.0F;
            this.leftArm.x = 5.0F;
            this.leftArm.xRot = Mth.cos(p_479331_.ageInTicks * 0.6662F) * 0.05F;
            this.leftArm.zRot = (float) (-Math.PI * 3.0 / 4.0);
            this.leftArm.yRot = 0.0F;
        }
    ...
    public void translateToHand(IllagerRenderState p_480287_, HumanoidArm p_479647_, PoseStack p_480326_) {
        this.root.translateAndRotate(p_480326_);
        this.getArm(p_479647_).translateAndRotate(p_480326_);
    }
}
