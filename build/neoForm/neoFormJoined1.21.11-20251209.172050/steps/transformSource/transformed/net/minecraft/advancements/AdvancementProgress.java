...
public class AdvancementProgress implements Comparable<AdvancementProgress> {
    ...
    private static final Codec<Map<String, CriterionProgress>> CRITERIA_CODEC = Codec.unboundedMap(Codec.STRING, OBTAINED_TIME_CODEC)
        .xmap(
            p_465324_ -> Util.mapValues((Map<String, Instant>)p_465324_, CriterionProgress::new),
    ...
    public void serializeToNetwork(FriendlyByteBuf buffer) {
        buffer.writeMap(this.criteria, FriendlyByteBuf::writeUtf, (p_144360_, p_144361_) -> p_144361_.serializeToNetwork(p_144360_));
    }
