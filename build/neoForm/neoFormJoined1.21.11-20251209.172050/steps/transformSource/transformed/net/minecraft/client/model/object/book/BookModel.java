...
public class BookModel extends Model<BookModel.State> {
    ...
    public void setupAnim(BookModel.State p_480767_) {
        super.setupAnim(p_480767_);
        float f = (Mth.sin(p_480767_.animationPos * 0.02F) * 0.1F + 1.25F) * p_480767_.open;
        this.leftLid.yRot = (float) Math.PI + f;
        this.rightLid.yRot = -f;
        this.leftPages.yRot = f;
        this.rightPages.yRot = -f;
        this.flipPage1.yRot = f - f * 2.0F * p_480767_.pageFlip1;
        this.flipPage2.yRot = f - f * 2.0F * p_480767_.pageFlip2;
