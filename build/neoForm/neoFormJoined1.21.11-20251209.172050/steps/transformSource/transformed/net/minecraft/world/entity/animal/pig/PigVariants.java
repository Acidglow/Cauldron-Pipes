...
public class PigVariants {
    ...
    private static void register(
        BootstrapContext<PigVariant> context, ResourceKey<PigVariant> key, PigVariant.ModelType model, String name, TagKey<Biome> spawnBiomes
    ) {
    ...
    private static void register(
        ...
        PigVariant.ModelType model,
        String name,
        SpawnPrioritySelectors spawnConditions
    ) {
        Identifier identifier = Identifier.withDefaultNamespace("entity/pig/" + name);
        context.register(key, new PigVariant(new ModelAndTexture<>(model, identifier), spawnConditions));
    }
}
