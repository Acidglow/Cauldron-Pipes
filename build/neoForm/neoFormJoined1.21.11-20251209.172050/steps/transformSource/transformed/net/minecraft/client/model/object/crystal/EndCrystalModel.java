...
public class EndCrystalModel extends EntityModel<EndCrystalRenderState> {
    ...
    public EndCrystalModel(ModelPart p_479102_) {
        super(p_479102_);
        this.base = p_479102_.getChild("base");
        this.outerGlass = p_479102_.getChild("outer_glass");
    ...
    public void setupAnim(EndCrystalRenderState p_480668_) {
        super.setupAnim(p_480668_);
        this.base.visible = p_480668_.showsBottom;
        float f = p_480668_.ageInTicks * 3.0F;
        float f1 = EndCrystalRenderer.getY(p_480668_.ageInTicks) * 16.0F;
