 ...
 */
    ...
    public BiomeTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, String modId) {
    ...
    protected void addTags(HolderLookup.Provider p_256485_) {
        ...
        this.tag(BiomeTags.HAS_TRIAL_CHAMBERS).addAll(list.stream().filter(p_421493_ -> p_421493_ != Biomes.DEEP_DARK));
