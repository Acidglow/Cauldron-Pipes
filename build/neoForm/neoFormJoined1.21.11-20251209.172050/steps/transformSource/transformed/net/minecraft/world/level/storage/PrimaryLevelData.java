...
public class PrimaryLevelData implements ServerLevelData, WorldData {
    ...
    private void setTagData(RegistryAccess registry, CompoundTag nbt, @Nullable CompoundTag playerNBT) {
        ...
        nbt.store("game_rules", GameRules.codec(this.enabledFeatures()), this.settings.gameRules());
    ...
    @Override
    public void setSpawn(LevelData.RespawnData p_451208_) {
        this.respawnData = p_451208_;
    }
    ...
    @Override
    public void setLegacyWorldBorderSettings(Optional<WorldBorder.Settings> p_445378_) {
        this.legacyWorldBorderSettings = p_445378_;
    }
