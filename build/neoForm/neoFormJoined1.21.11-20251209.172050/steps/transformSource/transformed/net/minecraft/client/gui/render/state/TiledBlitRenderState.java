...
public record TiledBlitRenderState(
    ...
    @Override
    public void buildVertices(VertexConsumer p_449748_) {
        ...
        for (int k = 0; k < i; k += this.tileWidth()) {
            ...
            for (int j1 = 0; j1 < j; j1 += this.tileHeight()) {
                ...
                p_449748_.addVertexWith2DPose(this.pose(), i2, k2).setUv(this.u0(), this.v0()).setColor(this.color());
                p_449748_.addVertexWith2DPose(this.pose(), i2, l2).setUv(this.u0(), f1).setColor(this.color());
                p_449748_.addVertexWith2DPose(this.pose(), j2, l2).setUv(f, f1).setColor(this.color());
                p_449748_.addVertexWith2DPose(this.pose(), j2, k2).setUv(f, this.v0()).setColor(this.color());
            }
        }
    }
