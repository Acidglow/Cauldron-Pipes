...
public class PhantomModel extends EntityModel<PhantomRenderState> {
    ...
    public PhantomModel(ModelPart p_479942_) {
        super(p_479942_);
        ModelPart modelpart = p_479942_.getChild("body");
    ...
    public void setupAnim(PhantomRenderState p_480335_) {
        super.setupAnim(p_480335_);
        float f = p_480335_.flapTime * 7.448451F * (float) (Math.PI / 180.0);
        float f1 = 16.0F;
