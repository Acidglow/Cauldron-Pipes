...
public class WaterDropParticle extends SingleQuadParticle {
    public WaterDropParticle(ClientLevel p_108484_, double p_108485_, double p_108486_, double p_108487_, TextureAtlasSprite p_447040_) {
        super(p_108484_, p_108485_, p_108486_, p_108487_, 0.0, 0.0, 0.0, p_447040_);
        this.xd *= 0.3F;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            double p_108509_,
            double p_108510_,
            RandomSource p_445633_
        ) {
            return new WaterDropParticle(p_108504_, p_108505_, p_108506_, p_108507_, this.sprite.get(p_445633_));
        }
    }
}
