...
public class CodModel extends EntityModel<LivingEntityRenderState> {
    ...
    public CodModel(ModelPart p_481790_) {
        super(p_481790_);
        this.tailFin = p_481790_.getChild("tail_fin");
    }
    ...
    public void setupAnim(LivingEntityRenderState p_478786_) {
        super.setupAnim(p_478786_);
        float f = p_478786_.isInWater ? 1.0F : 1.5F;
        this.tailFin.yRot = -f * 0.45F * Mth.sin(0.6F * p_478786_.ageInTicks);
    }
}
