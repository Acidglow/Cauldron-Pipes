...
public class BreezeModel extends EntityModel<BreezeRenderState> {
    ...
    public BreezeModel(ModelPart p_479258_) {
        super(p_479258_, RenderTypes::entityTranslucent);
        this.wind = p_479258_.getChild("wind_body");
        ...
        this.head = p_479258_.getChild("body").getChild("head");
        this.eyes = this.head.getChild("eyes");
        this.rods = p_479258_.getChild("body").getChild("rods");
        this.idleAnimation = BreezeAnimation.IDLE.bake(p_479258_);
        this.shootAnimation = BreezeAnimation.SHOOT.bake(p_479258_);
        this.slideAnimation = BreezeAnimation.SLIDE.bake(p_479258_);
        this.slideBackAnimation = BreezeAnimation.SLIDE_BACK.bake(p_479258_);
        this.inhaleAnimation = BreezeAnimation.INHALE.bake(p_479258_);
        this.jumpAnimation = BreezeAnimation.JUMP.bake(p_479258_);
    }
    ...
    public void setupAnim(BreezeRenderState p_480939_) {
        super.setupAnim(p_480939_);
        this.idleAnimation.apply(p_480939_.idle, p_480939_.ageInTicks);
        this.shootAnimation.apply(p_480939_.shoot, p_480939_.ageInTicks);
        this.slideAnimation.apply(p_480939_.slide, p_480939_.ageInTicks);
        this.slideBackAnimation.apply(p_480939_.slideBack, p_480939_.ageInTicks);
        this.inhaleAnimation.apply(p_480939_.inhale, p_480939_.ageInTicks);
        this.jumpAnimation.apply(p_480939_.longJump, p_480939_.ageInTicks);
    }
