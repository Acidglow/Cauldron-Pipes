...
public class ZombieVillagerModel<S extends ZombieVillagerRenderState> extends HumanoidModel<S> implements VillagerLikeModel<S> {
    public ZombieVillagerModel(ModelPart p_479461_) {
        super(p_479461_);
    }
    ...
    public static LayerDefinition createNoHatLayer() {
        return createBodyLayer().apply(p_480829_ -> {
            p_480829_.getRoot().clearChild("head").clearRecursively();
            return p_480829_;
        });
    }
    ...
    public static ArmorModelSet<LayerDefinition> createArmorLayerSet(CubeDeformation innerCubeDeformation, CubeDeformation outerCubeDeformation) {
        return createArmorMeshSet(ZombieVillagerModel::createBaseArmorMesh, innerCubeDeformation, outerCubeDeformation).map(p_481975_ -> LayerDefinition.create(p_481975_, 64, 32));
    }
    ...
    public void setupAnim(S p_482032_) {
        super.setupAnim(p_482032_);
        AnimationUtils.animateZombieArms(this.leftArm, this.rightArm, p_482032_.isAggressive, p_482032_);
    }

    public void translateToArms(ZombieVillagerRenderState p_482010_, PoseStack p_481937_) {
        this.translateToHand(p_482010_, HumanoidArm.RIGHT, p_481937_);
    }
}
