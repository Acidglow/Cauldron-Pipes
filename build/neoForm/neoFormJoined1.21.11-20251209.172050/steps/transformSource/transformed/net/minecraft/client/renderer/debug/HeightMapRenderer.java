...
public class HeightMapRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    @Override
    public void emitGizmos(double p_455432_, double p_454844_, double p_455905_, DebugValueAccess p_455083_, Frustum p_455655_, float p_455910_) {
        LevelAccessor levelaccessor = this.minecraft.level;
        BlockPos blockpos = BlockPos.containing(p_455432_, 0.0, p_455905_);
