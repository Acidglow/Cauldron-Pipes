...
public class StringSplitter {
    ...
    public int plainIndexAtWidth(String content, int maxWidth, Style style) {
        StringSplitter.WidthLimitedCharSink stringsplitter$widthlimitedcharsink = new StringSplitter.WidthLimitedCharSink(maxWidth);
    ...
    public FormattedText headByWidth(FormattedText content, int maxWidth, Style style) {
        final StringSplitter.WidthLimitedCharSink stringsplitter$widthlimitedcharsink = new StringSplitter.WidthLimitedCharSink(maxWidth);
    ...
    public int findLineBreak(String content, int maxWidth, Style style) {
        StringSplitter.LineBreakFinder stringsplitter$linebreakfinder = new StringSplitter.LineBreakFinder(maxWidth);
