...
public class SalmonModel extends EntityModel<SalmonRenderState> {
    ...
    public SalmonModel(ModelPart p_478935_) {
        super(p_478935_);
        this.bodyBack = p_478935_.getChild("body_back");
    }
    ...
    public void setupAnim(SalmonRenderState p_480827_) {
        super.setupAnim(p_480827_);
        float f = 1.0F;
        float f1 = 1.0F;
        if (!p_480827_.isInWater) {
            f = 1.3F;
            f1 = 1.7F;
        }

        this.bodyBack.yRot = -f * 0.25F * Mth.sin(f1 * 0.6F * p_480827_.ageInTicks);
    }
}
