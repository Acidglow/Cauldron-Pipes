...
public class PufferfishRenderer extends MobRenderer<Pufferfish, PufferfishRenderState, EntityModel<EntityRenderState>> {
    ...
    public Identifier getTextureLocation(PufferfishRenderState p_363552_) {
    ...
    public void extractRenderState(Pufferfish p_478441_, PufferfishRenderState p_362905_, float p_360796_) {
        super.extractRenderState(p_478441_, p_362905_, p_360796_);
        p_362905_.puffState = p_478441_.getPuffState();
    }
