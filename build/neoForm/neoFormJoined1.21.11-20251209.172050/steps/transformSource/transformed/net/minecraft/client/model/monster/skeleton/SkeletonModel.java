...
public class SkeletonModel<S extends SkeletonRenderState> extends HumanoidModel<S> {
    public SkeletonModel(ModelPart p_480366_) {
        super(p_480366_);
    }
    ...
    public void setupAnim(S p_482030_) {
        super.setupAnim(p_482030_);
        if (p_482030_.isAggressive && !p_482030_.isHoldingBow) {
            float f = p_482030_.attackTime;
            ...
            AnimationUtils.bobArms(this.rightArm, this.leftArm, p_482030_.ageInTicks);
        }
    }

    public void translateToHand(SkeletonRenderState p_480170_, HumanoidArm p_480493_, PoseStack p_482080_) {
        this.root().translateAndRotate(p_482080_);
        float f = p_480493_ == HumanoidArm.RIGHT ? 1.0F : -1.0F;
        ModelPart modelpart = this.getArm(p_480493_);
        modelpart.x += f;
        modelpart.translateAndRotate(p_482080_);
        modelpart.x -= f;
    }
}
