...
public class FrogModel extends EntityModel<FrogRenderState> {
    ...
    public FrogModel(ModelPart p_480813_) {
        super(p_480813_.getChild("root"));
        this.jumpAnimation = FrogAnimation.FROG_JUMP.bake(p_480813_);
        this.croakAnimation = FrogAnimation.FROG_CROAK.bake(p_480813_);
        this.tongueAnimation = FrogAnimation.FROG_TONGUE.bake(p_480813_);
        this.swimAnimation = FrogAnimation.FROG_SWIM.bake(p_480813_);
        this.walkAnimation = FrogAnimation.FROG_WALK.bake(p_480813_);
        this.idleWaterAnimation = FrogAnimation.FROG_IDLE_WATER.bake(p_480813_);
    }
    ...
    public void setupAnim(FrogRenderState p_479063_) {
        super.setupAnim(p_479063_);
        this.jumpAnimation.apply(p_479063_.jumpAnimationState, p_479063_.ageInTicks);
        this.croakAnimation.apply(p_479063_.croakAnimationState, p_479063_.ageInTicks);
        this.tongueAnimation.apply(p_479063_.tongueAnimationState, p_479063_.ageInTicks);
        if (p_479063_.isSwimming) {
            this.swimAnimation.applyWalk(p_479063_.walkAnimationPos, p_479063_.walkAnimationSpeed, 1.0F, 2.5F);
        } else {
            this.walkAnimation.applyWalk(p_479063_.walkAnimationPos, p_479063_.walkAnimationSpeed, 1.5F, 2.5F);
        }

        this.idleWaterAnimation.apply(p_479063_.swimIdleAnimationState, p_479063_.ageInTicks);
        this.croakingBody.visible = p_479063_.croakAnimationState.isStarted();
    }
}
