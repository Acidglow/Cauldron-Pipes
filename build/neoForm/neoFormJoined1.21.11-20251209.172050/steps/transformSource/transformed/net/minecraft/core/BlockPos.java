...
public class BlockPos extends Vec3i {
    public static final Codec<BlockPos> CODEC = Codec.INT_STREAM
        .<BlockPos>comapFlatMap(
            p_465894_ -> Util.fixedSize(p_465894_, 3).map(p_175270_ -> new BlockPos(p_175270_[0], p_175270_[1], p_175270_[2])),
    ...
    public BlockPos relative(Direction direction, int p_121949_) {
        return p_121949_ == 0
            ? this
            : new BlockPos(
                this.getX() + direction.getStepX() * p_121949_, this.getY() + direction.getStepY() * p_121949_, this.getZ() + direction.getStepZ() * p_121949_
            );
    }
