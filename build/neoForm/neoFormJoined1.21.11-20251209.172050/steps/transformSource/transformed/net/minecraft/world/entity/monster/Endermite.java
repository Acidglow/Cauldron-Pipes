...
public class Endermite extends Monster {
    ...
    @Override
    protected void readAdditionalSaveData(ValueInput p_421928_) {
        super.readAdditionalSaveData(p_421928_);
        this.life = p_421928_.getIntOr("Lifetime", 0);
    }

    @Override
    protected void addAdditionalSaveData(ValueOutput p_421766_) {
        super.addAdditionalSaveData(p_421766_);
        p_421766_.putInt("Lifetime", this.life);
    }
