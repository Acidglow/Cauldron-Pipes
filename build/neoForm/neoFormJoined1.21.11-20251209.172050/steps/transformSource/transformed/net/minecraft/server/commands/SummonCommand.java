...
public class SummonCommand {
    ...
    public static Entity createEntity(
        ...
        if (!Level.isInSpawnableBounds(blockpos)) {
            ...
            Entity entity = EntityType.loadEntityRecursive(compoundtag, serverlevel, EntitySpawnReason.COMMAND, p_396566_ -> {
                p_396566_.snapTo(pos.x, pos.y, pos.z, p_396566_.getYRot(), p_396566_.getXRot());
                return p_396566_;
            });
            if (entity == null) {
                ...
                if (randomizeProperties && entity instanceof Mob mob) {
                    mob.finalizeSpawn(
                        source.getLevel(), source.getLevel().getCurrentDifficultyAt(entity.blockPosition()), EntitySpawnReason.COMMAND, null
                    );
                }
