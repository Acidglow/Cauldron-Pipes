...
public abstract class VoxelShape {
    ...
    public Optional<Vec3> closestPointTo(Vec3 point) {
        if (this.isEmpty()) {
            ...
            this.forAllBoxes((p_460621_, p_460622_, p_460623_, p_460624_, p_460625_, p_460626_) -> {
                double d0 = Mth.clamp(point.x(), p_460621_, p_460624_);
                double d1 = Mth.clamp(point.y(), p_460622_, p_460625_);
                double d2 = Mth.clamp(point.z(), p_460623_, p_460626_);
                Vec3 vec3 = mutableobject.get();
                if (vec3 == null || point.distanceToSqr(d0, d1, d2) < point.distanceToSqr(vec3)) {
