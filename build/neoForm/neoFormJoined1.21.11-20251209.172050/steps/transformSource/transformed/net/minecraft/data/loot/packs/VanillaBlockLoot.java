...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        Blocks.COPPER_BARS.forEach(p_436521_ -> this.dropSelf(p_436521_));
        ...
        Blocks.COPPER_CHAIN.forEach(p_436523_ -> this.dropSelf(p_436523_));
        ...
        this.add(Blocks.SCULK_VEIN, p_344237_ -> this.createMultifaceBlockDrops(p_344237_, this.hasSilkTouch()));
        ...
        this.add(Blocks.PALE_MOSS_CARPET, p_378912_ -> this.createMossyCarpetBlockDrops(p_378912_));
        this.add(Blocks.PALE_HANGING_MOSS, p_404170_ -> this.createShearsOrSilkTouchOnlyDrop(p_404170_));
        ...
        this.add(Blocks.COPPER_GOLEM_STATUE, p_445277_ -> this.createCopperGolemStatueBlock(p_445277_));
        this.add(Blocks.EXPOSED_COPPER_GOLEM_STATUE, p_445271_ -> this.createCopperGolemStatueBlock(p_445271_));
        this.add(Blocks.WEATHERED_COPPER_GOLEM_STATUE, p_445275_ -> this.createCopperGolemStatueBlock(p_445275_));
        this.add(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, p_445267_ -> this.createCopperGolemStatueBlock(p_445267_));
        this.add(Blocks.WAXED_COPPER_GOLEM_STATUE, p_445273_ -> this.createCopperGolemStatueBlock(p_445273_));
        this.add(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, p_445265_ -> this.createCopperGolemStatueBlock(p_445265_));
        this.add(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, p_445269_ -> this.createCopperGolemStatueBlock(p_445269_));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, p_445279_ -> this.createCopperGolemStatueBlock(p_445279_));
        ...
        this.add(Blocks.POLISHED_DEEPSLATE_SLAB, p_344225_ -> this.createSlabItemTable(p_344225_));
        this.add(Blocks.DEEPSLATE_TILE_SLAB, p_344249_ -> this.createSlabItemTable(p_344249_));
        this.add(Blocks.DEEPSLATE_BRICK_SLAB, p_344213_ -> this.createSlabItemTable(p_344213_));
        this.add(Blocks.MUD_BRICK_SLAB, p_382633_ -> this.createSlabItemTable(p_382633_));
        this.add(Blocks.RESIN_BRICK_SLAB, p_392600_ -> this.createSlabItemTable(p_392600_));
        this.add(Blocks.OAK_DOOR, p_382586_ -> this.createDoorTable(p_382586_));
        this.add(Blocks.SPRUCE_DOOR, p_382572_ -> this.createDoorTable(p_382572_));
        this.add(Blocks.BIRCH_DOOR, p_382641_ -> this.createDoorTable(p_382641_));
        this.add(Blocks.JUNGLE_DOOR, p_382643_ -> this.createDoorTable(p_382643_));
        this.add(Blocks.ACACIA_DOOR, p_382609_ -> this.createDoorTable(p_382609_));
        this.add(Blocks.DARK_OAK_DOOR, p_382564_ -> this.createDoorTable(p_382564_));
        this.add(Blocks.PALE_OAK_DOOR, p_382580_ -> this.createDoorTable(p_382580_));
        this.add(Blocks.MANGROVE_DOOR, p_382566_ -> this.createDoorTable(p_382566_));
        this.add(Blocks.CHERRY_DOOR, p_382625_ -> this.createDoorTable(p_382625_));
        this.add(Blocks.BAMBOO_DOOR, p_382604_ -> this.createDoorTable(p_382604_));
        this.add(Blocks.WARPED_DOOR, p_382607_ -> this.createDoorTable(p_382607_));
        this.add(Blocks.CRIMSON_DOOR, p_382617_ -> this.createDoorTable(p_382617_));
        this.add(Blocks.IRON_DOOR, p_382602_ -> this.createDoorTable(p_382602_));
        this.add(Blocks.COPPER_DOOR, p_382623_ -> this.createDoorTable(p_382623_));
        this.add(Blocks.EXPOSED_COPPER_DOOR, p_382600_ -> this.createDoorTable(p_382600_));
        this.add(Blocks.WEATHERED_COPPER_DOOR, p_382596_ -> this.createDoorTable(p_382596_));
        this.add(Blocks.OXIDIZED_COPPER_DOOR, p_382584_ -> this.createDoorTable(p_382584_));
        this.add(Blocks.WAXED_COPPER_DOOR, p_382639_ -> this.createDoorTable(p_382639_));
        this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, p_382637_ -> this.createDoorTable(p_382637_));
        this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, p_382629_ -> this.createDoorTable(p_382629_));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, p_382613_ -> this.createDoorTable(p_382613_));
                                ...
                                LootItem.lootTableItem(Items.COCOA_BEANS)
                                    .apply(
                                        SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))
                                            .when(
                                                LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_466054_)
                        ...
                        .add(
                            (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                                ...
                                LootItem.lootTableItem(p_248918_)
                                    .apply(
                                        List.of(2, 3, 4),
                                        p_466043_ -> SetItemCountFunction.setCount(ConstantValue.exactly(p_466043_.intValue()))
                                            .when(
                                                LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_248918_)
                                                    .setProperties(
                                                        StatePropertiesPredicate.Builder.properties().hasProperty(SeaPickleBlock.PICKLES, p_466043_.intValue())
                                                    )
                                            )
                                    )
                            )
        ...
        this.add(
            Blocks.COMPOSTER,
            p_466041_ -> LootTable.lootTable()
                .withPool(
                    LootPool.lootPool().add((LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(p_466041_, LootItem.lootTableItem(Items.COMPOSTER)))
                )
                .withPool(
                    LootPool.lootPool()
                        .add(LootItem.lootTableItem(Items.BONE_MEAL))
                        .when(
                            LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_466041_)
                                .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(ComposterBlock.LEVEL, 8))
                        )
                )
        );
        this.add(Blocks.CAVE_VINES, p_344215_ -> this.createCaveVinesDrop(p_344215_));
        this.add(Blocks.CAVE_VINES_PLANT, p_344245_ -> this.createCaveVinesDrop(p_344245_));
        this.add(Blocks.CANDLE, p_382635_ -> this.createCandleDrops(p_382635_));
        this.add(Blocks.WHITE_CANDLE, p_382611_ -> this.createCandleDrops(p_382611_));
        this.add(Blocks.ORANGE_CANDLE, p_382594_ -> this.createCandleDrops(p_382594_));
        this.add(Blocks.MAGENTA_CANDLE, p_382576_ -> this.createCandleDrops(p_382576_));
        this.add(Blocks.LIGHT_BLUE_CANDLE, p_382615_ -> this.createCandleDrops(p_382615_));
        this.add(Blocks.YELLOW_CANDLE, p_382582_ -> this.createCandleDrops(p_382582_));
        this.add(Blocks.LIME_CANDLE, p_382598_ -> this.createCandleDrops(p_382598_));
        this.add(Blocks.PINK_CANDLE, p_382568_ -> this.createCandleDrops(p_382568_));
        this.add(Blocks.GRAY_CANDLE, p_382631_ -> this.createCandleDrops(p_382631_));
        this.add(Blocks.LIGHT_GRAY_CANDLE, p_382590_ -> this.createCandleDrops(p_382590_));
        this.add(Blocks.CYAN_CANDLE, p_382627_ -> this.createCandleDrops(p_382627_));
        this.add(Blocks.PURPLE_CANDLE, p_382619_ -> this.createCandleDrops(p_382619_));
        this.add(Blocks.BLUE_CANDLE, p_382588_ -> this.createCandleDrops(p_382588_));
        this.add(Blocks.BROWN_CANDLE, p_382645_ -> this.createCandleDrops(p_382645_));
        this.add(Blocks.GREEN_CANDLE, p_382570_ -> this.createCandleDrops(p_382570_));
        this.add(Blocks.RED_CANDLE, p_382578_ -> this.createCandleDrops(p_382578_));
        this.add(Blocks.BLACK_CANDLE, p_382649_ -> this.createCandleDrops(p_382649_));
        ...
        this.add(Blocks.DROPPER, p_432351_ -> this.createNameableBlockEntityTable(p_432351_));
        this.add(Blocks.ENCHANTING_TABLE, p_432355_ -> this.createNameableBlockEntityTable(p_432355_));
        this.add(Blocks.FURNACE, p_432353_ -> this.createNameableBlockEntityTable(p_432353_));
        this.add(Blocks.HOPPER, p_432343_ -> this.createNameableBlockEntityTable(p_432343_));
        this.add(Blocks.TRAPPED_CHEST, p_432357_ -> this.createNameableBlockEntityTable(p_432357_));
        this.add(Blocks.SMOKER, p_432347_ -> this.createNameableBlockEntityTable(p_432347_));
        this.add(Blocks.BLAST_FURNACE, p_432349_ -> this.createNameableBlockEntityTable(p_432349_));
        this.add(Blocks.BARREL, p_432345_ -> this.createNameableBlockEntityTable(p_432345_));
        ...
        Blocks.COPPER_LANTERN.forEach(p_436519_ -> this.add(p_436519_, this::createSingleItemTable));
                ...
                .withPool(
                    this.applyExplosionCondition(
                        ...
                        LootPool.lootPool()
                            .setRolls(ConstantValue.exactly(1.0F))
                            .add(
                                LootItem.lootTableItem(p_450767_)
                                    .apply(
        ...
        this.add(Blocks.BEE_NEST, p_344223_ -> this.createBeeNestDrop(p_344223_));
        this.add(Blocks.BEEHIVE, p_344233_ -> this.createBeeHiveDrop(p_344233_));
        ...
        this.add(Blocks.PALE_OAK_LEAVES, p_382605_ -> this.createLeavesDrops(p_382605_, Blocks.PALE_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        ...
        this.add(
            ...
            p_466045_ -> this.applyExplosionDecay(
                p_466045_,
                LootTable.lootTable()
                    .withPool(
                        LootPool.lootPool()
        ...
        this.add(
            ...
            p_344211_ -> this.createSilkTouchDispatchTable(
                p_344211_,
                (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                    p_344211_,
        ...
        this.add(
            Blocks.COBWEB,
            p_344206_ -> this.createSilkTouchOrShearsDispatchTable(
                p_344206_, (LootPoolEntryContainer.Builder<?>)this.applyExplosionCondition(p_344206_, LootItem.lootTableItem(Items.STRING))
            )
        );
        this.add(
            Blocks.DEAD_BUSH,
            p_344234_ -> this.createShearsDispatchTable(
                p_344234_,
                (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                    p_344234_, LootItem.lootTableItem(Items.STICK).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F)))
                )
            )
        );
        this.add(Blocks.SHORT_DRY_GRASS, p_382574_ -> this.createShearsOrSilkTouchOnlyDrop(p_382574_));
        this.add(Blocks.TALL_DRY_GRASS, p_401714_ -> this.createShearsOrSilkTouchOnlyDrop(p_401714_));
        this.add(Blocks.BUSH, p_401716_ -> this.createShearsOrSilkTouchOnlyDrop(p_401716_));
        this.add(Blocks.NETHER_SPROUTS, p_359396_ -> this.createShearsOnlyDrop(p_359396_));
        this.add(Blocks.SEAGRASS, p_359392_ -> this.createShearsOnlyDrop(p_359392_));
        this.add(Blocks.VINE, p_359394_ -> this.createShearsOnlyDrop(p_359394_));
        this.add(Blocks.GLOW_LICHEN, p_359401_ -> this.createMultifaceBlockDrops(p_359401_, this.hasShears()));
        this.add(Blocks.RESIN_CLUMP, p_382647_ -> this.createMultifaceBlockDrops(p_382647_));
        this.add(Blocks.HANGING_ROOTS, p_359400_ -> this.createShearsOnlyDrop(p_359400_));
        this.add(Blocks.SMALL_DRIPLEAF, p_359398_ -> this.createShearsOnlyDrop(p_359398_));
        this.add(Blocks.MANGROVE_LEAVES, p_382621_ -> this.createMangroveLeavesDrops(p_382621_));
        ...
        this.add(
            Blocks.GLOWSTONE,
            p_344236_ -> this.createSilkTouchDispatchTable(
                p_344236_,
                (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                    p_344236_,
        ...
        this.add(
            Blocks.MELON,
            p_344241_ -> this.createSilkTouchDispatchTable(
                p_344241_,
                (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                    p_344241_,
        ...
        this.add(
            Blocks.SEA_LANTERN,
            p_344228_ -> this.createSilkTouchDispatchTable(
                p_344228_,
                (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                    p_344228_,
        ...
        this.add(
            ...
            p_382592_ -> this.createSilkTouchDispatchTable(
                p_382592_,
                (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                    p_382592_,
                                ...
                                LootItem.lootTableItem(Items.NETHER_WART)
                                    .apply(
                                        SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))
                                            .when(
                                                LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_466052_)
                        ...
                        .add(
                            AlternativesEntry.alternatives(
                                AlternativesEntry.alternatives(
                                        ...
                                        p_466056_ -> LootItem.lootTableItem(Items.SNOWBALL)
                                            .when(
                                                LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_372570_)
                                                    .setProperties(
                                                        StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, p_466056_.intValue())
                                                    )
                                            )
                                            .apply(SetItemCountFunction.setCount(ConstantValue.exactly(p_466056_.intValue())))
                                    )
                                    .when(this.doesNotHaveSilkTouch()),
                                AlternativesEntry.alternatives(
                                    SnowLayerBlock.LAYERS.getPossibleValues(),
                                    p_466050_ -> p_466050_ == 8
                                        ? LootItem.lootTableItem(Blocks.SNOW_BLOCK)
                                        : LootItem.lootTableItem(Blocks.SNOW)
                                            .apply(SetItemCountFunction.setCount(ConstantValue.exactly(p_466050_.intValue())))
                                            .when(
                                                LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_372570_)
                                                    .setProperties(
                                                        StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, p_466050_.intValue())
                                                    )
                                            )
                                )
                            )
        ...
        this.add(
            Blocks.GRAVEL,
            p_344231_ -> this.createSilkTouchDispatchTable(
                p_344231_,
                this.applyExplosionCondition(
                    p_344231_,
                    LootItem.lootTableItem(Items.FLINT)
                        ...
                        .otherwise(LootItem.lootTableItem(p_344231_))
                )
            )
        );
        this.add(
            Blocks.CAMPFIRE,
            p_344226_ -> this.createSilkTouchDispatchTable(
                p_344226_,
                (LootPoolEntryContainer.Builder<?>)this.applyExplosionCondition(
                    p_344226_, LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                )
            )
        );
        this.add(
            Blocks.GILDED_BLACKSTONE,
            p_344243_ -> this.createSilkTouchDispatchTable(
                p_344243_,
                this.applyExplosionCondition(
                    p_344243_,
                    LootItem.lootTableItem(Items.GOLD_NUGGET)
                        ...
                        .when(BonusLevelTableCondition.bonusLevelFlatChance(registrylookup.getOrThrow(Enchantments.FORTUNE), 0.1F, 0.14285715F, 0.25F, 1.0F))
                        .otherwise(LootItem.lootTableItem(p_344243_))
                )
            )
        );
        this.add(
            Blocks.SOUL_CAMPFIRE,
            p_344209_ -> this.createSilkTouchDispatchTable(
                p_344209_,
                (LootPoolEntryContainer.Builder<?>)this.applyExplosionCondition(
                    p_344209_, LootItem.lootTableItem(Items.SOUL_SOIL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
                )
            )
        );
        this.add(
            Blocks.AMETHYST_CLUSTER,
            p_466048_ -> this.createSilkTouchDispatchTable(
                p_466048_,
                LootItem.lootTableItem(Items.AMETHYST_SHARD)
                    ...
                    .otherwise(
                        (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                            p_466048_, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                        )
                    )
            )
        );
                            ...
                            AlternativesEntry.alternatives(
                                ...
                                p_466053_ -> {
                                    ...
                                    LootItemBlockStatePropertyCondition.Builder lootitemblockstatepropertycondition$builder1 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
                                        ...
                                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(PitcherCropBlock.AGE, p_466053_.intValue()));
                                    return p_466053_ == 4
                                        ? LootItem.lootTableItem(Items.PITCHER_PLANT)
