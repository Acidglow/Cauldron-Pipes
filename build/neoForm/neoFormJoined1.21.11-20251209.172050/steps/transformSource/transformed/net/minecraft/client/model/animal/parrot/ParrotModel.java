...
public class ParrotModel extends EntityModel<ParrotRenderState> {
    ...
    public ParrotModel(ModelPart p_478512_) {
        super(p_478512_);
        this.body = p_478512_.getChild("body");
        this.tail = p_478512_.getChild("tail");
        this.leftWing = p_478512_.getChild("left_wing");
        this.rightWing = p_478512_.getChild("right_wing");
        this.head = p_478512_.getChild("head");
        this.leftLeg = p_478512_.getChild("left_leg");
        this.rightLeg = p_478512_.getChild("right_leg");
    }
    ...
    public void setupAnim(ParrotRenderState p_481757_) {
        super.setupAnim(p_481757_);
        this.prepare(p_481757_.pose);
        this.head.xRot = p_481757_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_481757_.yRot * (float) (Math.PI / 180.0);
        switch (p_481757_.pose) {
            case STANDING:
                this.leftLeg.xRot = this.leftLeg.xRot + Mth.cos(p_481757_.walkAnimationPos * 0.6662F) * 1.4F * p_481757_.walkAnimationSpeed;
                this.rightLeg.xRot = this.rightLeg.xRot + Mth.cos(p_481757_.walkAnimationPos * 0.6662F + (float) Math.PI) * 1.4F * p_481757_.walkAnimationSpeed;
            case FLYING:
            case ON_SHOULDER:
            default:
                float f2 = p_481757_.flapAngle * 0.3F;
                this.head.y += f2;
                this.tail.xRot = this.tail.xRot + Mth.cos(p_481757_.walkAnimationPos * 0.6662F) * 0.3F * p_481757_.walkAnimationSpeed;
                this.tail.y += f2;
                this.body.y += f2;
                this.leftWing.zRot = -0.0873F - p_481757_.flapAngle;
                this.leftWing.y += f2;
                this.rightWing.zRot = 0.0873F + p_481757_.flapAngle;
                this.rightWing.y += f2;
                this.leftLeg.y += f2;
                this.rightLeg.y += f2;
            case SITTING:
                break;
            case PARTY:
                float f = Mth.cos(p_481757_.ageInTicks);
                float f1 = Mth.sin(p_481757_.ageInTicks);
                this.head.x += f;
                this.head.y += f1;
                this.head.xRot = 0.0F;
                this.head.yRot = 0.0F;
                this.head.zRot = Mth.sin(p_481757_.ageInTicks) * 0.4F;
                this.body.x += f;
                this.body.y += f1;
                this.leftWing.zRot = -0.0873F - p_481757_.flapAngle;
                this.leftWing.x += f;
