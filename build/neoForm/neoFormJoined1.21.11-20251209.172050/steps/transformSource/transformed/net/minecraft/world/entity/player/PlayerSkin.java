...
public record PlayerSkin(
    ...
    public static PlayerSkin insecure(
        ClientAsset.Texture body, ClientAsset.@Nullable Texture cape, ClientAsset.@Nullable Texture elytra, PlayerModelType model
    ) {
    ...
    public record Patch(
        ...
        public static final MapCodec<PlayerSkin.Patch> MAP_CODEC = RecordCodecBuilder.mapCodec(
            p_450964_ -> p_450964_.group(
                ...
                .apply(p_450964_, PlayerSkin.Patch::create)
        );
        ...
        public static PlayerSkin.Patch create(
            ...
            return body.isEmpty() && cape.isEmpty() && elytra.isEmpty() && model.isEmpty()
                ? EMPTY
                : new PlayerSkin.Patch(body, cape, elytra, model);
        }
    }
}
