...
public class GameEventTagsProvider extends KeyTagProvider<GameEvent> {
    ...
    /**
 * @deprecated Neo: Use the {@linkplain #GameEventTagsProvider(PackOutput,
 ...
 */
    ...
    public GameEventTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
        this(output, provider, "vanilla");
    }

    public GameEventTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, String modId) {
        super(output, Registries.GAME_EVENT, provider, modId);
    }
