...
public class VillagerModel extends EntityModel<VillagerRenderState> implements HeadedModel, VillagerLikeModel<VillagerRenderState> {
    ...
    public VillagerModel(ModelPart p_481266_) {
        super(p_481266_);
        this.head = p_481266_.getChild("head");
        this.rightLeg = p_481266_.getChild("right_leg");
        this.leftLeg = p_481266_.getChild("left_leg");
        this.arms = p_481266_.getChild("arms");
    }
    ...
    public void setupAnim(VillagerRenderState p_479869_) {
        super.setupAnim(p_479869_);
        this.head.yRot = p_479869_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_479869_.xRot * (float) (Math.PI / 180.0);
        if (p_479869_.isUnhappy) {
            this.head.zRot = 0.3F * Mth.sin(0.45F * p_479869_.ageInTicks);
            this.head.xRot = 0.4F;
        } else {
            this.head.zRot = 0.0F;
        }

        this.rightLeg.xRot = Mth.cos(p_479869_.walkAnimationPos * 0.6662F) * 1.4F * p_479869_.walkAnimationSpeed * 0.5F;
        this.leftLeg.xRot = Mth.cos(p_479869_.walkAnimationPos * 0.6662F + (float) Math.PI) * 1.4F * p_479869_.walkAnimationSpeed * 0.5F;
    ...
    public void translateToArms(VillagerRenderState p_480293_, PoseStack p_478367_) {
        this.root.translateAndRotate(p_478367_);
        this.arms.translateAndRotate(p_478367_);
    }
}
