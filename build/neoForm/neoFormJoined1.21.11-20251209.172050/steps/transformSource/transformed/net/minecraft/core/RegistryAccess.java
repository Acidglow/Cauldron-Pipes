...
public interface RegistryAccess extends HolderLookup.Provider {
    ...
    default <E> Registry<E> lookupOrThrow(ResourceKey<? extends Registry<? extends E>> p_368620_) {
        return this.lookup(p_368620_).orElseThrow(() -> new IllegalStateException("Missing registry: " + p_368620_));
    }
