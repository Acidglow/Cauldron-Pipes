            ...
            .thenCompose(
                p_454398_ -> {
                    ReloadableServerResources reloadableserverresources = new ReloadableServerResources(
                        p_454398_.layers(), p_454398_.lookupWithUpdatedTags(), enabledFeatures, commandSelection, postponedTags, functionCompilationPermissions
                    );

                    // Neo: Fire the AddServerReloadListenersEvent and use the resulting listeners instead of the vanilla listener list.
                    List<PreparableReloadListener> listeners = net.neoforged.neoforge.event.EventHooks.onResourceReload(reloadableserverresources, p_454398_.layers().compositeAccess());
