...
public class V4312 extends NamespacedSchema {
    public V4312(int p_401898_, Schema p_401801_) {
        super(p_401898_, p_401801_);
    }
        ...
        outputSchema.registerType(
            ...
            () -> DSL.and(
                ...
                DSL.optionalFields(
                    ...
                    Pair.of(
                        "recipeBook",
                        DSL.optionalFields("recipes", DSL.list(References.RECIPE.in(outputSchema)), "toBeDisplayed", DSL.list(References.RECIPE.in(outputSchema)))
                    )
                )
            )
        );
