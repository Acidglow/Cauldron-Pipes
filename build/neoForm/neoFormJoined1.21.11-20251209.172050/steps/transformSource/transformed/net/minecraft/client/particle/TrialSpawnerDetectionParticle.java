...
public class TrialSpawnerDetectionParticle extends SingleQuadParticle {
    ...
    public TrialSpawnerDetectionParticle(
        ClientLevel level,
        double x,
        double y,
        double z,
        ...
        this.lifetime = (int)(8.0F / Mth.randomBetween(this.random, 0.5F, 1.0F) * sizeMultiplier);
    ...
    public float getQuadSize(float p_312246_) {
        return this.quadSize * Mth.clamp((this.age + p_312246_) / this.lifetime * 32.0F, 0.0F, 1.0F);
    }
