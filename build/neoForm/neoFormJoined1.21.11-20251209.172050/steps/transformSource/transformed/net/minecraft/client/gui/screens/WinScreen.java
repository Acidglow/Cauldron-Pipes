...
public class WinScreen extends Screen {
    ...
    @Override
    public boolean keyPressed(KeyEvent p_445671_) {
        if (p_445671_.isUp()) {
            this.direction = -1;
        } else if (p_445671_.key() == 341 || p_445671_.key() == 345) {
            this.speedupModifiers.add(p_445671_.key());
        } else if (p_445671_.key() == 32) {
            this.speedupActive = true;
        }

        this.scrollSpeed = this.calculateScrollSpeed();
        return super.keyPressed(p_445671_);
    }

    @Override
    public boolean keyReleased(KeyEvent p_446746_) {
        if (p_446746_.isUp()) {
            this.direction = 1;
        }
        ...
        } else if (p_446746_.key() == 341 || p_446746_.key() == 345) {
            this.speedupModifiers.remove(p_446746_.key());
        }

        this.scrollSpeed = this.calculateScrollSpeed();
        return super.keyReleased(p_446746_);
    }
    ...
    private void wrapCreditsIO(Identifier location, WinScreen.CreditsReader p_reader) {
    ...
    private void addCreditsLine(Component text, boolean centered, boolean narrate) {
        if (centered) {
    ...
    public void renderBackground(GuiGraphics p_282239_, int p_294762_, int p_295473_, float p_296441_) {
        if (this.poem) {
            ...
            super.renderBackground(p_282239_, p_294762_, p_295473_, p_296441_);
        }
    }
    ...
    protected void renderMenuBackground(GuiGraphics p_333914_, int p_333869_, int p_334014_, int p_333930_, int p_333890_) {
        ...
        Screen.renderMenuBackgroundTexture(p_333914_, Screen.MENU_BACKGROUND, 0, 0, 0.0F, f, p_333930_, p_333890_);
    }
