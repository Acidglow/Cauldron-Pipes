...
public class SpinAttackEffectModel extends EntityModel<AvatarRenderState> {
    ...
    public SpinAttackEffectModel(ModelPart p_479203_) {
        super(p_479203_);

        for (int i = 0; i < 2; i++) {
            this.boxes[i] = p_479203_.getChild(boxName(i));
        }
    }
    ...
    public void setupAnim(AvatarRenderState p_480873_) {
        super.setupAnim(p_480873_);

        for (int i = 0; i < this.boxes.length; i++) {
            float f = p_480873_.ageInTicks * -(45 + (i + 1) * 5);
