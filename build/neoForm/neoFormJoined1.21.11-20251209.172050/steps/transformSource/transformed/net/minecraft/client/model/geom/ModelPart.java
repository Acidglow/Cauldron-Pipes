...
public final class ModelPart {
    ...
    public void getExtentsForGui(PoseStack poseStack, Consumer<Vector3fc> output) {
        this.visit(poseStack, (p_470483_, p_470484_, p_470485_, p_470486_) -> {
            for (ModelPart.Polygon modelpart$polygon : p_470486_.polygons) {
                for (ModelPart.Vertex modelpart$vertex : modelpart$polygon.vertices()) {
                    ...
                    Vector3f vector3f = p_470483_.pose().transformPosition(f, f1, f2, new Vector3f());
