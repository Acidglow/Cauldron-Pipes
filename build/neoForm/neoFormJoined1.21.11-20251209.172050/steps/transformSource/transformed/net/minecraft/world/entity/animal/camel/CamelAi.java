...
public class CamelAi {
    ...
    public static class CamelPanic extends AnimalPanic<Camel> {
        ...
        protected boolean checkExtraStartConditions(ServerLevel p_470608_, Camel p_470833_) {
            return super.checkExtraStartConditions(p_470608_, p_470833_) && !p_470833_.isMobControlled();
        }
