...
public class BiomeDefaultFeatures {
    ...
    public static void snowySpawns(MobSpawnSettings.Builder builder, boolean notIceSpikes) {
        ...
        caveSpawns(builder);
        monsters(builder, notIceSpikes ? 90 : 95, 5, notIceSpikes ? 5 : 0, 20, false);
    ...
    public static void monsters(MobSpawnSettings.Builder builder, int zombieWeight, int zombieVillagerWeight, int zombieHorseWeight, int skeletonWeight, boolean isUnderwater) {
