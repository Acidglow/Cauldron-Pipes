...
public class DefaultRandomPos {
    ...
    public static @Nullable Vec3 getPosTowards(PathfinderMob mob, int radius, int yRange, Vec3 vectorPosition, double amplifier) {
        ...
        return RandomPos.generateRandomPos(
            ...
            () -> {
                BlockPos blockpos = RandomPos.generateRandomDirectionWithinRadians(
                    mob.getRandom(), 0.0, radius, yRange, 0, vec3.x, vec3.z, (float) (Math.PI / 2)
                );
                return blockpos == null ? null : generateRandomPosTowardDirection(mob, radius, flag, blockpos);
            }
        );
    ...
    private static @Nullable BlockPos generateRandomPosTowardDirection(PathfinderMob mob, int radius, boolean shortCircuit, BlockPos pos) {
