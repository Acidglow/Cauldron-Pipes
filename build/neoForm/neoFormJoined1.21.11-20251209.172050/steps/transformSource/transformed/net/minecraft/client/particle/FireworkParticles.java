...
public class FireworkParticles {
    ...
    public static class FlashProvider implements ParticleProvider<ColorParticleOption> {
        ...
        public Particle createParticle(
            ColorParticleOption p_447119_,
            ClientLevel p_106660_,
            double p_106661_,
            double p_106662_,
            double p_106663_,
            double p_106664_,
            double p_106665_,
            double p_106666_,
            RandomSource p_447147_
        ) {
            FireworkParticles.OverlayParticle fireworkparticles$overlayparticle = new FireworkParticles.OverlayParticle(
                p_106660_, p_106661_, p_106662_, p_106663_, this.sprite.get(p_447147_)
            );
            fireworkparticles$overlayparticle.setColor(p_447119_.getRed(), p_447119_.getGreen(), p_447119_.getBlue());
            fireworkparticles$overlayparticle.setAlpha(p_447119_.getAlpha());
    ...
    public static class OverlayParticle extends SingleQuadParticle {
        public OverlayParticle(ClientLevel p_106677_, double p_106678_, double p_106679_, double p_106680_, TextureAtlasSprite p_445403_) {
            super(p_106677_, p_106678_, p_106679_, p_106680_, p_445403_);
            this.lifetime = 4;
        }
        ...
        @Override
        public void extract(QuadParticleRenderState p_451366_, Camera p_445719_, float p_445704_) {
            this.setAlpha(0.6F - (this.age + p_445704_ - 1.0F) * 0.25F * 0.5F);
            super.extract(p_451366_, p_445719_, p_445704_);
        }
    ...
    public static class Starter extends NoRenderParticle {
        ...
        public void tick() {
            ...
            if (this.life % 2 == 0 && this.life / 2 < this.explosions.size()) {
                ...
                this.engine.createParticle(ColorParticleOption.create(ParticleTypes.FLASH, i), this.x, this.y, this.z, 0.0, 0.0, 0.0);
            }
