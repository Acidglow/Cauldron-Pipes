...
public class ShulkerBulletModel extends EntityModel<ShulkerBulletRenderState> {
    ...
    public ShulkerBulletModel(ModelPart p_479930_) {
        super(p_479930_);
        this.main = p_479930_.getChild("main");
    }
    ...
    public void setupAnim(ShulkerBulletRenderState p_479567_) {
        super.setupAnim(p_479567_);
        this.main.yRot = p_479567_.yRot * (float) (Math.PI / 180.0);
        this.main.xRot = p_479567_.xRot * (float) (Math.PI / 180.0);
    }
}
