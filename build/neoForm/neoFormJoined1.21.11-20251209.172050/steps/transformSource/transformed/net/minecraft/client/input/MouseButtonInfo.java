...
public record MouseButtonInfo(@MouseButtonInfo.MouseButton int button, @InputWithModifiers.Modifiers int modifiers) implements InputWithModifiers {
    ...
    @OnlyIn(Dist.CLIENT)
    @org.intellij.lang.annotations.MagicConstant(intValues = {com.mojang.blaze3d.platform.InputConstants.PRESS, com.mojang.blaze3d.platform.InputConstants.RELEASE})
