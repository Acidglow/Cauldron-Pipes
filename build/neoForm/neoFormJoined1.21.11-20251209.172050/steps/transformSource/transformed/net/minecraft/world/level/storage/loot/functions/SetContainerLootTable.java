...
public class SetContainerLootTable extends LootItemConditionalFunction {
    public static final MapCodec<SetContainerLootTable> CODEC = RecordCodecBuilder.mapCodec(
        p_404621_ -> commonFields(p_404621_)
            .and(
                p_404621_.group(
                    LootTable.KEY_CODEC.fieldOf("name").forGetter(p_335347_ -> p_335347_.name),
                    Codec.LONG.optionalFieldOf("seed", 0L).forGetter(p_298105_ -> p_298105_.seed),
                    BuiltInRegistries.BLOCK_ENTITY_TYPE.holderByNameCodec().fieldOf("type").forGetter(p_298107_ -> p_298107_.type)
                )
            )
            .apply(p_404621_, SetContainerLootTable::new)
    );
