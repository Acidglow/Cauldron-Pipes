...
public class RabbitModel extends EntityModel<RabbitRenderState> {
    ...
    public RabbitModel(ModelPart p_480766_) {
        super(p_480766_);
        this.leftHaunch = p_480766_.getChild("left_haunch");
        this.rightHaunch = p_480766_.getChild("right_haunch");
        this.leftFrontLeg = p_480766_.getChild("left_front_leg");
        this.rightFrontLeg = p_480766_.getChild("right_front_leg");
        this.head = p_480766_.getChild("head");
    }
    ...
    public void setupAnim(RabbitRenderState p_479015_) {
        super.setupAnim(p_479015_);
        this.head.xRot = p_479015_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_479015_.yRot * (float) (Math.PI / 180.0);
        float f = Mth.sin(p_479015_.jumpCompletion * (float) Math.PI);
