...
public enum FrontAndTop implements StringRepresentable {
    ...
    private static final FrontAndTop[] BY_TOP_FRONT = Util.make(new FrontAndTop[NUM_DIRECTIONS * NUM_DIRECTIONS], p_378840_ -> {
        for (FrontAndTop frontandtop : values()) {
            p_378840_[lookupKey(frontandtop.front, frontandtop.top)] = frontandtop;
        }
    });
