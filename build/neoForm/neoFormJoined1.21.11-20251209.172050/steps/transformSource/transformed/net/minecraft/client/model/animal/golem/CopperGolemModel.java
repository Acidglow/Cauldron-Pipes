...
public class CopperGolemModel extends EntityModel<CopperGolemRenderState> implements ArmedModel<CopperGolemRenderState>, HeadedModel {
    ...
    public CopperGolemModel(ModelPart p_482057_) {
        super(p_482057_);
        this.body = p_482057_.getChild("body");
        this.head = this.body.getChild("head");
        this.rightArm = this.body.getChild("right_arm");
        this.leftArm = this.body.getChild("left_arm");
        this.walkAnimation = CopperGolemAnimation.COPPER_GOLEM_WALK.bake(p_482057_);
        this.walkWithItemAnimation = CopperGolemAnimation.COPPER_GOLEM_WALK_ITEM.bake(p_482057_);
        this.idleAnimation = CopperGolemAnimation.COPPER_GOLEM_IDLE.bake(p_482057_);
        this.interactionGetItem = CopperGolemAnimation.COPPER_GOLEM_CHEST_INTERACTION_NOITEM_GET.bake(p_482057_);
        this.interactionGetNoItem = CopperGolemAnimation.COPPER_GOLEM_CHEST_INTERACTION_NOITEM_NOGET.bake(p_482057_);
        this.interactionDropItem = CopperGolemAnimation.COPPER_GOLEM_CHEST_INTERACTION_ITEM_DROP.bake(p_482057_);
        this.interactionDropNoItem = CopperGolemAnimation.COPPER_GOLEM_CHEST_INTERACTION_ITEM_NODROP.bake(p_482057_);
    }

    public static LayerDefinition createBodyLayer() {
        MeshDefinition meshdefinition = new MeshDefinition().transformed(p_478925_ -> p_478925_.translated(0.0F, 24.0F, 0.0F));
    ...
    public static LayerDefinition createRunningPoseBodyLayer() {
        MeshDefinition meshdefinition = new MeshDefinition().transformed(p_479132_ -> p_479132_.translated(0.0F, 0.0F, 0.0F));
        PartDefinition partdefinition = meshdefinition.getRoot();
    ...
    public static LayerDefinition createSittingPoseBodyLayer() {
        MeshDefinition meshdefinition = new MeshDefinition().transformed(p_478854_ -> p_478854_.translated(0.0F, 0.0F, 0.0F));
        PartDefinition partdefinition = meshdefinition.getRoot();
        PartDefinition partdefinition1 = partdefinition.addOrReplaceChild(
            "body",
            CubeListBuilder.create()
    ...
    public static LayerDefinition createStarPoseBodyLayer() {
        MeshDefinition meshdefinition = new MeshDefinition().transformed(p_481844_ -> p_481844_.translated(0.0F, 0.0F, 0.0F));
        PartDefinition partdefinition = meshdefinition.getRoot();
        PartDefinition partdefinition1 = partdefinition.addOrReplaceChild(
            "body",
    ...
    public static LayerDefinition createEyesLayer() {
        return createBodyLayer().apply(p_479407_ -> {
            p_479407_.getRoot().retainPartsAndChildren(Set.of("eyes"));
            return p_479407_;
        });
    }

    public void setupAnim(CopperGolemRenderState p_480627_) {
        super.setupAnim(p_480627_);
        this.head.xRot = p_480627_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_480627_.yRot * (float) (Math.PI / 180.0);
        if (p_480627_.rightHandItemState.isEmpty() && p_480627_.leftHandItemState.isEmpty()) {
            this.walkAnimation.applyWalk(p_480627_.walkAnimationPos, p_480627_.walkAnimationSpeed, 2.0F, 2.5F);
        } else {
            this.walkWithItemAnimation.applyWalk(p_480627_.walkAnimationPos, p_480627_.walkAnimationSpeed, 2.0F, 2.5F);
            this.poseHeldItemArmsIfStill();
        }

        this.idleAnimation.apply(p_480627_.idleAnimationState, p_480627_.ageInTicks);
        this.interactionGetItem.apply(p_480627_.interactionGetItem, p_480627_.ageInTicks);
        this.interactionGetNoItem.apply(p_480627_.interactionGetNoItem, p_480627_.ageInTicks);
        this.interactionDropItem.apply(p_480627_.interactionDropItem, p_480627_.ageInTicks);
        this.interactionDropNoItem.apply(p_480627_.interactionDropNoItem, p_480627_.ageInTicks);
    }

    public void translateToHand(CopperGolemRenderState p_478551_, HumanoidArm p_480324_, PoseStack p_478358_) {
        this.root.translateAndRotate(p_478358_);
        this.body.translateAndRotate(p_478358_);
        ModelPart modelpart = p_480324_ == HumanoidArm.RIGHT ? this.rightArm : this.leftArm;
        modelpart.translateAndRotate(p_478358_);
        if (p_478551_.copperGolemState.equals(CopperGolemState.IDLE)) {
            p_478358_.mulPose(Axis.YP.rotationDegrees(p_480324_ == HumanoidArm.RIGHT ? -90.0F : 90.0F));
            p_478358_.translate(0.0F, 0.0F, 0.125F);
        } else {
            p_478358_.scale(0.55F, 0.55F, 0.55F);
            p_478358_.translate(-0.125F, 0.3125F, -0.1875F);
        }
    }
    ...
    @Override
    public void translateToHead(PoseStack p_481114_) {
        this.body.translateAndRotate(p_481114_);
        this.head.translateAndRotate(p_481114_);
        p_481114_.translate(0.0F, 0.125F, 0.0F);
        p_481114_.scale(1.0625F, 1.0625F, 1.0625F);
    }
