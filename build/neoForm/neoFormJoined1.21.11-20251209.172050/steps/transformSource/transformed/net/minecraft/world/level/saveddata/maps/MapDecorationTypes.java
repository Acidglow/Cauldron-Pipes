...
public class MapDecorationTypes {
    ...
    private static Holder<MapDecorationType> register(
        ...
        MapDecorationType mapdecorationtype = new MapDecorationType(Identifier.withDefaultNamespace(assetId), showOnItemFrame, mapColor, trackCount, explorationMapElement);
