...
public abstract class StuckInBodyLayer<M extends PlayerModel, S> extends RenderLayer<AvatarRenderState, M> {
    ...
    public void submit(PoseStack p_436030_, SubmitNodeCollector p_432880_, int p_432778_, AvatarRenderState p_446278_, float p_434298_, float p_434732_) {
        int i = this.numStuck(p_446278_);
        if (i > 0) {
            RandomSource randomsource = RandomSource.create(p_446278_.id);
