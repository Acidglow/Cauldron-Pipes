...
public class BlockUtil {
    ...
    public static BlockUtil.FoundRectangle getLargestRectangleAround(
        BlockPos centerPos, Direction.Axis axis1, int max1, Direction.Axis axis2, int pos2, Predicate<BlockPos> posPredicate
    ) {
        ...
        ablockutil$intbounds[i] = new BlockUtil.IntBounds(
            getLimit(posPredicate, blockpos$mutableblockpos.set(centerPos), direction2, pos2),
            getLimit(posPredicate, blockpos$mutableblockpos.set(centerPos), direction3, pos2)
        );
