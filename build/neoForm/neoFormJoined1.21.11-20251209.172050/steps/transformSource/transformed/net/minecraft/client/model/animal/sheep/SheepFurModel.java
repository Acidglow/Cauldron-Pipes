...
public class SheepFurModel extends QuadrupedModel<SheepRenderState> {
    public SheepFurModel(ModelPart p_478305_) {
        super(p_478305_);
    }
    ...
    public void setupAnim(SheepRenderState p_481578_) {
        super.setupAnim(p_481578_);
        this.head.y = this.head.y + p_481578_.headEatPositionScale * 9.0F * p_481578_.ageScale;
        this.head.xRot = p_481578_.headEatAngleScale;
    }
}
