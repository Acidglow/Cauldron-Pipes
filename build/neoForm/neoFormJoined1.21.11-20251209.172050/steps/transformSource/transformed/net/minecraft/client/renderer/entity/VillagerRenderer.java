...
public class VillagerRenderer extends AgeableMobRenderer<Villager, VillagerRenderState, VillagerModel> {
    ...
    public Identifier getTextureLocation(VillagerRenderState p_362235_) {
    ...
    public void extractRenderState(Villager p_480330_, VillagerRenderState p_363733_, float p_365246_) {
        super.extractRenderState(p_480330_, p_363733_, p_365246_);
        HoldingEntityRenderState.extractHoldingEntityRenderState(p_480330_, p_363733_, this.itemModelResolver);
        p_363733_.isUnhappy = p_480330_.getUnhappyCounter() > 0;
        p_363733_.villagerData = p_480330_.getVillagerData();
    }
}
