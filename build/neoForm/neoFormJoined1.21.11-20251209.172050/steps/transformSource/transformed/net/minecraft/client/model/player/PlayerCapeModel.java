...
public class PlayerCapeModel extends PlayerModel {
    ...
    public PlayerCapeModel(ModelPart p_481837_) {
        super(p_481837_, false);
    }
    ...
    @Override
    public void setupAnim(AvatarRenderState p_481699_) {
        super.setupAnim(p_481699_);
        this.cape
            .rotateBy(
                new Quaternionf()
                    .rotateY((float) -Math.PI)
                    .rotateX((6.0F + p_481699_.capeLean / 2.0F + p_481699_.capeFlap) * (float) (Math.PI / 180.0))
                    .rotateZ(p_481699_.capeLean2 / 2.0F * (float) (Math.PI / 180.0))
                    .rotateY((180.0F - p_481699_.capeLean2 / 2.0F) * (float) (Math.PI / 180.0))
            );
    }
}
