...
public class CompoundContainer implements Container {
    ...
    @Override
    public void startOpen(ContainerUser p_434294_) {
        this.container1.startOpen(p_434294_);
        this.container2.startOpen(p_434294_);
    }

    @Override
    public void stopOpen(ContainerUser p_433780_) {
        this.container1.stopOpen(p_433780_);
        this.container2.stopOpen(p_433780_);
    }
