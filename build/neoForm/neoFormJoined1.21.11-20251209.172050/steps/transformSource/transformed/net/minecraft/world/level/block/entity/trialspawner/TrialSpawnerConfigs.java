...
public class TrialSpawnerConfigs {
        ...
        register(
            ...
            TrialSpawnerConfig.builder()
                ...
                .spawnPotentialsDefinition(
                    WeightedList.of(customSpawnDataWithEquipment(EntityType.ZOMBIE, p_368519_ -> p_368519_.putBoolean("IsBaby", true), null))
                )
                .build(),
            TrialSpawnerConfig.builder()
                .simultaneousMobsAddedPerPlayer(0.5F)
    ...
    private static <T extends Entity> SpawnData spawnData(EntityType<T> entityType) {
        return customSpawnDataWithEquipment(entityType, p_368629_ -> {}, null);
    }
    ...
    private static <T extends Entity> SpawnData spawnDataWithEquipment(EntityType<T> entityType, ResourceKey<LootTable> lootTableKey) {
        return customSpawnDataWithEquipment(entityType, p_368493_ -> {}, lootTableKey);
    }
    ...
    private static <T extends Entity> SpawnData customSpawnDataWithEquipment(
        ...
        Optional<EquipmentTable> optional = Optional.ofNullable(lootTableKey).map(p_368648_ -> new EquipmentTable((ResourceKey<LootTable>)p_368648_, 0.0F));
