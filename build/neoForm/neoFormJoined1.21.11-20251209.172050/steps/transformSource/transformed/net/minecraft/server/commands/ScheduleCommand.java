...
public class ScheduleCommand {
    ...
    private static int schedule(
        ...
        if (time == 0) {
            ...
            long i = source.getLevel().getGameTime() + time;
            ...
            if (optional.isPresent()) {
                ...
                source.sendSuccess(
                    () -> Component.translatable("commands.schedule.created.function", Component.translationArg(identifier), time, i), true
                );
            } else {
                ...
                source.sendSuccess(() -> Component.translatable("commands.schedule.created.tag", Component.translationArg(identifier), time, i), true);
            }
