...
public class V705 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:arrow", p_18164_ -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(
            ...
            p_392938_ -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), "LastOutput", References.TEXT_COMPONENT.in(schema))
        );
        ...
        schema.register(
            map,
            "minecraft:donkey",
            p_396655_ -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema))
        );
        ...
        schema.register(map, "minecraft:enderman", p_18158_ -> DSL.optionalFields("carried", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(map, "minecraft:fireworks_rocket", p_396638_ -> DSL.optionalFields("FireworksItem", References.ITEM_STACK.in(schema)));
        schema.register(map, "minecraft:furnace_minecart", p_397034_ -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(
            map,
            "minecraft:horse",
            p_396649_ -> DSL.optionalFields("ArmorItem", References.ITEM_STACK.in(schema), "SaddleItem", References.ITEM_STACK.in(schema))
        );
        ...
        schema.register(map, "minecraft:minecart", p_18122_ -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema)));
        registerMob(schema, map, "minecraft:mooshroom");
        schema.register(
            map,
            "minecraft:mule",
            p_396643_ -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema))
        );
        ...
        schema.register(map, "minecraft:skeleton_horse", p_18140_ -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema)));
        ...
        schema.register(map, "minecraft:spectral_arrow", p_18107_ -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(map, "minecraft:zombie_horse", p_396653_ -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema)));
        registerMob(schema, map, "minecraft:zombie_pigman");
        schema.register(
            map,
            "minecraft:zombie_villager",
            p_396651_ -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in(schema))))
        );
