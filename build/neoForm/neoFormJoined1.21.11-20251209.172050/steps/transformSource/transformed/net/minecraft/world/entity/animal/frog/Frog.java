...
public class Frog extends Animal {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_326194_) {
        ...
        p_326194_.define(DATA_VARIANT_ID, VariantUtils.getDefaultOrAny(this.registryAccess(), DEFAULT_VARIANT));
    ...
    @Override
    public <T> @Nullable T get(DataComponentType<? extends T> p_397492_) {
        return p_397492_ == DataComponents.FROG_VARIANT ? castComponentValue((DataComponentType<T>)p_397492_, this.getVariant()) : super.get(p_397492_);
    }

    @Override
    protected void applyImplicitComponents(DataComponentGetter p_398009_) {
        this.applyImplicitComponentIfPresent(p_398009_, DataComponents.FROG_VARIANT);
        super.applyImplicitComponents(p_398009_);
    }

    @Override
    protected <T> boolean applyImplicitComponent(DataComponentType<T> p_397257_, T p_397258_) {
        if (p_397257_ == DataComponents.FROG_VARIANT) {
            this.setVariant(castComponentValue(DataComponents.FROG_VARIANT, p_397258_));
            return true;
        } else {
            return super.applyImplicitComponent(p_397257_, p_397258_);
        }
    }

    @Override
    protected void addAdditionalSaveData(ValueOutput p_422666_) {
        super.addAdditionalSaveData(p_422666_);
        VariantUtils.writeVariant(p_422666_, this.getVariant());
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_422028_) {
        super.readAdditionalSaveData(p_422028_);
        VariantUtils.readVariant(p_422028_, Registries.FROG_VARIANT).ifPresent(this::setVariant);
    }

    @Override
    protected void customServerAiStep(ServerLevel p_376431_) {
        ProfilerFiller profilerfiller = Profiler.get();
        profilerfiller.push("frogBrain");
        this.getBrain().tick(p_376431_, this);
        profilerfiller.pop();
        profilerfiller.push("frogActivityUpdate");
        FrogAi.updateActivity(this);
        profilerfiller.pop();
        super.customServerAiStep(p_376431_);
    }
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_218488_, DifficultyInstance p_218489_, EntitySpawnReason p_361013_, @Nullable SpawnGroupData p_218491_
    ) {
        ...
        return super.finalizeSpawn(p_218488_, p_218489_, p_361013_, p_218491_);
    }
    ...
    @Override
    protected int calculateFallDamage(double p_397739_, float p_218519_) {
        return super.calculateFallDamage(p_397739_, p_218519_) - 5;
    }

    @Override
    protected void travelInWater(Vec3 p_461071_, double p_461250_, boolean p_461275_, double p_460880_) {
        this.moveRelative(this.getSpeed(), p_461071_);
