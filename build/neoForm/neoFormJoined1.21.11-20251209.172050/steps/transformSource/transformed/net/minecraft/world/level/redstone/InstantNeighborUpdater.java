...
public class InstantNeighborUpdater implements NeighborUpdater {
    ...
    @Override
    public void neighborChanged(BlockPos p_230751_, Block p_230752_, @Nullable Orientation p_364727_) {
        BlockState blockstate = this.level.getBlockState(p_230751_);
        this.neighborChanged(blockstate, p_230751_, p_230752_, p_364727_, false);
    }

    @Override
    public void neighborChanged(BlockState p_230745_, BlockPos p_230746_, Block p_230747_, @Nullable Orientation p_365054_, boolean p_230749_) {
        NeighborUpdater.executeUpdate(this.level, p_230745_, p_230746_, p_230747_, p_365054_, p_230749_);
    }
}
