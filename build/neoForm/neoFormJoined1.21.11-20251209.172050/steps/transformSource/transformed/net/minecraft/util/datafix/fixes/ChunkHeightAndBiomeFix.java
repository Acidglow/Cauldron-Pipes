    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            p_184879_ -> p_184879_.updateTyped(
                ...
                type2,
                p_460363_ -> {
                    Dynamic<?> dynamic = p_460363_.get(DSL.remainderFinder());
                    ...
                    p_460363_ = p_460363_.updateTyped(opticfinder1, type3, p_466456_ -> {
                        IntSet intset = new IntOpenHashSet();
                        Dynamic<?> dynamic3 = (Dynamic<?>)p_466456_.write()
                            .result()
                    ...
                    return p_460363_.update(DSL.remainderFinder(), p_460359_ -> {
                        if (flag) {
                            p_460359_ = this.predictChunkStatusBeforeSurface(p_460359_, set);
                        }

                        return updateChunkTag(p_460359_, flag, mutableboolean.booleanValue(), "minecraft:noise".equals(s1), mutableobject.get());
                    });
                }
            )
        );
