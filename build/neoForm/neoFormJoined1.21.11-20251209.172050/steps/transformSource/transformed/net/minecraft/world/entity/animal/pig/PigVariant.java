...
public record PigVariant(ModelAndTexture<PigVariant.ModelType> modelAndTexture, SpawnPrioritySelectors spawnConditions)
    ...
    public static final Codec<PigVariant> DIRECT_CODEC = RecordCodecBuilder.create(
        p_478299_ -> p_478299_.group(
            ...
            .apply(p_478299_, PigVariant::new)
    );
    public static final Codec<PigVariant> NETWORK_CODEC = RecordCodecBuilder.create(
        p_479362_ -> p_479362_.group(ModelAndTexture.codec(PigVariant.ModelType.CODEC, PigVariant.ModelType.NORMAL).forGetter(PigVariant::modelAndTexture))
            .apply(p_479362_, PigVariant::new)
    );
    ...
    private PigVariant(ModelAndTexture<PigVariant.ModelType> p_478429_) {
        this(p_478429_, SpawnPrioritySelectors.EMPTY);
    }
