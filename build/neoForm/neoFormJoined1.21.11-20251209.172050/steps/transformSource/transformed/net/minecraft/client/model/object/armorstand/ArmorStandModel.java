...
public class ArmorStandModel extends ArmorStandArmorModel {
    ...
    public ArmorStandModel(ModelPart p_480796_) {
        super(p_480796_);
        this.rightBodyStick = p_480796_.getChild("right_body_stick");
        this.leftBodyStick = p_480796_.getChild("left_body_stick");
        this.shoulderStick = p_480796_.getChild("shoulder_stick");
        this.basePlate = p_480796_.getChild("base_plate");
    ...
    @Override
    public void setupAnim(ArmorStandRenderState p_477960_) {
        super.setupAnim(p_477960_);
        this.basePlate.yRot = (float) (Math.PI / 180.0) * -p_477960_.yRot;
        this.leftArm.visible = p_477960_.showArms;
        this.rightArm.visible = p_477960_.showArms;
        this.basePlate.visible = p_477960_.showBasePlate;
        this.rightBodyStick.xRot = (float) (Math.PI / 180.0) * p_477960_.bodyPose.x();
        this.rightBodyStick.yRot = (float) (Math.PI / 180.0) * p_477960_.bodyPose.y();
        this.rightBodyStick.zRot = (float) (Math.PI / 180.0) * p_477960_.bodyPose.z();
        this.leftBodyStick.xRot = (float) (Math.PI / 180.0) * p_477960_.bodyPose.x();
        this.leftBodyStick.yRot = (float) (Math.PI / 180.0) * p_477960_.bodyPose.y();
        this.leftBodyStick.zRot = (float) (Math.PI / 180.0) * p_477960_.bodyPose.z();
        this.shoulderStick.xRot = (float) (Math.PI / 180.0) * p_477960_.bodyPose.x();
        this.shoulderStick.yRot = (float) (Math.PI / 180.0) * p_477960_.bodyPose.y();
        this.shoulderStick.zRot = (float) (Math.PI / 180.0) * p_477960_.bodyPose.z();
    }

    public void translateToHand(ArmorStandRenderState p_479453_, HumanoidArm p_481310_, PoseStack p_479170_) {
        ModelPart modelpart = this.getArm(p_481310_);
        boolean flag = modelpart.visible;
        modelpart.visible = true;
        super.translateToHand(p_479453_, p_481310_, p_479170_);
