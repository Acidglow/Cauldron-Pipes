...
public class HappyGhastRenderer extends AgeableMobRenderer<HappyGhast, HappyGhastRenderState, HappyGhastModel> {
    ...
    public Identifier getTextureLocation(HappyGhastRenderState p_415985_) {
    ...
    protected AABB getBoundingBoxForCulling(HappyGhast p_478579_) {
        AABB aabb = super.getBoundingBoxForCulling(p_478579_);
        float f = p_478579_.getBbHeight();
        return aabb.setMinY(aabb.minY - f / 2.0F);
    }

    public void extractRenderState(HappyGhast p_479700_, HappyGhastRenderState p_415588_, float p_415709_) {
        super.extractRenderState(p_479700_, p_415588_, p_415709_);
        p_415588_.bodyItem = p_479700_.getItemBySlot(EquipmentSlot.BODY).copy();
        p_415588_.isRidden = p_479700_.isVehicle();
        p_415588_.isLeashHolder = p_479700_.isLeashHolder();
    }
}
