...
public class TropicalFishLargeModel extends EntityModel<TropicalFishRenderState> {
    ...
    public TropicalFishLargeModel(ModelPart p_479122_) {
        super(p_479122_);
        this.tail = p_479122_.getChild("tail");
    }
    ...
    public void setupAnim(TropicalFishRenderState p_479862_) {
        super.setupAnim(p_479862_);
        float f = p_479862_.isInWater ? 1.0F : 1.5F;
        this.tail.yRot = -f * 0.45F * Mth.sin(0.6F * p_479862_.ageInTicks);
    }
}
