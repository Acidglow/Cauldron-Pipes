...
public class EntityDataSerializers {
    ...
    private static final StreamCodec<ByteBuf, OptionalInt> OPTIONAL_UNSIGNED_INT_CODEC = new StreamCodec<ByteBuf, OptionalInt>() {
        public OptionalInt decode(ByteBuf p_445816_) {
            int i = VarInt.read(p_445816_);
            return i == 0 ? OptionalInt.empty() : OptionalInt.of(i - 1);
        }

        public void encode(ByteBuf p_446459_, OptionalInt p_445651_) {
            VarInt.write(p_446459_, p_445651_.orElse(-1) + 1);
        }
    };
