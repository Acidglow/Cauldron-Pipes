...
public class ReportReasonSelectionScreen extends Screen {
    ...
    public ReportReasonSelectionScreen(@Nullable Screen lastScreen, @Nullable ReportReason currentlySelectedReason, ReportType reportType, Consumer<ReportReason> onSelectedReason) {
        super(REASON_TITLE);
    ...
    public class ReasonSelectionList extends ObjectSelectionList<ReportReasonSelectionScreen.ReasonSelectionList.Entry> {
        ...
        public class Entry extends ObjectSelectionList.Entry<ReportReasonSelectionScreen.ReasonSelectionList.Entry> {
            ...
            @Override
            public void renderContent(GuiGraphics p_439346_, int p_440497_, int p_439746_, boolean p_439154_, float p_439726_) {
                int i = this.getContentX() + 1;
                int j = this.getContentY() + (this.getContentHeight() - 9) / 2 + 1;
                p_439346_.drawString(ReportReasonSelectionScreen.this.font, this.reason.title(), i, j, -1);
            }
            ...
            @Override
            public boolean mouseClicked(MouseButtonEvent p_446785_, boolean p_435027_) {
                ReasonSelectionList.this.setSelected(this);
                return super.mouseClicked(p_446785_, p_435027_);
            }
