...
public class SheepModel extends QuadrupedModel<SheepRenderState> {
    ...
    public SheepModel(ModelPart p_481117_) {
        super(p_481117_);
    }
    ...
    public void setupAnim(SheepRenderState p_480098_) {
        super.setupAnim(p_480098_);
        this.head.y = this.head.y + p_480098_.headEatPositionScale * 9.0F * p_480098_.ageScale;
        this.head.xRot = p_480098_.headEatAngleScale;
    }
}
