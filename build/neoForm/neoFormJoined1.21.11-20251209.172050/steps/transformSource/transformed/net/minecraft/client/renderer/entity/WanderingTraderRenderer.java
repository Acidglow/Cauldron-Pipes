...
public class WanderingTraderRenderer extends MobRenderer<WanderingTrader, VillagerRenderState, VillagerModel> {
    ...
    public Identifier getTextureLocation(VillagerRenderState p_467205_) {
    ...
    public void extractRenderState(WanderingTrader p_480708_, VillagerRenderState p_362242_, float p_364692_) {
        super.extractRenderState(p_480708_, p_362242_, p_364692_);
        HoldingEntityRenderState.extractHoldingEntityRenderState(p_480708_, p_362242_, this.itemModelResolver);
        p_362242_.isUnhappy = p_480708_.getUnhappyCounter() > 0;
    }
}
