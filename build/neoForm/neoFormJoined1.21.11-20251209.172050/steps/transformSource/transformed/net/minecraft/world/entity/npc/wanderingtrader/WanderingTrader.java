...
public class WanderingTrader extends AbstractVillager implements Consumable.OverrideConsumeSound {
    ...
    public WanderingTrader(EntityType<? extends WanderingTrader> p_479796_, Level p_480997_) {
        super(p_479796_, p_480997_);
    }
        ...
        this.goalSelector
            .addGoal(
                ...
                new UseItemGoal<>(
                    ...
                    p_481587_ -> this.level().isDarkOutside() && !p_481587_.isInvisible()
                )
            );
        this.goalSelector
            .addGoal(
                ...
                new UseItemGoal<>(
                    ...
                    p_479356_ -> this.level().isBrightOutside() && p_479356_.isInvisible()
                )
            );
    ...
    @Override
    public @Nullable AgeableMob getBreedOffspring(ServerLevel p_479496_, AgeableMob p_480521_) {
        return null;
    }
    ...
    @Override
    protected void updateTrades(ServerLevel p_480141_) {
        ...
        for (Pair<VillagerTrades.ItemListing[], Integer> pair : VillagerTrades.WANDERING_TRADER_TRADES) {
            ...
            this.addOffersFromItemListings(p_480141_, merchantoffers, avillagertrades$itemlisting, pair.getRight());
        }
    }

    @Override
    protected void addAdditionalSaveData(ValueOutput p_481692_) {
        super.addAdditionalSaveData(p_481692_);
        p_481692_.putInt("DespawnDelay", this.despawnDelay);
        p_481692_.storeNullable("wander_target", BlockPos.CODEC, this.wanderTarget);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_481279_) {
        super.readAdditionalSaveData(p_481279_);
        this.despawnDelay = p_481279_.getIntOr("DespawnDelay", 0);
        this.wanderTarget = p_481279_.read("wander_target", BlockPos.CODEC).orElse(null);
    ...
    @Override
    public SoundEvent getConsumeSound(ItemStack p_478262_) {
        return p_478262_.is(Items.MILK_BUCKET) ? SoundEvents.WANDERING_TRADER_DRINK_MILK : SoundEvents.WANDERING_TRADER_DRINK_POTION;
    }
