...
public record SavedDataType<T extends SavedData>(String id, Factory<T> factory, Factory<Codec<T>> codecFactory, @org.jspecify.annotations.Nullable DataFixTypes dataFixType) {
    public SavedDataType(String id, Supplier<T> constructor, Codec<T> codec, @org.jspecify.annotations.Nullable DataFixTypes dataFixType) {
    ...
    public SavedDataType(String id, Factory<T> constructor, Factory<Codec<T>> codec) {
