...
public class WitherBossModel extends EntityModel<WitherRenderState> {
    ...
    public WitherBossModel(ModelPart p_478200_) {
        super(p_478200_);
        this.ribcage = p_478200_.getChild("ribcage");
        this.tail = p_478200_.getChild("tail");
        this.centerHead = p_478200_.getChild("center_head");
        this.rightHead = p_478200_.getChild("right_head");
        this.leftHead = p_478200_.getChild("left_head");
    }
    ...
    public void setupAnim(WitherRenderState p_477932_) {
        super.setupAnim(p_477932_);
        setupHeadRotation(p_477932_, this.rightHead, 0);
        setupHeadRotation(p_477932_, this.leftHead, 1);
        float f = Mth.cos(p_477932_.ageInTicks * 0.1F);
        ...
        this.centerHead.yRot = p_477932_.yRot * (float) (Math.PI / 180.0);
        this.centerHead.xRot = p_477932_.xRot * (float) (Math.PI / 180.0);
    }
