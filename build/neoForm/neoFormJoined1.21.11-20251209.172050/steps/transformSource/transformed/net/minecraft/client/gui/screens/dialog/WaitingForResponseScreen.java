...
public class WaitingForResponseScreen extends Screen {
    ...
    public WaitingForResponseScreen(@Nullable Screen previousScreen) {
        ...
        this.closeButton = Button.builder(CommonComponents.GUI_BACK, p_428471_ -> this.onClose()).width(200).build();
    }
    ...
    protected void init() {
        ...
        this.layout.visitWidgets(p_428218_ -> {
            AbstractWidget abstractwidget = this.addRenderableWidget(p_428218_);
        });
