...
public interface LevelBasedValue {
    ...
    public record Exponent(LevelBasedValue base, LevelBasedValue power) implements LevelBasedValue {
        public static final MapCodec<LevelBasedValue.Exponent> CODEC = RecordCodecBuilder.mapCodec(
            p_455291_ -> p_455291_.group(
                ...
                .apply(p_455291_, LevelBasedValue.Exponent::new)
        );

        @Override
        public float calculate(int p_454966_) {
            return (float)Math.pow(this.base.calculate(p_454966_), this.power.calculate(p_454966_));
        }
    ...
    public record LevelsSquared(float added) implements LevelBasedValue {
        ...
        public float calculate(int p_344759_) {
            return Mth.square(p_344759_) + this.added;
        }
    ...
    public record Linear(float base, float perLevelAboveFirst) implements LevelBasedValue {
        ...
        public float calculate(int p_345943_) {
            return this.base + this.perLevelAboveFirst * (p_345943_ - 1);
        }
