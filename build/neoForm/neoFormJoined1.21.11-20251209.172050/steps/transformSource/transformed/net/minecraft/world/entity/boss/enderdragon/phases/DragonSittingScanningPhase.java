...
public class DragonSittingScanningPhase extends AbstractDragonSittingPhase {
    ...
    public DragonSittingScanningPhase(EnderDragon p_31342_) {
        ...
        this.scanTargeting = TargetingConditions.forCombat()
            .range(20.0)
            .selector((p_427095_, p_427096_) -> Math.abs(p_427095_.getY() - p_31342_.getY()) <= 10.0);
    }

    @Override
    public void doServerTick(ServerLevel p_376286_) {
        this.scanningTime++;
        LivingEntity livingentity = p_376286_.getNearestPlayer(this.scanTargeting, this.dragon, this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());
        if (livingentity != null) {
            ...
            livingentity = p_376286_.getNearestPlayer(CHARGE_TARGETING, this.dragon, this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());
