    ...
    private JsonElement serializePackets() {
        ...
        Stream.of(
            ...
            .forEach((p_352310_, p_352325_) -> {
                ...
                p_352325_.forEach(p_412023_ -> {
                    JsonObject jsonobject2 = new JsonObject();
                    jsonobject1.add(p_412023_.flow().id(), jsonobject2);
                    p_412023_.listPackets((p_466002_, p_466003_) -> {
                        JsonObject jsonobject3 = new JsonObject();
                        jsonobject3.addProperty("protocol_id", p_466003_);
                        jsonobject2.add(p_466002_.id().toString(), jsonobject3);
                    });
                });
            });
        return jsonobject;
