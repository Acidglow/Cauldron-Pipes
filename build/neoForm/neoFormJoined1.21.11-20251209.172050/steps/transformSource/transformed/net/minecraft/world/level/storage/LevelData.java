...
public interface LevelData {
    ...
    default void fillCrashReportCategory(CrashReportCategory crashReportCategory, LevelHeightAccessor level) {
        crashReportCategory.setDetail("Level spawn location", () -> CrashReportCategory.formatLocation(level, this.getRespawnData().pos()));
    ...
    public record RespawnData(GlobalPos globalPos, float yaw, float pitch) {
        ...
        public static final MapCodec<LevelData.RespawnData> MAP_CODEC = RecordCodecBuilder.mapCodec(
            p_451090_ -> p_451090_.group(
                ...
                .apply(p_451090_, LevelData.RespawnData::new)
        );
