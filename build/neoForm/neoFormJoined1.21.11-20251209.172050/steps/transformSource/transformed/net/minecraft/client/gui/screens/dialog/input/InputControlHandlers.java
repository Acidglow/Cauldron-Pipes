...
public class InputControlHandlers {
    ...
    private static <T extends InputControl> @Nullable InputControlHandler<T> get(T p_426260_) {
    ...
    static class SingleOptionHandler implements InputControlHandler<SingleOptionInput> {
        public void addControl(SingleOptionInput p_425545_, Screen p_425696_, InputControlHandler.Output p_426241_) {
            SingleOptionInput.Entry singleoptioninput$entry = p_425545_.initial().orElse(p_425545_.entries().getFirst());
            CycleButton.Builder<SingleOptionInput.Entry> builder = CycleButton.builder(SingleOptionInput.Entry::displayOrDefault, singleoptioninput$entry)
                ...
                .displayState(!p_425545_.labelVisible() ? CycleButton.DisplayState.VALUE : CycleButton.DisplayState.NAME_AND_VALUE);
