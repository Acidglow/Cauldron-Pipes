...
public class Camel extends AbstractHorse {
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_421932_) {
        super.addAdditionalSaveData(p_421932_);
        p_421932_.putLong("LastPoseTick", this.entityData.get(LAST_POSE_CHANGE_TICK));
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_422249_) {
        super.readAdditionalSaveData(p_422249_);
        long i = p_422249_.getLongOr("LastPoseTick", 0L);
        if (i < 0L) {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_249190_, DifficultyInstance p_251264_, EntitySpawnReason p_364651_, @Nullable SpawnGroupData p_249259_
    ) {
        CamelAi.initMemories(this, p_249190_.getRandom());
        this.resetLastPoseChangeTickToFullStand(p_249190_.getLevel().getGameTime());
        return super.finalizeSpawn(p_249190_, p_251264_, p_364651_, p_249259_);
    }
    ...
    @Override
    protected void customServerAiStep(ServerLevel p_376616_) {
        ProfilerFiller profilerfiller = Profiler.get();
        profilerfiller.push("camelBrain");
        Brain<?> brain = this.getBrain();
        ((Brain<Camel>)brain).tick(p_376616_, this);
        profilerfiller.pop();
        profilerfiller.push("camelActivityUpdate");
        CamelAi.updateActivity(this);
        profilerfiller.pop();
        super.customServerAiStep(p_376616_);
    }
    ...
    @Override
    protected void actuallyHurt(ServerLevel p_376291_, DamageSource p_250410_, float p_251451_) {
        this.standUpInstantly();
        super.actuallyHurt(p_376291_, p_250410_, p_251451_);
    }
    ...
    protected Vec3 getPassengerAttachmentPoint(Entity p_295101_, EntityDimensions p_294765_, float p_294716_) {
        ...
        return new Vec3(0.0, f1, f * p_294716_).yRot(-this.getYRot() * (float) (Math.PI / 180.0));
    }
    ...
    private double getBodyAnchorAnimationYOffset(boolean firstPassenger, float partialTick, EntityDimensions dimensions, float scale) {
        double d0 = dimensions.height() - 0.375F * scale;
        float f = scale * 1.43F;
    ...
    @Override
    protected Holder<SoundEvent> getEquipSound(EquipmentSlot p_397855_, ItemStack p_397494_, Equippable p_397094_) {
        return (Holder<SoundEvent>)(p_397855_ == EquipmentSlot.SADDLE ? this.getSaddleSound() : super.getEquipSound(p_397855_, p_397494_, p_397094_));
    }
