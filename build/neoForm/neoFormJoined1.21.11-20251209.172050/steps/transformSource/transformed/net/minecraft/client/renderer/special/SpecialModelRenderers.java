...
public class SpecialModelRenderers {
    ...
    public static final Codec<SpecialModelRenderer.Unbaked> CODEC = ID_MAPPER.codec(Identifier.CODEC)
        .dispatch(SpecialModelRenderer.Unbaked::type, p_388167_ -> p_388167_);
    ...
    public static Map<Block, SpecialModelRenderer<?>> createBlockRenderers(SpecialModelRenderer.BakingContext context) {
        ...
        map.forEach((p_432308_, p_432309_) -> {
            SpecialModelRenderer<?> specialmodelrenderer = p_432309_.bake(context);
            if (specialmodelrenderer != null) {
                builder.put(p_432308_, specialmodelrenderer);
            }
        });
