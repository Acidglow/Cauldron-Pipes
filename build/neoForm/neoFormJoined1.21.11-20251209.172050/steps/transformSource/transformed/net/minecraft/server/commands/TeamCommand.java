                            ...
                            Commands.argument("team", StringArgumentType.word())
                                ...
                                .then(
                                    Commands.argument("displayName", ComponentArgument.textComponent(context))
                                        .executes(
                                            p_400895_ -> createTeam(
                                                p_400895_.getSource(),
                                                StringArgumentType.getString(p_400895_, "team"),
                                                ComponentArgument.getResolvedComponent(p_400895_, "displayName")
                                            )
                                        )
                                )
                        )
                                ...
                                .then(
                                    Commands.literal("displayName")
                                        .then(
                                            Commands.argument("displayName", ComponentArgument.textComponent(context))
                                                .executes(
                                                    p_400896_ -> setDisplayName(
                                                        p_400896_.getSource(),
                                                        TeamArgument.getTeam(p_400896_, "team"),
                                                        ComponentArgument.getResolvedComponent(p_400896_, "displayName")
                                                    )
                                                )
                                        )
                                )
                                        ...
                                        .then(
                                            Commands.argument("prefix", ComponentArgument.textComponent(context))
                                                .executes(
                                                    p_400894_ -> setPrefix(
                                                        p_400894_.getSource(),
                                                        TeamArgument.getTeam(p_400894_, "team"),
                                                        ComponentArgument.getResolvedComponent(p_400894_, "prefix")
                                                    )
                                                )
                                        )
                                )
                                        ...
                                        .then(
                                            Commands.argument("suffix", ComponentArgument.textComponent(context))
                                                .executes(
                                                    p_400893_ -> setSuffix(
                                                        p_400893_.getSource(),
                                                        TeamArgument.getTeam(p_400893_, "team"),
                                                        ComponentArgument.getResolvedComponent(p_400893_, "suffix")
                                                    )
                                                )
                                        )
                                )
