...
public class ChickenModel extends EntityModel<ChickenRenderState> {
    ...
    public ChickenModel(ModelPart p_482129_) {
        super(p_482129_);
        this.head = p_482129_.getChild("head");
        this.rightLeg = p_482129_.getChild("right_leg");
        this.leftLeg = p_482129_.getChild("left_leg");
        this.rightWing = p_482129_.getChild("right_wing");
        this.leftWing = p_482129_.getChild("left_wing");
    }
    ...
    public void setupAnim(ChickenRenderState p_482134_) {
        super.setupAnim(p_482134_);
        float f = (Mth.sin(p_482134_.flap) + 1.0F) * p_482134_.flapSpeed;
        this.head.xRot = p_482134_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_482134_.yRot * (float) (Math.PI / 180.0);
