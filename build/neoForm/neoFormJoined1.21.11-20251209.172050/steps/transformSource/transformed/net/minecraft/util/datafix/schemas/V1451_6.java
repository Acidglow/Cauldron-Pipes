        ...
        public <T> T apply(DynamicOps<T> ops, T value) {
            ...
            return DataFixUtils.orElse(
                    dynamic.get("CriteriaName")
                        ...
                        .result()
                        .map(p_466495_ -> {
                            int i = p_466495_.indexOf(58);
                            if (i < 0) {
                                return Pair.of("_special", p_466495_);
                            } else {
                                try {
                                    Identifier identifier = Identifier.bySeparator(p_466495_.substring(0, i), '.');
                                    Identifier identifier1 = Identifier.bySeparator(p_466495_.substring(i + 1), '.');
