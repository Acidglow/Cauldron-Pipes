...
public class ItemSpawnEggFix extends DataFix {
    private static final @Nullable String[] ID_TO_ENTITY = DataFixUtils.make(new String[256], p_341874_ -> {
        p_341874_[1] = "Item";
        p_341874_[2] = "XPOrb";
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            type,
            p_404248_ -> {
                Optional<Pair<String, String>> optional = p_404248_.getOptional(opticfinder);
                if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:spawn_egg")) {
                    Dynamic<?> dynamic = p_404248_.get(DSL.remainderFinder());
                    short short1 = dynamic.get("Damage").asShort((short)0);
                    Optional<? extends Typed<?>> optional1 = p_404248_.getOptionalTyped(opticfinder2);
                    ...
                    Typed<?> typed = p_404248_;
                    String s = ID_TO_ENTITY[short1 & 255];
                    if (s != null && (optional4.isEmpty() || !Objects.equals(optional4.get(), s))) {
                        Typed<?> typed1 = p_404248_.getOrCreateTyped(opticfinder2);
                        Dynamic<?> dynamic1 = DataFixUtils.orElse(
                            typed1.getOptionalTyped(opticfinder3).map(p_404249_ -> p_404249_.write().getOrThrow()), dynamic.emptyMap()
                        );
                        dynamic1 = dynamic1.set("id", dynamic1.createString(s));
                        typed = p_404248_.set(opticfinder2, ExtraDataFixUtils.readAndSet(typed1, opticfinder3, dynamic1));
                    }
