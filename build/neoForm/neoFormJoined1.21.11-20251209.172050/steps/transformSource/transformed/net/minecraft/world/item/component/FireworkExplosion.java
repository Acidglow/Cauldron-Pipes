...
public record FireworkExplosion(FireworkExplosion.Shape shape, IntList colors, IntList fadeColors, boolean hasTrail, boolean hasTwinkle)
    ...
    @Override
    public void addToTooltip(Item.TooltipContext p_341341_, Consumer<Component> p_331404_, TooltipFlag p_330365_, DataComponentGetter p_399966_) {
        p_331404_.accept(this.shape.getName().withStyle(ChatFormatting.GRAY));
