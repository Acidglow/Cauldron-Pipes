...
public class SnbtGrammar {
    ...
    static enum ArrayPrefix {
        BYTE(SnbtGrammar.TypeSuffix.BYTE) {
            ...
            @Override
            public <T> @Nullable T create(DynamicOps<T> p_410319_, List<SnbtGrammar.IntegerLiteral> p_410656_, ParseState<?> p_410578_) {
        ...
        INT(SnbtGrammar.TypeSuffix.INT, SnbtGrammar.TypeSuffix.BYTE, SnbtGrammar.TypeSuffix.SHORT) {
            ...
            @Override
            public <T> @Nullable T create(DynamicOps<T> p_409890_, List<SnbtGrammar.IntegerLiteral> p_410031_, ParseState<?> p_409844_) {
        ...
        LONG(SnbtGrammar.TypeSuffix.LONG, SnbtGrammar.TypeSuffix.BYTE, SnbtGrammar.TypeSuffix.SHORT, SnbtGrammar.TypeSuffix.INT) {
            ...
            @Override
            public <T> @Nullable T create(DynamicOps<T> p_410327_, List<SnbtGrammar.IntegerLiteral> p_409793_, ParseState<?> p_410839_) {
