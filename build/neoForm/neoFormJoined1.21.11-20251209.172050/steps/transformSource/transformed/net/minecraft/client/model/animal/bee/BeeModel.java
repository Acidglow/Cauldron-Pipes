...
public class BeeModel extends EntityModel<BeeRenderState> {
    ...
    public BeeModel(ModelPart p_481815_) {
        super(p_481815_);
        this.bone = p_481815_.getChild("bone");
    ...
    public void setupAnim(BeeRenderState p_482040_) {
        super.setupAnim(p_482040_);
        this.rollAmount = p_482040_.rollAmount;
        this.stinger.visible = p_482040_.hasStinger;
        if (!p_482040_.isOnGround) {
            float f = p_482040_.ageInTicks * 120.32113F * (float) (Math.PI / 180.0);
        ...
        if (!p_482040_.isAngry && !p_482040_.isOnGround) {
            float f1 = Mth.cos(p_482040_.ageInTicks * 0.18F);
            ...
            this.bone.y = this.bone.y - Mth.cos(p_482040_.ageInTicks * 0.18F) * 0.9F;
        }
