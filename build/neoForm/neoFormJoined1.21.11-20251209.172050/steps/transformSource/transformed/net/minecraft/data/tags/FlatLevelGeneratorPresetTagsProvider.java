 ...
 *             PackOutput, CompletableFuture, String) mod id variant}
 */
    @Deprecated
    ...
    public FlatLevelGeneratorPresetTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, String modId) {
        super(output, Registries.FLAT_LEVEL_GENERATOR_PRESET, provider, modId);
    }
