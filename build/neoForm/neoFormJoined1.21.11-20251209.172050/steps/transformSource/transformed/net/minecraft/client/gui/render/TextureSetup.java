...
public record TextureSetup(
    ...
    public static TextureSetup doubleTexture(GpuTextureView texture1, GpuSampler sampler1, GpuTextureView texture2, GpuSampler sampler2) {
        return new TextureSetup(texture1, texture2, null, sampler1, sampler2, null);
    }
