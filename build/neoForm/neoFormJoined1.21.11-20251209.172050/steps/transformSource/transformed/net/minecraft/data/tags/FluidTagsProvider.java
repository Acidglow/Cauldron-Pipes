 ...
 */
    ...
    public FluidTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, String modId) {
        super(output, Registries.FLUID, provider, p_256474_ -> p_256474_.builtInRegistryHolder().key(), modId);
    }
