...
public class SkullModel extends SkullModelBase {
    ...
    public SkullModel(ModelPart p_480099_) {
        super(p_480099_);
        this.head = p_480099_.getChild("head");
    }
    ...
    public void setupAnim(SkullModelBase.State p_478387_) {
        super.setupAnim(p_478387_);
        this.head.yRot = p_478387_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_478387_.xRot * (float) (Math.PI / 180.0);
    }
}
