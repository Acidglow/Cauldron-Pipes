...
public class JsonRpcApiSchema implements DataProvider {
    ...
    @Override
    public CompletableFuture<?> run(CachedOutput p_442837_) {
        ...
        return DataProvider.saveStable(
            p_442837_, DiscoveryService.DiscoverResponse.CODEC.codec().encodeStart(JsonOps.INSTANCE, discoveryservice$discoverresponse).getOrThrow(), this.path
        );
    }
