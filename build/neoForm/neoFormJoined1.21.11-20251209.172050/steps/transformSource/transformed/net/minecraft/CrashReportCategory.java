...
public class CrashReportCategory {
    ...
    public static String formatLocation(LevelHeightAccessor levelHeightAccessor, double x, double y, double z) {
        return String.format(
            ...
            y,
            z,
            formatLocation(levelHeightAccessor, BlockPos.containing(x, y, z))
        );
    }
    ...
    public static String formatLocation(LevelHeightAccessor levelHeightAccessor, int x, int y, int z) {
        ...
        try {
            ...
            int j4 = (j3 + 1 << 5) - 1;
            int k4 = i3 << 9;
            int l4 = levelHeightAccessor.getMinY();
            int i5 = j3 << 9;
            int j5 = (i3 + 1 << 9) - 1;
            int k5 = levelHeightAccessor.getMaxY();
            int l5 = (j3 + 1 << 9) - 1;
            stringbuilder.append(
                String.format(
