...
public class SnifferModel extends EntityModel<SnifferRenderState> {
    ...
    public SnifferModel(ModelPart p_478667_) {
        super(p_478667_);
        this.head = p_478667_.getChild("bone").getChild("body").getChild("head");
        this.sniffSearchAnimation = SnifferAnimation.SNIFFER_SNIFF_SEARCH.bake(p_478667_);
        this.walkAnimation = SnifferAnimation.SNIFFER_WALK.bake(p_478667_);
        this.digAnimation = SnifferAnimation.SNIFFER_DIG.bake(p_478667_);
        this.longSniffAnimation = SnifferAnimation.SNIFFER_LONGSNIFF.bake(p_478667_);
        this.standUpAnimation = SnifferAnimation.SNIFFER_STAND_UP.bake(p_478667_);
        this.happyAnimation = SnifferAnimation.SNIFFER_HAPPY.bake(p_478667_);
        this.sniffSniffAnimation = SnifferAnimation.SNIFFER_SNIFFSNIFF.bake(p_478667_);
        this.babyTransform = SnifferAnimation.BABY_TRANSFORM.bake(p_478667_);
    }
    ...
    public void setupAnim(SnifferRenderState p_479910_) {
        super.setupAnim(p_479910_);
        this.head.xRot = p_479910_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_479910_.yRot * (float) (Math.PI / 180.0);
        if (p_479910_.isSearching) {
            this.sniffSearchAnimation.applyWalk(p_479910_.walkAnimationPos, p_479910_.walkAnimationSpeed, 9.0F, 100.0F);
        } else {
            this.walkAnimation.applyWalk(p_479910_.walkAnimationPos, p_479910_.walkAnimationSpeed, 9.0F, 100.0F);
        }

        this.digAnimation.apply(p_479910_.diggingAnimationState, p_479910_.ageInTicks);
        this.longSniffAnimation.apply(p_479910_.sniffingAnimationState, p_479910_.ageInTicks);
        this.standUpAnimation.apply(p_479910_.risingAnimationState, p_479910_.ageInTicks);
        this.happyAnimation.apply(p_479910_.feelingHappyAnimationState, p_479910_.ageInTicks);
        this.sniffSniffAnimation.apply(p_479910_.scentingAnimationState, p_479910_.ageInTicks);
        if (p_479910_.isBaby) {
