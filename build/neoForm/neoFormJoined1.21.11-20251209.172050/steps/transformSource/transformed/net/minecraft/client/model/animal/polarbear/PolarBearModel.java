...
public class PolarBearModel extends QuadrupedModel<PolarBearRenderState> {
    ...
    public PolarBearModel(ModelPart p_479050_) {
        super(p_479050_);
    }
    ...
    public static LayerDefinition createBodyLayer(boolean baby) {
        ...
        return LayerDefinition.create(meshdefinition, 128, 64)
            .apply(baby ? BABY_TRANSFORMER : MeshTransformer.IDENTITY)
            .apply(MeshTransformer.scaling(1.2F));
    }

    public void setupAnim(PolarBearRenderState p_478403_) {
        super.setupAnim(p_478403_);
        float f = p_478403_.standScale * p_478403_.standScale;
        float f1 = p_478403_.ageScale;
        float f2 = p_478403_.isBaby ? 0.44444445F : 1.0F;
