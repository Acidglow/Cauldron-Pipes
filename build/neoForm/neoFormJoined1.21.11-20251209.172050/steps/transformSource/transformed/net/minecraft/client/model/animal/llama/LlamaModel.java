...
public class LlamaModel extends EntityModel<LlamaRenderState> {
    ...
    public LlamaModel(ModelPart p_478344_) {
        super(p_478344_);
        this.head = p_478344_.getChild("head");
        this.rightChest = p_478344_.getChild("right_chest");
        this.leftChest = p_478344_.getChild("left_chest");
        this.rightHindLeg = p_478344_.getChild("right_hind_leg");
        this.leftHindLeg = p_478344_.getChild("left_hind_leg");
        this.rightFrontLeg = p_478344_.getChild("right_front_leg");
        this.leftFrontLeg = p_478344_.getChild("left_front_leg");
    }
    ...
    private static MeshDefinition transformToBaby(MeshDefinition mesh) {
        ...
        float f1 = 0.7F;
        float f2 = 1.1F;
        UnaryOperator<PartPose> unaryoperator = p_479417_ -> p_479417_.translated(0.0F, 21.0F, 3.52F).scaled(0.71428573F, 0.64935064F, 0.7936508F);
        UnaryOperator<PartPose> unaryoperator1 = p_478140_ -> p_478140_.translated(0.0F, 33.0F, 0.0F).scaled(0.625F, 0.45454544F, 0.45454544F);
        UnaryOperator<PartPose> unaryoperator2 = p_481726_ -> p_481726_.translated(0.0F, 33.0F, 0.0F).scaled(0.45454544F, 0.41322312F, 0.45454544F);
        MeshDefinition meshdefinition = new MeshDefinition();
    ...
    public void setupAnim(LlamaRenderState p_479825_) {
        super.setupAnim(p_479825_);
        this.head.xRot = p_479825_.xRot * (float) (Math.PI / 180.0);
        this.head.yRot = p_479825_.yRot * (float) (Math.PI / 180.0);
        float f = p_479825_.walkAnimationSpeed;
        float f1 = p_479825_.walkAnimationPos;
        ...
        this.rightChest.visible = p_479825_.hasChest;
        this.leftChest.visible = p_479825_.hasChest;
    }
}
