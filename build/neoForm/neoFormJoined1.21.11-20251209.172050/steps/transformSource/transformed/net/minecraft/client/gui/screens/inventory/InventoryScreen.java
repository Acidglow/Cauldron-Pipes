...
public class InventoryScreen extends AbstractRecipeBookScreen<InventoryMenu> {
    ...
    public static void renderEntityInInventoryFollowsAngle(
        ...
        p_282802_.submitEntityRenderState(entityrenderstate, p_294663_, vector3f, quaternionf, quaternionf1, p_275688_, p_275245_, p_275535_, p_294406_);
    }
    ...
    @Override
    public boolean mouseReleased(MouseButtonEvent p_446466_) {
        if (this.buttonClicked) {
            this.buttonClicked = false;
            return true;
        } else {
            return super.mouseReleased(p_446466_);
        }
    }
}
