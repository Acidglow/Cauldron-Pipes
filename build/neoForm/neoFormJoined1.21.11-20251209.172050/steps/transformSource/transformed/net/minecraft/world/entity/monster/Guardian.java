...
public class Guardian extends Monster {
    ...
    public boolean hurtServer(ServerLevel p_376911_, DamageSource p_376689_, float p_376584_) {
        if (!this.isMoving()
            && !p_376689_.is(DamageTypeTags.AVOIDS_GUARDIAN_THORNS)
            && !p_376689_.is(DamageTypes.THORNS)
            && p_376689_.getDirectEntity() instanceof LivingEntity livingentity) {
            livingentity.hurtServer(p_376911_, this.damageSources().thorns(this), 2.0F);
        }
    ...
    @Override
    protected void travelInWater(Vec3 p_460874_, double p_460806_, boolean p_461044_, double p_461008_) {
        this.moveRelative(0.1F, p_460874_);
    ...
    static class GuardianAttackSelector implements TargetingConditions.Selector {
        ...
        @Override
        public boolean test(@Nullable LivingEntity p_32881_, ServerLevel p_376639_) {
