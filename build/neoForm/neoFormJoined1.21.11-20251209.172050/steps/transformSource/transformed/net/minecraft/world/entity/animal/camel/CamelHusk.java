...
public class CamelHusk extends Camel {
    public CamelHusk(EntityType<? extends Camel> p_460897_, Level p_461170_) {
        super(p_460897_, p_461170_);
    }

    @Override
    public boolean removeWhenFarAway(double p_461048_) {
        return true;
    }
    ...
    @Override
    public InteractionResult interact(Player p_468258_, InteractionHand p_469951_) {
        this.setPersistenceRequired();
        return super.interact(p_468258_, p_469951_);
    }
    ...
    @Override
    public boolean isFood(ItemStack p_461187_) {
        return p_461187_.is(ItemTags.CAMEL_HUSK_FOOD);
    }
    ...
    @Override
    public boolean canMate(Animal p_460995_) {
        return false;
    }

    @Override
    public @Nullable Camel getBreedOffspring(ServerLevel p_461155_, AgeableMob p_460790_) {
        return null;
    }
    ...
    @Override
    protected SoundEvent getHurtSound(DamageSource p_461114_) {
        return SoundEvents.CAMEL_HUSK_HURT;
    }

    @Override
    protected void playStepSound(BlockPos p_460969_, BlockState p_460649_) {
        if (p_460649_.is(BlockTags.CAMEL_SAND_STEP_SOUND_BLOCKS)) {
