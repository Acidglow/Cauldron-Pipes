...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationSystem {
    ...
    @Override
    public boolean hurtServer(ServerLevel p_376555_, DamageSource p_376455_, float p_376277_) {
        return this.isLikedPlayer(p_376455_.getEntity()) ? false : super.hurtServer(p_376555_, p_376455_, p_376277_);
    }
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_422258_) {
        super.addAdditionalSaveData(p_422258_);
        this.writeInventoryToTag(p_422258_);
        p_422258_.store("listener", VibrationSystem.Data.CODEC, this.vibrationData);
        p_422258_.putLong("DuplicationCooldown", this.duplicationCooldown);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_422340_) {
        super.readAdditionalSaveData(p_422340_);
        this.readInventoryFromTag(p_422340_);
        this.vibrationData = p_422340_.read("listener", VibrationSystem.Data.CODEC).orElseGet(VibrationSystem.Data::new);
        this.setDuplicationCooldown(p_422340_.getIntOr("DuplicationCooldown", 0));
    }
