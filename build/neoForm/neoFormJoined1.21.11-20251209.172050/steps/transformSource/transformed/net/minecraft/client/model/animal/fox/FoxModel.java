...
public class FoxModel extends EntityModel<FoxRenderState> {
    ...
    public FoxModel(ModelPart p_479985_) {
        super(p_479985_);
        this.head = p_479985_.getChild("head");
        this.body = p_479985_.getChild("body");
        this.rightHindLeg = p_479985_.getChild("right_hind_leg");
        this.leftHindLeg = p_479985_.getChild("left_hind_leg");
        this.rightFrontLeg = p_479985_.getChild("right_front_leg");
        this.leftFrontLeg = p_479985_.getChild("left_front_leg");
    ...
    public void setupAnim(FoxRenderState p_480998_) {
        super.setupAnim(p_480998_);
        float f = p_480998_.walkAnimationSpeed;
        float f1 = p_480998_.walkAnimationPos;
        ...
        this.head.zRot = p_480998_.headRollAngle;
        this.rightHindLeg.visible = true;
        this.leftHindLeg.visible = true;
        this.rightFrontLeg.visible = true;
        this.leftFrontLeg.visible = true;
        float f2 = p_480998_.ageScale;
        if (p_480998_.isCrouching) {
            this.body.xRot += 0.10471976F;
            float f3 = p_480998_.crouchAmount;
            this.body.y += f3 * f2;
            this.head.y += f3 * f2;
        } else if (p_480998_.isSleeping) {
        ...
        if (!p_480998_.isSleeping && !p_480998_.isFaceplanted && !p_480998_.isCrouching) {
            this.head.xRot = p_480998_.xRot * (float) (Math.PI / 180.0);
            this.head.yRot = p_480998_.yRot * (float) (Math.PI / 180.0);
        }

        if (p_480998_.isSleeping) {
            this.head.xRot = 0.0F;
            this.head.yRot = (float) (-Math.PI * 2.0 / 3.0);
            this.head.zRot = Mth.cos(p_480998_.ageInTicks * 0.027F) / 22.0F;
        }

        if (p_480998_.isCrouching) {
            float f4 = Mth.cos(p_480998_.ageInTicks) * 0.01F;
            this.body.yRot = f4;
