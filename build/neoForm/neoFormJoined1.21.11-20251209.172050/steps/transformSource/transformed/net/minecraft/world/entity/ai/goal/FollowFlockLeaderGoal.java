...
public class FollowFlockLeaderGoal extends Goal {
    ...
    public boolean canUse() {
        if (this.mob.hasFollowers()) {
            ...
            Predicate<AbstractSchoolingFish> predicate = p_477876_ -> p_477876_.canBeFollowed() || !p_477876_.isFollower();
            ...
            abstractschoolingfish.addFollowers(list.stream().filter(p_477877_ -> !p_477877_.isFollower()));
