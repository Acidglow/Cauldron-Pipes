...
public class SimpleGizmoCollector implements GizmoCollector {
    ...
    @Override
    public GizmoProperties add(Gizmo p_455612_) {
        SimpleGizmoCollector.GizmoInstance simplegizmocollector$gizmoinstance = new SimpleGizmoCollector.GizmoInstance(p_455612_);
    ...
    public List<SimpleGizmoCollector.GizmoInstance> drainGizmos() {
        ...
        this.gizmos.removeIf(p_457573_ -> p_457573_.getExpireTimeMillis() < i);
    ...
    public static class GizmoInstance implements GizmoProperties {
        ...
        @Override
        public GizmoProperties persistForMillis(int p_457879_) {
            this.startTimeMillis = Util.getMillis();
            this.expireTimeMillis = this.startTimeMillis + p_457879_;
            return this;
        }
        ...
        public float getAlphaMultiplier(long currentTime) {
            if (this.shouldFadeOut) {
                long i = this.expireTimeMillis - this.startTimeMillis;
                long j = currentTime - this.startTimeMillis;
