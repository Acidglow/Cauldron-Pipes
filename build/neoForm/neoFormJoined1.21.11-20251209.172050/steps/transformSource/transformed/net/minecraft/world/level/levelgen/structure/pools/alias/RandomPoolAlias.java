...
public record RandomPoolAlias(ResourceKey<StructureTemplatePool> alias, WeightedList<ResourceKey<StructureTemplatePool>> targets) implements PoolAliasBinding {
    static MapCodec<RandomPoolAlias> CODEC = RecordCodecBuilder.mapCodec(
        p_405620_ -> p_405620_.group(
            ...
            .apply(p_405620_, RandomPoolAlias::new)
    );

    @Override
    public void forEachResolved(RandomSource p_405862_, BiConsumer<ResourceKey<StructureTemplatePool>, ResourceKey<StructureTemplatePool>> p_404739_) {
        this.targets.getRandom(p_405862_).ifPresent(p_405391_ -> p_404739_.accept(this.alias, (ResourceKey<StructureTemplatePool>)p_405391_));
    }
