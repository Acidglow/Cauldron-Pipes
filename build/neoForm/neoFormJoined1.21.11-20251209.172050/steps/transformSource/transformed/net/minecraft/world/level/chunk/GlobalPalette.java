...
public class GlobalPalette<T> implements Palette<T> {
    ...
    @Override
    public int idFor(T p_62648_, PaletteResize<T> p_445739_) {
    ...
    @Override
    public void read(FriendlyByteBuf p_62654_, IdMap<T> p_447365_) {
    }

    @Override
    public void write(FriendlyByteBuf p_62656_, IdMap<T> p_445976_) {
    }

    @Override
    public int getSerializedSize(IdMap<T> p_445527_) {
        return 0;
    }
