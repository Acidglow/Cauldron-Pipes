...
public class FriendlyByteBuf extends ByteBuf implements net.neoforged.neoforge.common.extensions.IFriendlyByteBufExtension {
    ...
    public <L, R> void writeEither(
        ...
        either.ifLeft(p_415006_ -> {
            this.writeBoolean(true);
            leftWriter.encode(this, (L)p_415006_);
        }).ifRight(p_415004_ -> {
            this.writeBoolean(false);
            rightWriter.encode(this, (R)p_415004_);
        });
    }
    ...
    public static @Nullable CompoundTag readNbt(ByteBuf buffer) {
        Tag tag = readNbt(buffer, NbtAccounter.defaultQuota());
