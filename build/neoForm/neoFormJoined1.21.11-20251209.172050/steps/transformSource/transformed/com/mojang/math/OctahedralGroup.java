...
public enum OctahedralGroup implements StringRepresentable {
    ...
    public Direction rotate(Direction direction) {
        if (this.rotatedDirections == null) {
            this.rotatedDirections = Util.makeEnumMap(Direction.class, p_454080_ -> {
                Direction.Axis direction$axis = p_454080_.getAxis();
                Direction.AxisDirection direction$axisdirection = p_454080_.getAxisDirection();
    ...
    public Vector3i rotate(Vector3i rotation) {
        this.permutation.permuteVector(rotation);
        rotation.x = rotation.x * (this.invertX ? -1 : 1);
        rotation.y = rotation.y * (this.invertY ? -1 : 1);
        rotation.z = rotation.z * (this.invertZ ? -1 : 1);
        return rotation;
    }
