...
public class RealmsLongRunningMcoTaskScreen extends RealmsScreen {
    ...
    @Override
    public boolean keyPressed(KeyEvent p_446100_) {
        if (p_446100_.key() == 256) {
            this.cancel();
            return true;
        } else {
            return super.keyPressed(p_446100_);
        }
    }
    ...
    public void init() {
        ...
        this.layout.addChild(this.loadingDotsWidget, p_425123_ -> p_425123_.paddingTop(10).paddingBottom(30));
