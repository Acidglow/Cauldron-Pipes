...
public class GlConst {
    ...
    public static int bufferUsageToGlFlag(@GpuBuffer.Usage int bufferUsage) {
        int i = 0;
        if ((bufferUsage & 1) != 0) {
            i |= 65;
        }
    ...
    public static int bufferUsageToGlEnum(@GpuBuffer.Usage int bufferUsage) {
        boolean flag = (bufferUsage & 4) != 0;
        if ((bufferUsage & 2) != 0) {
            return flag ? 35040 : 35044;
        } else if ((bufferUsage & 1) != 0) {
