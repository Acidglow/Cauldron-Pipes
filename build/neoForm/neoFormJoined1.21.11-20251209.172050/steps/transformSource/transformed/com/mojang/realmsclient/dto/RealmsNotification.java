...
public class RealmsNotification {
    ...
    public static class InfoPopup extends RealmsNotification {
        ...
        private InfoPopup(
            RealmsNotification notification, RealmsText title, RealmsText message, Identifier image, RealmsNotification.@Nullable UrlButton urlButton
        ) {
        ...
        public static RealmsNotification.InfoPopup parse(RealmsNotification notification, JsonObject json) {
            ...
            Identifier identifier = Identifier.parse(JsonUtils.getRequiredString("image", json));
            ...
            return new RealmsNotification.InfoPopup(notification, realmstext, realmstext1, identifier, realmsnotification$urlbutton);
        }

        public @Nullable PopupScreen buildScreen(Screen backgroundScreen, Consumer<UUID> uuidOutput) {
            ...
            if (component == null) {
                ...
                if (this.urlButton != null) {
                    popupscreen$builder.addButton(this.urlButton.urlText.createComponent(RealmsNotification.BUTTON_TEXT_FALLBACK), p_304766_ -> {
                        ...
                        minecraft.setScreen(new ConfirmLinkScreen(p_465315_ -> {
                            if (p_465315_) {
