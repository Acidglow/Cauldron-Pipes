...
public class VertexMultiConsumer {
    ...
    static class Double implements VertexConsumer {
        ...
        @Override
        public VertexConsumer setColor(int p_455605_) {
            this.first.setColor(p_455605_);
            this.second.setColor(p_455605_);
            return this;
        }
        ...
        @Override
        public VertexConsumer setLineWidth(float p_455015_) {
            this.first.setLineWidth(p_455015_);
            this.second.setLineWidth(p_455015_);
            return this;
        }
    ...
    record Multiple(VertexConsumer[] delegates) implements VertexConsumer {
        ...
        @Override
        public VertexConsumer setColor(int p_455087_) {
            this.forEach(p_454079_ -> p_454079_.setColor(p_455087_));
            return this;
        }
        ...
        @Override
        public VertexConsumer setLineWidth(float p_456175_) {
            this.forEach(p_454077_ -> p_454077_.setLineWidth(p_456175_));
            return this;
        }
