...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
    ...
    public void init() {
        ...
        this.subtitle.forEach(p_457331_ -> linearlayout.addChild(new StringWidget(p_457331_, this.font)));
    ...
    class Entry extends ObjectSelectionList.Entry<RealmsSelectWorldTemplateScreen.Entry> {
        ...
        @Override
        public boolean mouseClicked(MouseButtonEvent p_446446_, boolean p_434444_) {
            RealmsSelectWorldTemplateScreen.this.selectedTemplate = this.template;
            RealmsSelectWorldTemplateScreen.this.updateButtonStates();
            if (p_434444_ && this.isFocused()) {
                RealmsSelectWorldTemplateScreen.this.callback.accept(this.template);
            }

            if (this.websiteButton != null) {
                this.websiteButton.mouseClicked(p_446446_, p_434444_);
            }

            if (this.trailerButton != null) {
                this.trailerButton.mouseClicked(p_446446_, p_434444_);
            }

            return super.mouseClicked(p_446446_, p_434444_);
        }

        @Override
        public void renderContent(GuiGraphics p_439634_, int p_438992_, int p_440319_, boolean p_439731_, float p_439078_) {
            p_439634_.blit(
            ...
            if (this.websiteButton != null) {
                ...
                this.websiteButton.render(p_439634_, p_438992_, p_440319_, p_439078_);
            }

            if (this.trailerButton != null) {
                this.trailerButton.setPosition(this.getContentRight() - j - this.trailerButton.getWidth() * 2 - 15, this.getContentY());
                this.trailerButton.render(p_439634_, p_438992_, p_440319_, p_439078_);
            }

            int k = this.getContentX() + 45 + 20;
            int l = this.getContentY() + 5;
            p_439634_.drawString(RealmsSelectWorldTemplateScreen.this.font, this.template.name(), k, l, -1);
            p_439634_.drawString(RealmsSelectWorldTemplateScreen.this.font, this.template.version(), this.getContentRight() - j - 5, l, -6250336);
            p_439634_.drawString(RealmsSelectWorldTemplateScreen.this.font, this.template.author(), k, l + 9 + 5, -6250336);
            if (!this.template.recommendedPlayers().isBlank()) {
                p_439634_.drawString(
    ...
    class WorldTemplateList extends ObjectSelectionList<RealmsSelectWorldTemplateScreen.Entry> {
        ...
        @Override
        public boolean mouseClicked(MouseButtonEvent p_447290_, boolean p_433489_) {
            if (RealmsSelectWorldTemplateScreen.this.currentLink != null) {
                ...
                return super.mouseClicked(p_447290_, p_433489_);
            }
        }

        public void setSelected(RealmsSelectWorldTemplateScreen.@Nullable Entry p_313741_) {
            super.setSelected(p_313741_);
            RealmsSelectWorldTemplateScreen.this.selectedTemplate = p_313741_ == null ? null : p_313741_.template;
            RealmsSelectWorldTemplateScreen.this.updateButtonStates();
        }
